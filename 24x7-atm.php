...
<head>
    ...
    <title>24x7 ATM | Top Management Colleges in Greater Noida</title>
	<meta name="description" content="24x7 ATM - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">24x7 ATM</div>
								...
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<div class="placement-process">
                                            <p class="new-text">
                                                The institute also provides the facility of a 24x7 ATM in the premises for the safety of the students, faculties and staff. The presence of an ATM just at the entry gate inside the campus ensures the safety of the users and addresses their emergency needs to collect cash as well.   
                                            </p>
