...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>About GIMS | Top PGDM Colleges in Greater Noida</title>
        <meta
            name="description"
            content="About GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."
        />
        <meta
            name="keywords"
        ...
        <link rel="alternate" href="https://www.gims.net.in/about-gims.php" hreflang="es-us" />
        <link rel="canonical" href="https://www.gims.net.in/about-gims.php" />
        ...
        <meta property="og:title" content="About GIMS | Top PGDM Colleges in Greater Noida" />
        <meta
            property="og:description"
            content="About GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."
        />
        <meta property="og:url" content="https://www.gims.net.in/about-gims.php" />
        <meta property="fb:app_id" content="573928583391257" />

        <meta name="twitter:card" content="summary" />
        <meta name="twitter:site" content="@gims_net_in" />
        <meta name="twitter:title" content="About GIMS | Top PGDM Colleges in Greater Noida" />
        <meta
        ...
        <meta name="og:title" content="About GIMS | Top PGDM Colleges in Greater Noida" />
        <meta name="og:url" content="https://www.gims.net.in/about-gims.php" />
        ...
        <script type="application/ld+json">
            {
                ...
                "url": "https://www.gims.net.in/about-gims.php",
                "sameAs": [
                ...
                <div class="intro">
                    <div class="container custom_container">
                        <div class="row align-items-center new-pd4 zoomanimate">
                            ...
                            <div class="col-lg-12">
                                <h1 class="page-t">About GIMS</h1>
                                <h3 class="sub-t">PGDM Institute</h3>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-9">
                                        <div class="col-lg-12 new-pd9 awardbg2">
                                            <div class="pgdmtext">
                                                <!-- <img
                                                    src="img/college-gims.jpg"
                                                    style="padding-bottom: 10px"
                                                    alt="PGDM Campus"
                                                /> -->
                                                <div class="pgdm-image-flex">
                                                    <img
                                                        src="img/about-us-image-1.webp"
                                                        alt="GIMS Campus Image 1"
                                                    />
                                                    <img
                                                        src="img/about-us-image-2.webp"
                                                        alt="GIMS Campus Image 2"
                                                    />
                                                </div>

                                                <p>The GNIOT Group of Institutions, established in the year 2000, carries a
                                                strong legacy of excellence in higher education. GNIOT Institute of
                                                Management Studies (GIMS), Greater Noida, was established in 2020 in the
                                                emerging education hub—Greater Noida, with a focused mission to impart
                                                quality management education through its PGDM programme. Founded during
                                                a period of global transformation, GIMS was envisioned to prepare young
                                                graduates for the challenges of Industry 4.0, nurturing innovation,
                                                adaptability, and a forward-looking mindset.<br /><br />

                                                Guided by the visionary leadership of the Founder Chairman Shri K. L.
                                                Gupta, whose philosophy emphasizes value-based education, and the
                                                present Chairman Mr. Rajesh Gupta, who is committed to academic
                                                excellence and holistic learner development, GIMS aspires to make a
                                                meaningful contribution to management education in India.<br /><br />

                                                GIMS is headed by Prof. (Dr.) Bhupender Kumar Som, Director, GIMS,
                                                Greater Noida, a PhD in Statistics and an IBM-certified Enterprise
                                                Design Thinking Practitioner. Under his leadership, the institute
                                                ensures high academic standards, outcome-oriented learning, and
                                                effective implementation of contemporary teaching–learning practices.<br /><br />

                                                GIMS emphasizes the creation of industry-ready management professionals through experiential learning, multidisciplinary research, consulting, and strong corporate partnerships. To support this objective, the institute has established various Centres of Excellence across key management domains, reinforcing its commitment to holistic education, leadership development, and continuous academic advancement.<br /><br />
                                                </p>
                                            </div>
                                        </div>
                                    </div>
