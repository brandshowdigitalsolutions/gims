...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Academic Calendar | Top Management Colleges in Greater Noida</title>
        <meta
            name="description"
    ...
    <body class="home_four">
        ...
        <div id="wavescroll">
            <section class="section wave_two_section_two">
                ...
                <div class="text" style="font-size: 34px">Academic Calendar</div>
                ...
                <div class="intro">
                    <div class="container custom_container">
                        <div class="row align-items-center new-pd4 zoomanimate">
                            ...
                            <div class="col-lg-12">
                                <h1 class="page-t">Academic Calendar</h1>
                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <ul class="academic-calendar-list">
                                                            <li><a href="pdf/ac/academic-calendar-2025-26.pdf" target="_blank">Academic Calendar 2025 - 2026 - Click Here</a></li>
                                                            <li><a href="https://www.gims.net.in/pdf/ac/academic-calendar-2024-25.pdf" target="_blank">Academic Calendar 2024 - 2025 - Click Here</a></li>
                                                            <li><a href="pdf/ac/academic-calendar-2023-24.pdf" target="_blank">Academic Calendar 2023 - 2024 - Click Here</a></li>
                                                            <li><a href="pdf/ac/academic-calendar-2022-23.pdf" target="_blank">Academic Calendar 2022 - 2023 - Click Here</a></li>
                                                            <li><a href="pdf/ac/academic-calendar-2021-22.pdf" target="_blank">Academic Calendar 2021 - 2022 - Click Here</a></li>
                                                            <li><a href="pdf/ac/academic-calendar-2020-21.pdf" target="_blank">Academic Calendar 2020 - 2021 - Click Here</a></li>
                                                        </ul>
                                                        <style>
