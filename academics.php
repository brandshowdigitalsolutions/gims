...
<head>
    <meta charset="utf-8">
    <title>Academics | Management Campus in Greater Noida</title>
	<meta name="description" content="Academics - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
	...
	<link rel="alternate" href="https://www.gims.net.in/about-crc-department.php" hreflang="es-us"/>
	<link rel="canonical" href="https://www.gims.net.in/about-crc-department.php">
	...
	<meta property="og:title" content="Academics | Management Campus in Greater Noida">
	<meta property="og:description" content="Academics - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India.">
	<meta property="og:url" content="https://www.gims.net.in/about-crc-department.php">
	<meta property="fb:app_id" content="573928583391257">

    
	<meta name="twitter:card" content="summary">
	<meta name="twitter:site" content="@gims_net_in">
	<meta name="twitter:title" content="Academics | Management Campus in Greater Noida">
	<meta name="twitter:description" content="Academics - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India.">
	
	<!-- Open Graph general (Facebook, Pinterest & Google+) -->
	<meta name="og:title" content="Academics | Management Campus in Greater Noida"/>
	<meta name="og:url" content="https://www.gims.net.in/about-crc-department.php">
	...
	<script type="application/ld+json">
	 ...
	 "url": "https://www.gims.net.in/about-crc-department.php",
	 "sameAs": [
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Academics</div>
            ...
            <div class="intro">
                <div class="container custom_container">
                    <div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							<h1 class="page-t">Academics</h1>
							<h3 class="sub-t">Life @ GIMS - Greater Noida</h3>
						</div>
							...
							<div class="row">
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<p class="pgdmtext">
											<b>GNIOT Institute of Management Studies (GIMS)</b> strives for a serene academic ambience that focuses on the development and all-round growth of the students. The Institute has a balanced strength of faculties having rich experience in academia and the industry. The faculty members possess expertise in not only teaching, but also in research and development. It is appreciable to see highly skilled people come together under one roof to impart prime quality training to the students. The Faculty at the Institute functions to bring about a right mix of theory, application along with proportionate practice which caters to the ongoing industry needs.
											<br/>
											<br/>
											The faculty fraternity incessantly supports the students in running the activity clubs, organizing national and international activities, inter and intra-college competitions, annual technical and cultural festivals, live projects, group projects in addition to various activities for social cause. GIMS, Greater Noida students have consistently won accolades and awards at various levels and events.
											<br/>
											<br/>
											Experiential Learning is undertaken for every course. This is backed up by assignments, internships, quizzes, flip classes, presentations, Performance iMprovement Programmes (PIPs), Chanakya Talk Series(CTS), industrial visits and live project opportunities to provide students real-time learning and assessment of their work.
											<br/>
											<br/>
										</p>
									</div>
