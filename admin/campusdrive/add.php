    ...
    <div class="row-fluid">
        <div class="box span12">
            <div class="box-header" data-original-title="">
                <h2><i class="halflings-icon white edit"></i><span class="break"></span>Add Campus Drive</h2>
            </div>
            <div class="box-content">
                <form class="form-horizontal" name="frm1" enctype='multipart/form-data' action="campusdrive/insertcampusdrive.php?action=add" method="post" onsubmit="return validate1();">
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="input-file uniform_on span6" id="time" type="text" name="time">Time Should be hh:mm
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="hlink">Image</label>
                            <div class="controls">
                                <input class="input-file uniform_on span6" id="files" type="file" name="files" multiple> image Should be 90 X 90
                            </div>
                        </div>
                        ...
                        <!--<div class="control-group">
                            ...
                            <div class="controls">
                                <input class="input-file uniform_on span6" id="package" type="text" name="package" multiple>
                            </div>
                        </div>-->
                        <div class="control-group">
                            <label class="control-label" for="hlink">Location</label>
                            <div class="controls">
                                <input class="input-file uniform_on span6" id="campus" type="text" name="campus" multiple>
                            </div>
                        </div>
