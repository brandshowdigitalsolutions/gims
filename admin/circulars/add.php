...
else if($m == "7")
{
    ...
    <script type="text/javascript">
        swal({
            title: "",
            text: "Invalid FIle. Only PDF allowed",
            timer: 6000,
            type: "error",
            showConfirmButton: true
        });
    ...
    <div class="row-fluid">
        <div class="box span12">
            ...
            <div class="box-content">
                ...
                <a href="circulars.php?option=add" class="quick-button-small span1">
    ...
    <div class="row-fluid">
        <div class="box span12">
            <div class="box-header" data-original-title="">
                <h2><i class="halflings-icon white edit"></i><span class="break"></span>Add Circulars</h2>
            </div>
            <div class="box-content">
                <form class="form-horizontal" name="frm1" enctype='multipart/form-data' action="circulars/insertcirculars.php?action=add" method="post" onsubmit="return validate1();">
                    <fieldset>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="hlink">Files</label>
                            <div class="controls">
