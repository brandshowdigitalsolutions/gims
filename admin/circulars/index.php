    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon white user"></i><span class="break"></span>Circulars</h2>
            </div>
            <div class="box-content">
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <tbody>
                    <?php
                    $getalbums = mysqli_query($conn,"select * from tbl_circulars ORDER BY id desc");
                   ...
                   <td><?php echo $rowalbums['download'];?></td>
                                <td class="center">
                                    <a href="circulars.php?option=update&id=<?php echo $rowalbums['id']; ?>" class="btn btn-info">
