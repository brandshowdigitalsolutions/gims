...
function validatealbumss()
{
	with(window.document.frmaddalbum)
	{
		...
		if(coverpick.value.trim() == "")
		{
			swal({
				title: "",
				text: "Please choose cover pic.",
				timer: 5000,
				type: "error",
				showConfirmButton: true
			});
...
{
	with(window.document.frmalbum)
	{
		if(title.value.trim() == "")
		{
			swal({
				title: "",
				text: "Please enter album title.",
				timer: 5000,
				type: "error",
				showConfirmButton: true
			});
		...
		if(banner_pic.value.trim() == "")
		{
			swal({
				title: "",
				text: "Please choose Banner pic.",
				timer: 5000,
				type: "error",
				showConfirmButton: true
			});
...
function validate1()
{
	with(window.document.frm1)
	{
			...
			if(email.value.trim() == "")
		{
			...
			if(per_address.value.trim() == "")
		{
			swal({
				title: "",
				text: "Please enter per address.",
				timer: 5000,
				type: "error",
				showConfirmButton: true
			});
...
function validate11()
{
	with(window.document.frm1)
	{
		if(full_heading.value.trim() == "")
		{
			swal({
				title: "",
				text: "Please enter full heading.",
				timer: 5000,
				type: "error",
				showConfirmButton: true
			});
...
function validatevent()
{
	with(window.document.frmalbum)
	{
		...
		if(short_des.value.trim() == "")
		{
			swal({
				title: "",
				text: "Please enter short des.",
				timer: 5000,
				type: "error",
				showConfirmButton: true
			});
...
function delAlbum(id)
{
	...
	swal({
			...
			closeOnConfirm: true },
		function(){
			window.location.href = "gallery/galleryprocess.php?action=delete&albumid="+albumid;
		});
...
function delplace(id)
{
	...
	swal({
			...
			closeOnConfirm: true },
		function(){
			window.location.href = "placement/galleryprocess.php?action=delete&albumid="+albumid;
		});
...
function deltraining(id)
{
	...
	swal({
			...
			closeOnConfirm: true },
		function(){
			window.location.href = "training/galleryprocess.php?action=delete&albumid="+albumid;
		});
...
function delEvent(id)
{
	...
	swal({
		...
		function()
		{
			window.location.href = "newsevent/galleryprocess.php?action=delete&albumid="+albumid;
		});

}
function validateaddimages()
{
	with(window.document.frmaddimages)
	{
		if(aid.value.trim() == "")
		{
			swal({
				title: "",
				text: "Please select album.",
				timer: 5000,
				type: "error",
				showConfirmButton: true
			});
...
function delImage(id)
{
	...
	swal({
			...
			closeOnConfirm: true },
		function(){
			window.location.href = "gallery/galleryprocess.php?action=deleteimage&imageid="+imageid;
		});
...
{
	with(window.document.frmvideo)
	{
		if(title.value.trim() == "")
		{
			swal({
				title: "",
				text: "Please enter title id.",
				timer: 5000,
				type: "error",
				showConfirmButton: true
			});
...
function delvideo(id)
{
	...
	swal({
		...
		closeOnConfirm: true },
		function(){
			window.location.href = "videos/videosprocess.php?action=delete&videoid="+videoid;
	});
