    ...
    <div class="row-fluid">
        <div class="box span12">
            ...
            <div class="box-content">
                ...
                <!--<a href="latest-news.php?option=export" class="quick-button-small span1">
                    <i class="icon-plus-sign "></i>
                    <p>Export</p>
                </a>-->
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon white user"></i><span class="break"></span>Latest News</h2>
            </div>
            <div class="box-content">
                <table class="table table-striped table-bordered bootstrap-datatable datatable" id="example">
                    ...
                    <tbody>
                    <?php
                    $getalbums = mysqli_query($conn,"select * from tbl_latest_news ORDER BY id desc");
                    ...
                    <td><?php echo $rowalbums['sdescription'];?></td>
                    <td><?php echo $rowalbums['description'];?></td>
                    <td><?php echo $rowalbums['location'];?></td>
                    
                   <td> <?php echo date("j F, Y", strtotime($rowalbums["date"])); ?></td>
                   <td><?php echo $rowalbums['images'];?></td>
                                <td class="center">
                                    <a href="latest-news.php?option=update&id=<?php echo $rowalbums['id']; ?>" class="btn btn-info">
