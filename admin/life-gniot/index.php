    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon white user"></i><span class="break"></span>Life@Gniot</h2>
            </div>
            <div class="box-content">
                <table class="table table-striped table-bordered bootstrap-datatable datatable" data-sort-order="desc">
                    <thead>
                    <tr>
                    <th>ID</th>
                    <th>Title</th>
                    ...
                    <tbody>
                    <?php
                    $getalbums = mysqli_query($conn,"select * from tbl_lifegniot ORDER BY id DESC");
                   ...
                   <td><?php echo $rowalbums['description'];?></td>
                                <td class="center">
                                    <a href="life-gniot.php?option=update&id=<?php echo $rowalbums['id']; ?>" class="btn btn-info">
