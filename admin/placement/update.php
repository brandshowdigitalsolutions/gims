    ...
    <div class="row-fluid">
        <div class="box span12">
            ...
            <div class="box-content">
                    ...
                    <form class="form-horizontal" name="frm1" action="placement/galleryprocess.php?action=update" method="post" onsubmit="return validate1();" enctype="multipart/form-data">
                      
                        <fieldset>
                            <div class="control-group">
                                <label class="control-label" for="title">ID</label>
                                <div class="controls">
                                    <input type="text" class="span6" name="reds" id="regid"  value="<?php echo $regid; ?>">
