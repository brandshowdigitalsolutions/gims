    ...
    <div class="row-fluid">
        <div class="box span12">
            <div class="box-header" data-original-title="">
                <h2><i class="halflings-icon white edit"></i><span class="break"></span>Add Placement Updates</h2>
            </div>
            <div class="box-content">
                <form class="form-horizontal" name="frm1" enctype='multipart/form-data' action="placementupdates/insertplacementupdates.php?action=add" method="post" onsubmit="return validate1();">
                    <fieldset>
