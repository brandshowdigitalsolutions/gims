    ...
    <div class="row-fluid">
        <div class="box span12">
            ...
            <div class="box-content">
                <a href="placement-updates.php?option=add" class="quick-button-small span1">
                    <i class="icon-plus-sign "></i>
                    <p>Add</p>
                </a>
                <a href="placement-updates.php" class="quick-button-small span1">
                    <i class="icon-film"></i>
                    <p>View</p>
                    <?php
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon white user"></i><span class="break"></span>Placement Updates</h2>
            </div>
            <div class="box-content">
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <tbody>
                    <?php
                    $getalbums = mysqli_query($conn,"select * from tbl_placement_updates ORDER BY id desc");
                    ...
                    <td><?php echo $rowalbums['description'];?></td>
                                <td class="center">
                                    <a href="placement-updates.php?option=update&id=<?php echo $rowalbums['id']; ?>" class="btn btn-info">
