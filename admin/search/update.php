...
$getalbum = mysqli_query($conn, "select * from  tbl_searchcourse where id = '".$id."'");
if(mysqli_num_rows($getalbum) > 0)
{
    ...
    $category = $rowalbum['category'];
    $keywords = $rowalbum['keywords'];
    $link = $rowalbum['link'];
    ...
    <div class="row-fluid">
        <div class="box span12">
            <div class="box-header" data-original-title="">
                <h2><i class="halflings-icon white edit"></i><span class="break"></span>Update Course</h2>
            </div>
            <div class="box-content">
               
                    <form class="form-horizontal" name="frm1" enctype='multipart/form-data' action="search/insertcourse.php?action=update" method="post" onsubmit="return validate1();">
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="span6" id="category" name="category" value="<?php echo $category;?>">
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                 <textarea name="keywords" id="keywords" class="input-file uniform_on span6" ><?php echo $keywords;?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="span6" id="link" name="link" value="<?php echo $link;?>">
                            </div>
                        </div>
