...
<head>
    ...
    <title>AICTE Pledge | Top Management Colleges in Greater Noida</title>
            ...
            <div class="intro">
                <div class="container custom_container">
                    <div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							<h1 class="page-t">AICTE Pledge</h1>
                                            ...
                                            <div class="gallery-box">
                                                <div class="row">
                                                    <div class="col-md-12 popup-box">
                                                        <a class="example-image-link" href="img/aicte-4.webp" data-lightbox="example-set" >
                                                            <img class="example-image" src="img/aicte-4.webp" alt="Gims Classrooms"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-md-12 popup-box">
                                                        <a class="example-image-link" href="img/aicte-1.webp" data-lightbox="example-set" >
                                                            <img class="example-image" src="img/aicte-1.webp" alt="Gims Classrooms"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-md-12 popup-box">
                                                        <a class="example-image-link" href="img/aicte-2.webp" data-lightbox="example-set" >
                                                            <img class="example-image" src="img/aicte-2.webp" alt="Gims Classrooms"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-md-12 popup-box">
                                                        <a class="example-image-link" href="img/aicte-3.webp" data-lightbox="example-set" >
                                                            <img class="example-image" src="img/aicte-3.webp" alt="Gims Classrooms"/>
                                                        </a>
                                                    </div>
