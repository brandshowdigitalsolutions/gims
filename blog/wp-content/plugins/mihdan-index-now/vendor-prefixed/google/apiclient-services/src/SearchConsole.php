 ...
 * the License.
 */
namespace Mihdan\IndexNow\Dependencies\Google\Service;
 ...
 * @internal
 */
class SearchConsole extends \Mihdan\IndexNow\Dependencies\Google\Service
{
    ...
    public function __construct($clientOrConfig = [], $rootUrl = null)
    {
        ...
        $this->urlInspection_index = new SearchConsole\Resource\UrlInspectionIndex($this, $this->serviceName, 'index', ['methods' => ['inspect' => ['path' => 'v1/urlInspection/index:inspect', 'httpMethod' => 'POST', 'parameters' => []]]]);
...
\class_alias(SearchConsole::class, 'Mihdan\\IndexNow\\Dependencies\\Google_Service_SearchConsole');
