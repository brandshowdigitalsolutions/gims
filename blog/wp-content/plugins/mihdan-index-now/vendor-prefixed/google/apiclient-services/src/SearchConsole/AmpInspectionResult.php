...
/** @internal */
class AmpInspectionResult extends \Mihdan\IndexNow\Dependencies\Google\Collection
{
...
\class_alias(AmpInspectionResult::class, 'Mihdan\\IndexNow\\Dependencies\\Google_Service_SearchConsole_AmpInspectionResult');
