...
/** @internal */
class InspectUrlIndexRequest extends \Mihdan\IndexNow\Dependencies\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(InspectUrlIndexRequest::class, 'Mihdan\\IndexNow\\Dependencies\\Google_Service_SearchConsole_InspectUrlIndexRequest');
