...
/** @internal */
class Item extends \Mihdan\IndexNow\Dependencies\Google\Collection
{
...
\class_alias(Item::class, 'Mihdan\\IndexNow\\Dependencies\\Google_Service_SearchConsole_Item');
