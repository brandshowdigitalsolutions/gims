...
/** @internal */
class UrlInspectionResult extends \Mihdan\IndexNow\Dependencies\Google\Model
{
...
\class_alias(UrlInspectionResult::class, 'Mihdan\\IndexNow\\Dependencies\\Google_Service_SearchConsole_UrlInspectionResult');
