...
use DomainException;
use Mihdan\IndexNow\Dependencies\Google\AccessToken\Revoke;
use Mihdan\IndexNow\Dependencies\Google\AccessToken\Verify;
use Mihdan\IndexNow\Dependencies\Google\Auth\ApplicationDefaultCredentials;
use Mihdan\IndexNow\Dependencies\Google\Auth\Cache\MemoryCacheItemPool;
use Mihdan\IndexNow\Dependencies\Google\Auth\Credentials\ServiceAccountCredentials;
use Mihdan\IndexNow\Dependencies\Google\Auth\Credentials\UserRefreshCredentials;
...
use Mihdan\IndexNow\Dependencies\Google\Auth\GetUniverseDomainInterface;
use Mihdan\IndexNow\Dependencies\Google\Auth\HttpHandler\HttpHandlerFactory;
use Mihdan\IndexNow\Dependencies\Google\Auth\OAuth2;
use Mihdan\IndexNow\Dependencies\Google\AuthHandler\AuthHandlerFactory;
use Mihdan\IndexNow\Dependencies\Google\Http\REST;
use Mihdan\IndexNow\Dependencies\GuzzleHttp\Client as GuzzleClient;
use Mihdan\IndexNow\Dependencies\GuzzleHttp\ClientInterface;
use Mihdan\IndexNow\Dependencies\GuzzleHttp\Ring\Client\StreamHandler;
use InvalidArgumentException;
use LogicException;
use Mihdan\IndexNow\Dependencies\Monolog\Handler\StreamHandler as MonologStreamHandler;
use Mihdan\IndexNow\Dependencies\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
...
use Mihdan\IndexNow\Dependencies\Psr\Log\LoggerInterface;
...
class Client
{
    ...
    protected function createDefaultHttpClient()
    {
        ...
        } elseif (\defined('Mihdan\\IndexNow\\Dependencies\\GuzzleHttp\\ClientInterface::VERSION')) {
