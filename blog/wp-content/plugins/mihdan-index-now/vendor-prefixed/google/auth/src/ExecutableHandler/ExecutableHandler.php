...
use Mihdan\IndexNow\Dependencies\Symfony\Component\Process\Exception\ProcessTimedOutException;
use Mihdan\IndexNow\Dependencies\Symfony\Component\Process\Process;
/** @internal */
class ExecutableHandler
{
    ...
    public function __invoke(string $command) : int
    {
        ...
        try {
            ...
            throw new ExecutableResponseError('The executable failed to finish within the timeout specified.', 'TIMEOUT_EXCEEDED');
        }
