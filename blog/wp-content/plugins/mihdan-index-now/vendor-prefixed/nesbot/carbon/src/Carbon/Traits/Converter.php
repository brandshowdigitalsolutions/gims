...
use Mihdan\IndexNow\Dependencies\Carbon\CarbonInterval;
use Mihdan\IndexNow\Dependencies\Carbon\CarbonPeriod;
use Mihdan\IndexNow\Dependencies\Carbon\CarbonPeriodImmutable;
use Mihdan\IndexNow\Dependencies\Carbon\Exceptions\UnitException;
use Closure;
use DateTime;
...
trait Converter
{
    ...
    public function __toString()
    {
        ...
        return $format instanceof Closure ? $format($this) : $this->rawFormat($format ?: (\defined('Mihdan\\IndexNow\\Dependencies\\static::DEFAULT_TO_STRING_FORMAT') ? static::DEFAULT_TO_STRING_FORMAT : CarbonInterface::DEFAULT_TO_STRING_FORMAT));
    }
    /**
    ...
    {
        return $this->avoidMutation()->setTimezone('GMT')->rawFormat(\defined('Mihdan\\IndexNow\\Dependencies\\static::RFC7231_FORMAT') ? static::RFC7231_FORMAT : CarbonInterface::RFC7231_FORMAT);
    }
    /**
