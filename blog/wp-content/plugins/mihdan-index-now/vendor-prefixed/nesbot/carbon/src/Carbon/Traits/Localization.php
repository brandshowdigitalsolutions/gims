 ...
 */
namespace Mihdan\IndexNow\Dependencies\Carbon\Traits;

use Mihdan\IndexNow\Dependencies\Carbon\CarbonInterface;
use Mihdan\IndexNow\Dependencies\Carbon\Exceptions\InvalidTypeException;
use Mihdan\IndexNow\Dependencies\Carbon\Exceptions\NotLocaleAwareException;
use Mihdan\IndexNow\Dependencies\Carbon\Language;
use Mihdan\IndexNow\Dependencies\Carbon\Translator;
use Mihdan\IndexNow\Dependencies\Carbon\TranslatorStrongTypeInterface;
use Closure;
use Mihdan\IndexNow\Dependencies\Symfony\Component\Translation\TranslatorBagInterface;
use Mihdan\IndexNow\Dependencies\Symfony\Component\Translation\TranslatorInterface;
use Mihdan\IndexNow\Dependencies\Symfony\Contracts\Translation\LocaleAwareInterface;
use Mihdan\IndexNow\Dependencies\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
// @codeCoverageIgnoreStart
if (\interface_exists('Mihdan\\IndexNow\\Dependencies\\Symfony\\Contracts\\Translation\\TranslatorInterface') && !\interface_exists('Mihdan\\IndexNow\\Dependencies\\Symfony\\Component\\Translation\\TranslatorInterface')) {
    \class_alias('Mihdan\\IndexNow\\Dependencies\\Symfony\\Contracts\\Translation\\TranslatorInterface', 'Mihdan\\IndexNow\\Dependencies\\Symfony\\Component\\Translation\\TranslatorInterface');
}
