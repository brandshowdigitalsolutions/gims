...
use Mihdan\IndexNow\Dependencies\phpseclib3\Crypt\EC\Curves\Curve25519;
use Mihdan\IndexNow\Dependencies\phpseclib3\Crypt\EC\Curves\Curve448;
use Mihdan\IndexNow\Dependencies\phpseclib3\Crypt\EC\Curves\Ed25519;
use Mihdan\IndexNow\Dependencies\phpseclib3\Crypt\EC\Curves\Ed448;
use Mihdan\IndexNow\Dependencies\phpseclib3\Crypt\EC\Formats\Keys\PKCS1;
use Mihdan\IndexNow\Dependencies\phpseclib3\Crypt\EC\Formats\Keys\PKCS8;
use Mihdan\IndexNow\Dependencies\phpseclib3\Crypt\EC\Parameters;
use Mihdan\IndexNow\Dependencies\phpseclib3\Crypt\EC\PrivateKey;
use Mihdan\IndexNow\Dependencies\phpseclib3\Crypt\EC\PublicKey;
...
use Mihdan\IndexNow\Dependencies\phpseclib3\File\ASN1\Maps\ECParameters;
        ...
        switch ($curveName) {
            case 'Ed25519':
                $providers = [
                    ...
                    'OpenSSL' => \defined('Mihdan\\IndexNow\\Dependencies\\OPENSSL_KEYTYPE_ED25519'),
                ];
                break;
            case 'Ed448':
                // OPENSSL_KEYTYPE_ED448 introduced in PHP 8.4.0
                $providers = ['OpenSSL' => \defined('Mihdan\\IndexNow\\Dependencies\\OPENSSL_KEYTYPE_ED448')];
                break;
            case 'Curve25519':
                $providers = [
                    'libsodium' => \function_exists('sodium_crypto_box_publickey_from_secretkey'),
                    // OPENSSL_KEYTYPE_X25519 introduced in PHP 8.4.0
                    'OpenSSL' => \defined('Mihdan\\IndexNow\\Dependencies\\OPENSSL_KEYTYPE_X25519'),
                ];
                break;
            // OPENSSL_KEYTYPE_X448 introduced in PHP 8.4.0
            case 'Curve448':
                $providers = ['OpenSSL' => \defined('Mihdan\\IndexNow\\Dependencies\\OPENSSL_KEYTYPE_X448')];
                break;
            default:
