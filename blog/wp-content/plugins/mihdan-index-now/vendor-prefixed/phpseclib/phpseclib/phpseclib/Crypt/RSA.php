...
use Mihdan\IndexNow\Dependencies\phpseclib3\Crypt\RSA\PrivateKey;
    ...
    protected function handleOpenSSL($func, $message, $signature = null)
    {
        ...
        if (self::$forcedEngine !== 'PHP') {
            ...
            if ($this->{$paddingType} === self::SIGNATURE_PSS) {
                switch (\true) {
                    case !\defined('Mihdan\\IndexNow\\Dependencies\\OPENSSL_PKCS1_PSS_PADDING'):
            ...
            */
            ...
            if (isset($error)) {
                ...
                switch (\true) {
                    case $this->signaturePadding === self::SIGNATURE_PSS && \defined('Mihdan\\IndexNow\\Dependencies\\OPENSSL_PKCS1_PSS_PADDING'):
