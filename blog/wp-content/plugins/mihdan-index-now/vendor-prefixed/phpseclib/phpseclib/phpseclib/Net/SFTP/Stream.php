 ...
 */
namespace Mihdan\IndexNow\Dependencies\phpseclib3\Net\SFTP;

use Mihdan\IndexNow\Dependencies\phpseclib3\Crypt\Common\PrivateKey;
use Mihdan\IndexNow\Dependencies\phpseclib3\Net\SFTP;
...
class Stream
{
    ...
    {
        if (\defined('Mihdan\\IndexNow\\Dependencies\\NET_SFTP_STREAM_LOGGING')) {
            echo "__construct()\r\n";
        }
    }
    /**
    ...
    private function _rename($path_from, $path_to)
    {
        ...
        // the $component part of parse_url() was added in PHP 5.1.2
