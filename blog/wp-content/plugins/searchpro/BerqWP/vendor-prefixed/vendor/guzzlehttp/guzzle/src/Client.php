...
use BerqWP_Deps\GuzzleHttp\Cookie\CookieJar;
use BerqWP_Deps\GuzzleHttp\Exception\GuzzleException;
use BerqWP_Deps\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \BerqWP_Deps\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
