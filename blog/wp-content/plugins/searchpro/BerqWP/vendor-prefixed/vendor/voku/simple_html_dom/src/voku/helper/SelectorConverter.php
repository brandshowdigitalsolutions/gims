...
use BerqWP_Deps\Symfony\Component\CssSelector\CssSelectorConverter;
class SelectorConverter
{
     ...
     * @return string
     */
    public static function toXPath(string $selector, bool $ignoreCssSelectorErrors = \false, bool $isForHtml = \true)
    {
