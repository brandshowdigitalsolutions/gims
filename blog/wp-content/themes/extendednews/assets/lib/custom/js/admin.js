(function ($) {
    ...
    var ajaxurl = extendednews_admin.ajax_url;
    var extendednewsNonce = extendednews_admin.ajax_nonce;
    var custom_theme_file_frame;

    // Category Color
    $('#extendednews-cat-color').wpColorPicker();
    ...
    $('.twp-img-upload-button').click( function(){
        ...
        frame = wp.media({
            title: extendednews_admin.upload_image,
            button: {
            text: extendednews_admin.use_image
            },
    ...
    $('.twp-custom-setup').click(function(){
        ...
        var data = {
            'action': 'extendednews_notice_dismiss',
            '_wpnonce': extendednewsNonce,
        };
 
        $.post(ajaxurl, data, function( response ) {

            $('.twp-extendednews-notice').hide();
    ...
    $('.twp-install-active').click(function(){
        ...
        $(this).closest('.twp-extendednews-notice').addClass('twp-installing');

        var data = {
            'action': 'extendednews_install_plugins',
            '_wpnonce': extendednewsNonce,
        };
    ...
    $('.theme-recommended-plugin .recommended-plugin-status').click(function(){
        ...
        $.post(ajaxurl, data, function( response ) {
            ...
            var active = extendednews_admin.active
            var deactivate = extendednews_admin.deactivate
