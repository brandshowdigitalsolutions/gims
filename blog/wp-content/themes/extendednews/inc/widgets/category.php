...
if ( !function_exists('extendednews_category_widgets') ) :
     ...
     * @since 1.0.0
     */
    function extendednews_category_widgets(){
        // Recent Post widget.
        register_widget('ExtendedNews_Sidebar_Category_Widget');

    }

endif;
add_action('widgets_init', 'extendednews_category_widgets');

// Recent Post widget
if ( !class_exists('ExtendedNews_Sidebar_Category_Widget') ) :
     ...
     * @since 1.0.0
     */
    class ExtendedNews_Sidebar_Category_Widget extends ExtendedNews_Widget_Base
    {
        ...
        {
            $opts = array(
                'classname' => 'extendednews_category_widget',
            ...
            $fields = array(
                ...
                'top_category' => array(
                    'label' => esc_html__('Top Categories:', 'extendednews'),
                    'type' => 'number',
                    'default' => 5,
                    'css' => 'max-width:60px;',
                    'min' => 1,
                ...
                'enable_cat_desc' => array(
                    'label' => esc_html__('Enable Category Description:', 'extendednews'),
                    'type' => 'checkbox',
                    'default' => true,
                ),
                'latest_title' => array(
                    'label' => esc_html__('Latest Text Label:', 'extendednews'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default' => esc_html__('Latest :', 'extendednews'),
                ),
            );

            parent::__construct('extendednews-category-layout', esc_html__('ExtendedNews: Sidebar Category Widget', 'extendednews'), $opts, array(), $fields);
        }
