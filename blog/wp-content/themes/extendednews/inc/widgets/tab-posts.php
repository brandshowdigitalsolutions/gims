...
if ( !function_exists('extendednews_tab_posts_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function extendednews_tab_posts_widgets(){
        // Tab Post widget.
        register_widget('ExtendedNews_Tab_Posts_Widget');

    }
endif;
add_action('widgets_init', 'extendednews_tab_posts_widgets');

/* Tabed widget */
if ( !class_exists('ExtendedNews_Tab_Posts_Widget') ):
     ...
     * @since 1.0.0
     */
    class ExtendedNews_Tab_Posts_Widget extends ExtendedNews_Widget_Base {
        ...
        function __construct() {
            ...
            $opts = array(
                'classname'   => 'extendednews_widget_tabbed',
                'description' => esc_html__('Tabbed widget.', 'extendednews'),
            );
            $fields = array(
                'popular_heading' => array(
                    'label'          => esc_html__('Popular', 'extendednews'),
                    'type'           => 'heading',
                ),
                'popular_title' => array(
                    'label' => esc_html__('Popular Tab Title', 'extendednews'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Popular', 'extendednews'),
                ),
                'popular_number' => array(
                    'label'         => esc_html__('No. of Posts:', 'extendednews'),
                    'type'          => 'number',
                    'css'           => 'max-width:60px;',
                    'default'       => 5,
                    'min'           => 1,
                ...
                'recent_heading' => array(
                    'label'         => esc_html__('Recent', 'extendednews'),
                    'type'          => 'heading',
                ),
                'recent_title' => array(
                    'label' => esc_html__('Recent Tab Title', 'extendednews'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Recent', 'extendednews'),
                ),
                'recent_number' => array(
                    'label'        => esc_html__('No. of Posts:', 'extendednews'),
                    'type'         => 'number',
                ...
                'comments_heading' => array(
                    'label'           => esc_html__('Comments', 'extendednews'),
                    'type'            => 'heading',
                ),
                'comment_title' => array(
                    'label' => esc_html__('Comment Tab Title', 'extendednews'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Comments', 'extendednews'),
                ),
                'comments_number' => array(
                    'label'          => esc_html__('No. of Comments:', 'extendednews'),
                    'type'           => 'number',
                    'css'            => 'max-width:60px;',
                    'default'        => 5,
                    'min'            => 1,
            ...
            parent::__construct( 'extendednews-tabbed', esc_html__( 'ExtendedNews: Sidebar Tab Widget', 'extendednews' ), $opts, array(), $fields );
