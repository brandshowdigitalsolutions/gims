...
<head>
    ...
    <title>Classrooms | Top Management Colleges in Greater Noida</title>
	<meta name="description" content="Classrooms - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Classrooms</div>
								...
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<div class="placement-process">
                                            <p class="new-text">
                                                The avant-garde classrooms are fully air conditioned and well equipped with all the modern day facilities from White Boards to Smart Boards, from Projectors to Wi-Fi. The students make the hundred percent of the knowledge imparted to them in these technically aided classrooms. The amphitheatrically designed classrooms make it even the more relishing experience to imbibe the learning comfortably.
                                            </p>
                                            <br>
                                            <div class="gallery-box">
                                                <div class="row">
                                                    <div class="col-md-4 popup-box">
                                                        <a class="example-image-link" href="img/classrooms/c-room-1.webp" data-lightbox="example-set" ><img class="example-image" src="img/classrooms/c-room-1.webp" alt="Gims Library"/></a>
                                                    </div>
                                                    <div class="col-md-4 popup-box">
                                                        <a class="example-image-link" href="img/classrooms/c-room-2.webp" data-lightbox="example-set" ><img class="example-image" src="img/classrooms/c-room-2.webp" alt="Gims Library"/></a>
                                                    </div>
                                                    <div class="col-md-4 popup-box">
                                                        <a class="example-image-link" href="img/classrooms/c-room-3.webp" data-lightbox="example-set" ><img class="example-image" src="img/classrooms/c-room-3.webp" alt="Gims Library"/></a>
                                                    </div>
                                                    <div class="col-md-4 popup-box">
                                                        <a class="example-image-link" href="img/classrooms/c-room-4.webp" data-lightbox="example-set" ><img class="example-image" src="img/classrooms/c-room-4.webp" alt="Gims Library"/></a>
                                                    </div>
                                                    <div class="col-md-4 popup-box">
                                                        <a class="example-image-link" href="img/classrooms/c-room-5.webp" data-lightbox="example-set" ><img class="example-image" src="img/classrooms/c-room-5.webp" alt="Gims Library"/></a>
                                                    </div>
                                                    <div class="col-md-4 popup-box">
                                                        <a class="example-image-link" href="img/classrooms/c-room-6.webp" data-lightbox="example-set" ><img class="example-image" src="img/classrooms/c-room-6.webp" alt="Gims Library"/></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
