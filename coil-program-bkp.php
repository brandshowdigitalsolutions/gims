...
<head>
	...
	<title>COIL Program | GIMS</title>

	<meta name="description" content="COIL Program Discover what’s new at GIMS with our HR Newsletter, featuring success stories, event updates, and the latest campus news." />

	<meta name="keywords" content="PGDM College, HR Newsletter, Educational Leadership, Visionary Leaders, Academic Excellence, Higher Education, College Governance, Institutional Leadership, College Trustees, Decision-Making Body"/>
	...
	<meta property="og:title" content="COIL Program">

	<meta property="og:description" content="COIL Program | Discover what’s new at GIMS with our HR Newsletter, featuring success stories, event updates, and the latest campus news.">
	...
	<meta name="twitter:title" content="COIL Program">

	<meta name="twitter:description" content="Discover what’s new at GIMS with our HR Newsletter, featuring success stories, event updates, and the latest campus news.">



	<!-- Open Graph general (Facebook, Pinterest & Google+) -->

	<meta name="og:title" content="COIL Program" />
...
<body class="home_four">
	...
	<div id="wavescroll">
		...
		<section class="section wave_two_section_two">
			...
			<div class="text" style="font-size:34px;">COIL Program</div>
				...
				<div class="container custom_container">
					...
					<div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							...
							<h1 class="page-t">COIL Program</h1>

							<h3 class="sub-t">COIL Report </h3>
											...
											<div class="col-md-4 col-6">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="view  zoom z-depth-1">
                                                        ...
                                                        <img alt="" class="card-img-top" src="img/news-letter/coil-project-report.webp">
                                                        <div class="mask flex-center blue-gradient-rgba">

                                                            <a class="btn btn-sm btn-white waves-effect waves-light" href="pdf/new-letter/coil-project-report.pdf" target="_blank">
                                                    ...
                                                    <div class="card-footer">COIL Report</div>
                                            ...
                                            <!-- <div class="col-md-4 col-6">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="view  zoom z-depth-1">
                                                        ...
                                                        <img alt="" class="card-img-top" src="img/news-letter/hr-dept-newsletter.png">
                                                        <div class="mask flex-center blue-gradient-rgba">

                                                            <a class="btn btn-sm btn-white waves-effect waves-light" href="pdf/hr-newsletter-2-0.pdf" target="_blank">
                                            ...
                                            <div class="col-md-4 col-6">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="view  zoom z-depth-1">
                                                        ...
                                                        <img alt="" class="card-img-top" src="img/news-letter/gims-alumini-connet-2-0-(hr-conclave-2024)-april-vol-1-isse-1.png">
                                                        <div class="mask flex-center blue-gradient-rgba">

                                                            <a class="btn btn-sm btn-white waves-effect waves-light" href="pdf/gims-alumini-connet-2-0-(hr-conclave-2024)-april-vol-1-isse-1.pdf" target="_blank">
