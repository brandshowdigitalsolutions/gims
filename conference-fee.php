...
<head>
    ...
    <title>Conference Fee | GNIOT Institute of Management Studies</title>
	<meta name="description" content="Conference Fee - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
	...
	<link rel="alternate" href="https://www.gims.net.in/conference-fee.php" hreflang="es-us"/>
	<link rel="canonical" href="https://www.gims.net.in/conference-fee.php">
	...
	<meta property="og:title" content="Conference Fee | GNIOT Institute of Management Studies">
	<meta property="og:description" content="Conference Fee - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India.">
	<meta property="og:url" content="https://www.gims.net.in/conference-fee.php">
	<meta property="fb:app_id" content="573928583391257">

    
	<meta name="twitter:card" content="summary">
	<meta name="twitter:site" content="@gims_net_in">
	<meta name="twitter:title" content="Conference Fee | GNIOT Institute of Management Studies">
	<meta name="twitter:description" content="Conference Fee - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India.">
	
	<!-- Open Graph general (Facebook, Pinterest & Google+) -->
	<meta name="og:title" content="Conference Fee | GNIOT Institute of Management Studies"/>
	<meta name="og:url" content="https://www.gims.net.in/conference-fee.php">
	...
	<script type="application/ld+json">
	 ...
	 "url": "https://www.gims.net.in/conference-fee.php",
	 "sameAs": [
            ...
            <div class="intro">
                <div class="container-fluid custom_container">
                    <div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							<h1 class="page-t">Conference Fee</h1>
									...
									<div class="col-lg-12">
                                        <div class="col-lg-12 new-pd9 awardbg2">
                                            ...
                                            <table class="new-t">
                                                    ...
                                                    <tr>
                                                    <td>International/ National Academician </td>
                                                    <td>RS. 1500</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <th colspan="2">
                                                            Research Workshop Fee
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            International/ National Academician / Research Scholar /    Participants / Industry Delegates
                                                        </td>
                                                        <td>
                                                            Rs. 1000
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <th>Research workshop Cum Conference fee</th>
                                                        <th>Rs. 2000</th>
                                                    </tr>
                                            ...
                                            <!-- <table class="tablegims">
                                                    ...
                                                    <tr>
                                                        <td>Research Scholars/Student</td>
                                                        <td>500 (INR)</td>
                                                        <td>750 (INR)</td>
                                                    </tr>
                                                    <tr>
                                                ...
                                                <!-- <p class="pgdmtextnew">
                                                ❖	Registration fee includes tea, lunch and conference kit.<br>
                                                ❖	No TA/DA will be provided to any participant.<br>
                                                ❖	Author(s) with multiple papers has to register separately for each paper with a 25% discount on each paper's fee.<br>
                                                </p> -->
                                                <!-- <table class="tablegims">
                                                Registration fee is payable by Online Bank Transfer. The details are as follows:
                                                    <tr>
                                                        <td>Bank Name & Address:</td>
                                                        <td>CANARA BANK, Greater Noida, Uttar Pradesh 201306</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Branch:</td>
                                                        <td>Greater Noida</td>
