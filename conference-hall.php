...
<head>
    ...
    <title>Conference Hall | Top Management Colleges in Greater Noida</title>
	<meta name="description" content="Conference Hall - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Conference Hall</div>
            ...
            <div class="intro">
                <div class="container custom_container">
                    <div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							<h1 class="page-t">Conference Hall</h1>
								...
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<div class="placement-process">
                                            <p class="new-text">
                                                Also various seminars, workshops, student and faculty interaction, faculty meetings, conferences and corporate interface activities are organized in the well-furnished, fully air conditioned conference hall. The conference hall is equipped with all the state-of-the-art audio-visual aids with a capacity to accommodate around 75 -100 people.   
                                            </p>
                                        </div>
                                        <br/>
                                        <br/>
                                        <div class="gallery-box">
                                            <div class="row">
                                                <div class="col-md-4 popup-box">
                                                    <a class="example-image-link" href="img/conference-hall/1.jpg" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/conference-hall/1.jpg" alt="GIMS Conference Hall"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-4 popup-box">
                                                    <a class="example-image-link" href="img/conference-hall/2.jpg" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/conference-hall/2.jpg" alt="GIMS Conference Hall"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-4 popup-box">
                                                    <a class="example-image-link" href="img/conference-hall/3.jpg" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/conference-hall/3.jpg" alt="GIMS Conference Hall"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-4 popup-box">
                                                    <a class="example-image-link" href="img/conference-hall/4.jpg" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/conference-hall/4.jpg" alt="GIMS Conference Hall"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-4 popup-box">
                                                    <a class="example-image-link" href="img/conference-hall/5.jpg" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/conference-hall/5.jpg" alt="GIMS Conference Hall"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-4 popup-box">
                                                    <a class="example-image-link" href="img/classrooms/c-room-9.webp" data-lightbox="example-set" ><img class="example-image" src="img/classrooms/c-room-9.webp" alt="GIMS Conference Hall"/></a>
                                                </div>
                                                <div class="col-md-4 popup-box">
                                                    <a class="example-image-link" href="img/classrooms/c-room-10.webp" data-lightbox="example-set" ><img class="example-image" src="img/classrooms/c-room-10.webp" alt="GIMS Conference Hall"/></a>
                                                </div>
                                                <div class="col-md-4 popup-box">
                                                    <a class="example-image-link" href="img/classrooms/c-room-11.webp" data-lightbox="example-set" ><img class="example-image" src="img/classrooms/c-room-11.webp" alt="GIMS Conference Hall"/></a>
                                                </div>
                                                <div class="col-md-4 popup-box">
                                                    <a class="example-image-link" href="img/classrooms/c-room-12.webp" data-lightbox="example-set" ><img class="example-image" src="img/classrooms/c-room-12.webp" alt="GIMS Conference Hall"/></a>
                                                </div>
                                            </div>
                                        </div>
									</div>
