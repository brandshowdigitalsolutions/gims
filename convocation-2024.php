...
<head>
    ...
    <title>Convocation 2024 | Top Management Colleges in Greater Noida</title>
	<meta name="description" content="AICTE - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">AICTE</div>
            ...
            <div class="intro">
                <div class="container custom_container">
                    <div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							<h1 class="page-t">Convocation 2024</h1>
								...
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<div class="placement-process">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/convo-25.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/convo-25.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/convo-25-1.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/convo-25-1.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/convo-25-2.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/convo-25-2.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/convo-25-3.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/convo-25-3.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/convo-25-4.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/convo-25-4.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/convo-25-5.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/convo-25-5.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/convo-25-6.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/convo-25-6.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/convo-25-7.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/convo-25-7.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/convo-25-8.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/convo-25-8.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/convo-25-9.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/convo-25-9.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/convo-25-10.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/convo-25-10.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>
                                            </div>
                                            </div>
