...
<head>
    ...
    <title>Convocation 2025 | Top Management Colleges in Greater Noida</title>
            ...
            <div class="intro">
                <div class="container custom_container">
                    <div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							<h1 class="page-t">Convocation 2025</h1>
										...
										<div class="placement-process">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/2025/convo-1.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/2025/convo-1.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>

                                                 <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/2025/convo-2.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/2025/convo-2.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>

                                                 <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/2025/convo-3.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/2025/convo-3.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>

                                                 <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/2025/convo-4.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/2025/convo-4.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>

                                                 <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/2025/convo-5.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/2025/convo-5.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>

                                                 <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/2025/convo-6.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/2025/convo-6.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>

                                                 <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/2025/convo-7.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/2025/convo-7.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>

                                                 <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/2025/convo-8.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/2025/convo-8.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>

                                                 <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/2025/convo-9.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/2025/convo-9.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>

                                                 <div class="col-md-12 popup-box">
                                                    <a class="example-image-link" href="img/convocations/2025/convo-10.webp" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/convocations/2025/convo-10.webp" alt="convocations-2025"/>
                                                    </a>
                                                </div>
                                            </div>
                                            </div>
