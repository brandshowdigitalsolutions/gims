...
<head>
    ...
    <title>Convocation 2023 | Top Management Colleges in Greater Noida</title>
                ...
                <div class="container custom_container">
                    <div class="row align-items-center new-pd4 zoomanimate">
						<div class="col-lg-12">
							<ul class="breadcrumb">
							  <li><a href="#">Home</a></li>
							  <li><a href="#">Convocation 2023</a></li>
							  <!-- <li>AICTE</li> -->
							</ul>
						</div>
						<div class="col-lg-12">
							<h1 class="page-t">Convocation 2023</h1>
                                            ...
                                            <div class="gallery-box">
                                                <div class="row">
                                                    <div class="col-md-12 popup-box">
                                                        <a class="example-image-link" href="img/convocations/convo-1.webp" data-lightbox="example-set" >
                                                            <img class="example-image" src="img/convocations/convo-1.webp" alt="convocations-2025"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-md-12 popup-box">
                                                        <a class="example-image-link" href="img/convocations/convo-2.webp" data-lightbox="example-set" >
                                                            <img class="example-image" src="img/convocations/convo-2.webp" alt="convocations-2025"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-md-12 popup-box">
                                                        <a class="example-image-link" href="img/convocations/convo-3.webp" data-lightbox="example-set" >
                                                            <img class="example-image" src="img/convocations/convo-3.webp" alt="convocations-2025"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-md-12 popup-box">
                                                        <a class="example-image-link" href="img/convocations/convo-4.webp" data-lightbox="example-set" >
                                                            <img class="example-image" src="img/convocations/convo-4.webp" alt="convocations-2025"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-md-12 popup-box">
                                                        <a class="example-image-link" href="img/convocations/convo-5.webp" data-lightbox="example-set" >
                                                            <img class="example-image" src="img/convocations/convo-5.webp" alt="convocations-2025"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-md-12 popup-box">
                                                        <a class="example-image-link" href="img/convocations/convo-6.webp" data-lightbox="example-set" >
                                                            <img class="example-image" src="img/convocations/convo-6.webp" alt="convocations-2025"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-md-12 popup-box">
                                                        <a class="example-image-link" href="img/convocations/convo-7.webp" data-lightbox="example-set" >
                                                            <img class="example-image" src="img/convocations/convo-7.webp" alt="convocations-2025"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-md-12 popup-box">
                                                        <a class="example-image-link" href="img/convocations/convo-8.webp" data-lightbox="example-set" >
                                                            <img class="example-image" src="img/convocations/convo-8.webp" alt="convocations-2025"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-md-12 popup-box">
                                                        <a class="example-image-link" href="img/convocations/convo-9.webp" data-lightbox="example-set" >
                                                            <img class="example-image" src="img/convocations/convo-9.webp" alt="convocations-2025"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-md-12 popup-box">
                                                        <a class="example-image-link" href="img/convocations/convo-10.webp" data-lightbox="example-set" >
                                                            <img class="example-image" src="img/convocations/convo-10.webp" alt="convocations-2025"/>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
