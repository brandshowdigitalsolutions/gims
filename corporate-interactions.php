...
<head>
    ...
    <title>Corporate Interactions</title>
	<meta name="description" content="Corporate Interactions - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Corporate Interactions</div>
            ...
            <div class="intro">
                <div class="container custom_container">
                    <div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							<h1 class="page-t">Corporate Interactions</h1>
							...
							<div class="row">
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <img src="img/crc/ci1.jpg" alt="">
                                            </div>
                                            <div class="col-md-6">
                                                <img src="img/crc/ci2-new.jpg" alt="">
                                            </div>
                                            <div class="col-md-6">
                                                <img src="img/crc/ci3-new.jpg" alt="">
                                            </div>
                                            <div class="col-md-6">
                                                <img src="img/crc/ci4-new.jpg" alt="">
                                            </div>
                                        </div>
									</div>
								</div>
