...
<head>
    ...
    <title>Chanakya Talk Series</title>
	<meta name="description" content="Chanakya Talk Series - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Chanakya Talk Series</div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
						<div class="col-lg-12">
							<ul class="breadcrumb">
							  ...
							  <li>Chanakya Talk Series</li>
							</ul>
						</div>
						<div class="col-lg-12">
							<h1 class="page-t">Chanakya Talk Series</h1>
							...
							<div class="row">
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <img src="img/crc/cts1.jpg" alt="">
                                            </div>
                                            <div class="col-md-6">
                                                <img src="img/crc/cts2.jpg" alt="">
                                            </div>
                                            <div class="col-md-6">
                                                <img src="img/crc/cts3.jpg" alt="">
                                            </div>
                                            <div class="col-md-6">
                                                <img src="img/crc/cts4.jpg" alt="">
                                            </div>
                                            <div class="col-md-6">
                                                <img src="img/crc/cts5.jpg" alt="">
                                            </div>
                                            <div class="col-md-6">
                                                <img src="img/crc/cts6.jpg" alt="">
                                            </div>
                                        </div>
									</div>
								</div>
