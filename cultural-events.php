...
<head>
    ...
    <title>Cultural Events | Top Management Colleges in Greater Noida</title>
	<meta name="description" content="Cultural Events - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Cultural Events</div>
            ...
            <div class="intro">
                <div class="container custom_container">
                    <div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							<h1 class="page-t">Cultural Events</h1>
							<h3 class="sub-t">GIMS (PGDM Institute) - Greater Noida</h3>
						</div>
							...
							<div class="row">
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<p class="pgdmtext">
											GNIOT Institute of Management Studies (GIMS)  has its own cultural and literary four days fest called 'AAGHAAZ'. It sees a lot of participation of students from other colleges as well. It is the biggest annual function hosted by students. Students from all the programs come together to organize competitions at a national scale. The fest is a three days event and goes on all day long and students just keep frantically moving from one competition to another, trying to take part in as many of them as they can. The icing on the cake would be the evenings which are even better when after an entire hectic day consisting of soulful tracks by singers, battle of bands, etc.
											<br/>
											<br/>
										</p>
									</div>
