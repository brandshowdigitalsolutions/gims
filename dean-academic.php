...
<head>
    ...
    <title>Message of the Dean – Academics  | Top Management Colleges in Greater Noida</title>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Message of the Dean Academics</div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							...
							<ul class="breadcrumb">
							  ...
							  <li>Message of the Dean Academics</li>
						...
						<div class="col-lg-12">
							...
							<h1 class="page-t">Message of the Dean Academics</h1>

							<!-- <h3 class="sub-t">Dr. Shalini Sharma - Dean- Outreach and Student Welfare(OSW)</h3> -->
