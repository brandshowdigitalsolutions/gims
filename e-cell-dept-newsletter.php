...
<head>
	...
	<title>E-cell Newsletter | GIMS</title>

	<meta name="description" content="Discover what’s new at GIMS with our E-cell Newsletter, featuring success stories, event updates, and the latest campus news." />

	<meta name="keywords" content="PGDM College, E-cell Newsletter, Educational Leadership, Visionary Leaders, Academic Excellence, Higher Education, College Governance, Institutional Leadership, College Trustees, Decision-Making Body"/>
	...
	<!-- Favicon -->
    <link rel="alternate" href="https://www.gims.net.in/E-cell-dept-newsletter.php" hreflang="es-us" />

	<link rel="canonical" href="https://www.gims.net.in/E-cell-dept-newsletter.php">
	...
	<meta property="og:title" content="E-cell Newsletter">

	<meta property="og:description" content="Discover what’s new at GIMS with our E-cell Newsletter, featuring success stories, event updates, and the latest campus news.">

	<meta property="og:url" content="https://www.gims.net.in/E-cell-dept-newsletter.php">
	...
	<meta name="twitter:title" content="E-cell Newsletter">

	<meta name="twitter:description" content="Discover what’s new at GIMS with our E-cell Newsletter, featuring success stories, event updates, and the latest campus news.">



	<!-- Open Graph general (Facebook, Pinterest & Google+) -->

	<meta name="og:title" content="E-cell Newsletter" />

	<meta name="og:url" content="https://www.gims.net.in/E-cell-dept-newsletter.php">
	...
	<script type="application/ld+json">

		{
			...
			"url": "https://www.gims.net.in/E-cell-dept-newsletter.php",
				...
				<div class="container custom_container">
					...
					<div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							...
							<h1 class="page-t">E-cell Newsletter</h1>

							<h3 class="sub-t">GIMS E-cell </h3>
                                        ...
                                        <div class="col-md-4 col-6">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="view  zoom z-depth-1">
                                                        ...
                                                        <img alt="" class="card-img-top" src="img/news-letter/jan-2025.webp">
                                                        <div class="mask flex-center blue-gradient-rgba">

                                                            <a class="btn btn-sm btn-white waves-effect waves-light" href="pdf/new-letter/newsletter-january-2025-volume-01-issue-01.pdf" target="_blank">
                                                    ...
                                                    <div class="card-footer">January 2025 Volume-01 | Issue-01</div>
                                            ...
                                            <!-- <div class="col-md-4 col-6">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="view  zoom z-depth-1">
                                                        ...
                                                        <img alt="" class="card-img-top" src="img/news-letter/gims-alumini-connet-2-0-(E-cell-conclave-2024)-april-vol-1-isse-1.png">
                                                        <div class="mask flex-center blue-gradient-rgba">

                                                            <a class="btn btn-sm btn-white waves-effect waves-light" E-cellef="pdf/gims-alumini-connet-2-0-(E-cell-conclave-2024)-april-vol-1-isse-1.pdf" target="_blank">
                                                    ...
                                                    <div class="card-footer">October 2024

                                                        Volume-2 | Issue-10</div>
