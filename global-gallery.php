...
<head>
	...
	<meta name="description" content="Global Engagement Gallery - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Global Engagement Gallery</div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							...
							<ul class="breadcrumb">
							  ...
							  <li>Global Engagement Gallery</li>
							</ul>
                                            ...
                                            <div class="gallery-box">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 popup-box">
                                                        ...
                                                        <a class="example-image-link" href="img/global-gallery/gallery-1.webp" data-lightbox="example-set" ><img class="example-image" src="img/global-gallery/gallery-1.webp" alt="Gims Gallery"/></a>

                                                    </div>

                                                    <div class="col-md-4 popup-box">

                                                        <a class="example-image-link" href="img/global-gallery/gallery-2.webp" data-lightbox="example-set" ><img class="example-image" src="img/global-gallery/gallery-2.webp" alt="Gims Gallery"/></a>

                                                    </div>

                                                    <div class="col-md-4 popup-box">

                                                        <a class="example-image-link" href="img/global-gallery/gallery-3.webp" data-lightbox="example-set" ><img class="example-image" src="img/global-gallery/gallery-3.webp" alt="Gims Gallery"/></a>
