...
<head>
    ...
    <title>Global Talk Series</title>
    <meta name="description"
        content="Global Talk Series – Global Engagements - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India." />
    <meta name="keywords"
...
<body class="home_four">
    ...
    <div id="wavescroll">
        ...
        <section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Global Talk Series</div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        <div class="col-lg-12">
                            <ul class="breadcrumb">
                                ...
                                <li>Global Talk Series</li>
                            </ul>
                        </div>
                        <div class="col-lg-12">
                            <h1 class="page-t">Global Talk Series</h1>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-9">
                                    <div class="col-lg-12 new-pd9 awardbg2">
                                        <h1 class="page-t">Global Talk Series</h1>
                                        <p class="pgdmtext">
                                            The <strong>Global Talk Series</strong> is a flagship initiative of the <strong>Department of Global
                                            Engagement, GIMS</strong>, designed to connect students, faculty, and academic
                                            leaders with distinguished international academicians, industry experts,
                                            policymakers, entrepreneurs, and thought leaders from across the world.
                                        </p>
                                        <h3>Objectives</h3>
                                        <ol type="1">
                                            <li>Promote Internationalisation at Home</li>
                                            <li>Enhance Global Perspectives</li>
                                            <li>Strengthen Cross-Cultural Understanding</li>
                                            <li>Facilitate Academic and Research Collaboration</li>
                                            <li>Bridge Academia and Industry</li>
                                            <li>Support Career and Professional Development</li>
                                            <li>Strengthen Institutional Global Partnerships</li>
                                            <li>Encourage Knowledge Exchange</li>
                                            <li>Encourage Knowledge Exchange</li>
                                        </ol>
