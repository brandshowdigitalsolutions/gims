...
<head>
    ...
    <title>Corporate Mentor - Mr. Harsh Raj Jain  | Top Management Colleges in Greater Noida</title>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Corporate Mentor - Mr. Harsh Raj Jain </div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							...
							<ul class="breadcrumb">
							  ...
							  <li>Corporate Mentor - Mr. Harsh Raj Jain </li>
						...
						<div class="col-lg-12">
							...
							<h3 class="sub-t">Mr. Harsh Raj Jain</h3>
								...
								<div class="col-lg-9">
									...
									<div class="col-lg-12 new-pd9 awardbg2">
										...
										<p class="pgdmtext">
											...
											<img src="img/banner/harsh-raj-jain.jpg" class="msgs" alt="Chairman Message" />
											...
											Congratulations on reaching this significant milestone in your academic journey! As you prepare to embark on your professional careers, I’d like to share some insights and expectations from the perspective of a corporate HR mentor. Understanding these expectations can help you transition smoothly into the corporate world and set you on a path to success.

											<br/>

											<br/>

											<strong>Professionalism and Work Ethic-</strong> Professionalism is key to making a positive impression. This includes punctuality, dressing appropriately, and exhibiting a positive attitude. A strong work ethic, characterized by diligence, reliability, and a commitment to excellence, is highly valued. 

											<br/>

											<br/>

											<strong>Team Collaboration-</strong> Most projects in the corporate world are team-based. Your ability to work well within a team, showing respect for diverse opinions and contributing positively, will be crucial. Building strong interpersonal relationships can significantly enhance your effectiveness and satisfaction at work. 

											<br/>

											<br/>

											Apart from the above points do also focus on your technological proficiency, integrity and ethical conduct & stay self-motivation and initiative. 
                                           ...
                                           <br/>
                                            ...
                                            <br>
											APAC & India Campus Lead, <br>Ebixcash
											</strong>
