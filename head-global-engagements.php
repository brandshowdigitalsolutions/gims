...
<head>
    ...
    <title>Message from the Head – Global Engagements | Top Management Colleges in Greater Noida</title>
	<meta name="description" content="Message from the Head – Global Engagements - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Message from the Head – Global Engagements</div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
						<div class="col-lg-12">
							<ul class="breadcrumb">
							  ...
							  <li>Message from the Head – Global Engagements</li>
							</ul>
						</div>
						<div class="col-lg-12">
							<h1 class="page-t">Message from the Head – Global Engagements</h1>
							<h3 class="sub-t">Prof. Charul Sharma Head – Global Engagements</h3>
						</div>
							...
							<div class="row">
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<p class="pgdmtext">
											<img src="img/message-head/message-head-charul3.webp?v=1" class="msgs" alt="directer" />
											<span style=" font-size: 60px; float: left; line-height: 51px; margin-right: 6px; font-family: auto; ">A</span>
											t GNIOT Institute of Management Studies (GIMS),India, we take pride in being recognized for the global exposure we provide to our PGDM students. We firmly believe that international exposure is a must-have for future leaders, equipping them with the perspectives and competencies needed to excel in a dynamic world.
                                            <br>
                                            In line with this vision, GIMS has been continuously building strong networks with embassies and forging collaborations with leading global universities, establishing more than 20 international collaborations worldwide. Our initiatives include the successful launch of the COIL (Collaborative Online International Learning) program, joint research projects, international conferences, and other impactful academic collaborations that enrich both our faculty and student communities.
                                            <br>
                                            A key highlight of our efforts is the International Immersion Program, which has already taken our students across nine countries—including Malaysia, Dubai, Singapore, Georgia, Abu Dhabi, Oman, Bahrain, Vietnam, and Almaty—with more destinations continuously being added. These programs provide invaluable opportunities for our PGDM students to experience diverse cultures, business practices, and international markets—strengthening their ability to thrive in a global environment.
                                            <br>
                                            We remain committed to expanding these global engagements and creating world-class opportunities for our students
											<br/>
                                            <span style="font-weight: bold; font-style: italic;">“Shaping Global Leaders Through International Exposure.”</span>
											<br/>
											<strong>
												Prof. Charul Sharma<br/>
                                                Assistant Professor<br/>
												Head – Global Engagements <br>
                                                Alumni Coordinator (Alumni Dept)<br/>
                                                GNIOT Institute of Management Studies (GIMS), India <br>
                                                Email id- <a href="mailto:head.globalengagements@gims.net.in"> head.globalengagements@gims.net.in</a><br>
                                                Phone: +91-8860606623
											</strong>
										</p>
									</div>
