...
<head>
    ...
    <title>Hostel Facility | Top Management Colleges in Greater Noida</title>
	<meta name="description" content="Hostel Facility - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Hostel Facility</div>
            ...
            <div class="intro">
                <div class="container custom_container">
                    <div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							<h1 class="page-t">Hostel Facility</h1>
								...
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<div class="placement-process">
                                            <p class="new-text">
                                                Both the Girls’ and Boys’ hostels are within the campus and are well-furnished twin and single sharing, A.C and non-AC rooms with all the basic facilities. The hostel mess provides healthy and scrumptious food based on the menu decided unanimously by the food committee which comprises some student representatives too. Both the hostels provide the fitness centre well-armed with the latest fitness equipment for the students to maintain their health and stay stimulating all the day.   
                                            </p>
                                        ...
                                        <div class="gallery-box">
                                            <div class="row">
                                                <div class="col-md-4 popup-box">
                                                    <a class="example-image-link" href="img/hostel-facility/1.jpg" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/hostel-facility/1.jpg" alt="GIMS Computer Lab"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-4 popup-box">
                                                    <a class="example-image-link" href="img/hostel-facility/2.jpg" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/hostel-facility/2.jpg" alt="GIMS Computer Lab"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-4 popup-box">
                                                    <a class="example-image-link" href="img/hostel-facility/3.jpg" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/hostel-facility/3.jpg" alt="GIMS Computer Lab"/>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
