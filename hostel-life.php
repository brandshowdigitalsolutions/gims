...
<head>
    ...
    <title>Hostel Life | Top Management Colleges in Greater Noida</title>
	<meta name="description" content="Hostel Life - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Hostel Life</div>
            ...
            <div class="intro">
                <div class="container custom_container">
                    <div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							<h1 class="page-t">Hostel Life</h1>
							<h3 class="sub-t">Hostel Life - Greater Noida</h3>
						</div>
							...
							<div class="row">
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<p class="pgdmtext">
											Separate accommodation for boys and girls with spacious and well-furnished hostel rooms. Both hostels are located in the college campus itself with at-par ultra-modern living environs. The hostels are designed to provide a proper mix of privacy & a unique social experience with 24x7 Local Area Network connectivity & Internet connectivity. The hostel also has sports and other recreational facilities for the students. For indoor activities there is a table tennis room, in addition to a well-equipped modern gymnasium. There is a common TV area where the students can enjoy cricket matches and other programs in large groups. The mess and cafeteria of the college campus provide hygienic and healthy food with an extensive menu to select from.
											<br/>
											<br/>
										</p>
									</div>
