...
<head>
	...
	<title>HR Newsletter | GIMS</title>

	<meta name="description"
		content="Discover what’s new at GIMS with our HR Newsletter, featuring success stories, event updates, and the latest campus news." />

	<meta name="keywords"
		content="PGDM College, HR Newsletter, Educational Leadership, Visionary Leaders, Academic Excellence, Higher Education, College Governance, Institutional Leadership, College Trustees, Decision-Making Body" />
	...
	<!-- Favicon -->
	<link rel="alternate" href="https://www.gims.net.in/hr-dept-newsletter.php" hreflang="es-us" />

	<link rel="canonical" href="https://www.gims.net.in/hr-dept-newsletter.php">
	...
	<meta property="og:title" content="HR Newsletter">

	<meta property="og:description"
		content="Discover what’s new at GIMS with our HR Newsletter, featuring success stories, event updates, and the latest campus news.">

	<meta property="og:url" content="https://www.gims.net.in/hr-dept-newsletter.php">
	...
	<meta name="twitter:title" content="HR Newsletter">
	...
	<meta name="og:title" content="HR Newsletter" />

	<meta name="og:url" content="https://www.gims.net.in/hr-dept-newsletter.php">
	...
	<script type="application/ld+json">

		{
			...
			"url": "https://www.gims.net.in/hr-dept-newsletter.php",
...
<body class="home_four">
	...
	<div id="wavescroll">
		...
		<section class="section wave_two_section_two">
			...
			<div class="text" style="font-size:34px;">HR Newsletter</div>
				...
				<div class="container custom_container">
					...
					<div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							...
							<h1 class="page-t">HR Newsletter</h1>

							<h3 class="sub-t">GIMS HR </h3>
												...
												<div class="card">
													...
													<div class="view  zoom z-depth-1">
														...
														<img alt="" class="card-img-top"
															src="img/news-letter/hr-dept-newsletter-mar-2026-vol-2-issue-3.webp">
														<div class="mask flex-center blue-gradient-rgba">

															<a class="btn btn-sm btn-white waves-effect waves-light"
																href="pdf/new-letter/hr-dept-newsletter-mar-2026-vol-2-issue-3.pdf"
																target="_blank">
													...
													<div class="card-footer">March 2026 | Volume-02 | Issue-03</div>
											...
											<div class="col-md-4 col-6">
												...
												<div class="card">
													...
													<div class="view  zoom z-depth-1">
														...
														<img alt="" class="card-img-top"
															src="img/news-letter/hr-dept-newsletter-dec-2025-vol-2-issue-2.webp">
														<div class="mask flex-center blue-gradient-rgba">

															<a class="btn btn-sm btn-white waves-effect waves-light"
																href="pdf/new-letter/hr-dept-newsletter-dec-2025-vol-2-issue-2.pdf"
																target="_blank">
													...
													<div class="card-footer">December 2025 | Volume-02 | Issue-02</div>
											...
											<div class="col-md-4 col-6">
												...
												<div class="card">
													...
													<div class="view  zoom z-depth-1">
														...
														<img alt="" class="card-img-top"
															src="img/news-letter/hr-dept-newsletter-sept-2025-vol-2-issue-2.webp">
														<div class="mask flex-center blue-gradient-rgba">

															<a class="btn btn-sm btn-white waves-effect waves-light"
																href="pdf/new-letter/hr-dept-newsletter-sept-2025-vol-2-issue-2.pdf"
																target="_blank">
													...
													<div class="card-footer">September 2025 | Volume-02 | Issue-01</div>
											...
											<div class="col-md-4 col-6">
												...
												<div class="card">
													...
													<div class="view  zoom z-depth-1">
														...
														<img alt="" class="card-img-top"
															src="img/news-letter/hr-dept-newsletter-nov-2024-vol-1-issue-3.webp">
														<div class="mask flex-center blue-gradient-rgba">

															<a class="btn btn-sm btn-white waves-effect waves-light"
																href="pdf/new-letter/hr-dept-newsletter-nov-2024-vol-1-issue-3.pdf"
																target="_blank">
													...
													<div class="card-footer">November 2024 | Volume-01 | Issue-03</div>
											...
											<div class="col-md-4 col-6">
												...
												<div class="card">
													...
													<div class="view  zoom z-depth-1">
														...
														<img alt="" class="card-img-top"
															src="img/news-letter/hr-dept-newsletter.png">
														<div class="mask flex-center blue-gradient-rgba">

															<a class="btn btn-sm btn-white waves-effect waves-light"
																href="pdf/hr-newsletter-2-0.pdf" target="_blank">
													...
													<div class="card-footer">July 2024 | Volume-01 | Issue-02</div>
											...
											<div class="col-md-4 col-6">
												...
												<div class="card">
													...
													<div class="view  zoom z-depth-1">
														...
														<img alt="" class="card-img-top"
															src="img/news-letter/gims-alumini-connet-2-0-(hr-conclave-2024)-april-vol-1-isse-1.png">
														<div class="mask flex-center blue-gradient-rgba">

															<a class="btn btn-sm btn-white waves-effect waves-light"
																href="pdf/gims-alumini-connet-2-0-(hr-conclave-2024)-april-vol-1-isse-1.pdf"
																target="_blank">
													...
													<div class="card-footer">April 2024 | Volume-01 | Issue-01</div>
