...
<head>
    <meta charset="utf-8">
    <title>Prof. Silki Gaur - GNIOT Institute of Management Studies</title>
    <meta name="description" content="Prof. Silki Gaur - Best PGDM private Colleges in Delhi, India, Top GBTU Colleges, Top  PGDM  Colleges, Best PGDM Institute Top 10 Rank PGDM College in Delhi NCR" />
    <meta name="keywords" content="Prof. Silki Gaur, GIMS faculty members,GIMS faculty profiles,GIMS faculty directory,GIMS faculty qualifications,GIMS faculty expertise,GIMS faculty research areas,GIMS faculty publications,GIMS faculty contact information,GIMS faculty achievements,GIMS faculty experience,GIMS faculty specializations,GIMS faculty academic background,GIMS faculty professional affiliations,GIMS faculty teaching philosophy." />
    ...
    <link rel="alternate" href="https://www.gims.net.in/silki-gaur.php" hreflang="es-us" />
    <link rel="canonical" href="https://www.gims.net.in/silki-gaur.php">
    ...
    <meta property="og:title" content="Prof. Silki Gaur - GNIOT Institute of Management Studies">
    <meta property="og:description" content="Prof. Silki Gaur - Best PGDM private Colleges in Delhi, India, Top GBTU Colleges, Top  PGDM  Colleges, Best PGDM Institute Top 10 Rank PGDM College in Delhi NCR">
    <meta property="og:url" content="https://www.gims.net.in/silki-gaur.php">
    <meta property="fb:app_id" content="573928583391257">


    <meta name="twitter:card" content="summary">
    <meta name="twitter:site" content="@GNIOTCollege">
    <meta name="twitter:title" content="Prof. Silki Gaur - GNIOT Institute of Management Studies">
    <meta name="twitter:description" content="Prof. Silki Gaur - Best PGDM private Colleges in Delhi, India, Top GBTU Colleges, Top  PGDM  Colleges, Best PGDM Institute Top 10 Rank PGDM College in Delhi NCR">

    <!-- Open Graph general (Facebook, Pinterest & Google+) -->
    <meta name="og:title" content="Prof. Silki Gaur - GNIOT Institute of Management Studies" />
    <meta name="og:url" content="https://www.gims.net.in/silki-gaur.php">
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "https://www.gims.net.in/silki-gaur.php",
            "sameAs": [
...
<body class="home_four">
    ...
    <div id="wavescroll">
        ...
        <section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Prof. Vibhanshu</div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        <div class="col-lg-12">
                            <ul class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li>Faculty</li>
                                <li>Prof. Silki Gaur</li>
                            </ul>
                        </div>
                        <div class="col-lg-12">
                            <h1 class="page-t">Prof. Silki Gaur</h1>
                                ...
                                <div class="col-lg-9">
                                    <div class="col-lg-12 new-pd9 awardbg2">
                                        <div class="facdiv">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="img/faculty/faculty.jpg" alt="Prof. Vibhanshu" width="100%">
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="facpinfo">
                                                        <p class="facdetail">
                                                            <span>Name:</span> Prof. Silki Gaur<br>
                                                            <span>Designation:</span> Assistant Professor <br>
                                                            <span>Area:</span> Marketing<br>
                                                            <span>Email id:</span> <a href="mailto:silkygaur.pgdm@gniot.net.in">silkygaur.pgdm@gniot.net.in</a> <br>
                                                            <span>Vidwan ID: </span> 384588<br>
                                                            <span>ORICID ID: </span> 0000-0001-8341-1195<br>
                                                            <span></span> <a class="linkedinic" href="https://www.linkedin.com/in/silky-gaur21/" target="_blank"><svg width="80px" height="20px" viewBox="20 0 500 140" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                                                                    <g>
                                                        ...
                                                        <p class="brfprofile"><b>Brief Profile: </b> Prof. Silky Gaur is a marketing enthusiast with a keen interest in the areas of consumer behaviour and branding. She is NET qualified and is pursuing her Ph.D. in Marketing.</p>
                                                ...
                                                <div class="col-md-12">
                                                        ...
                                                        <div id="Button1" class="tabcontent links" style="display:block;">
                                                            ...
                                                            <ul class="facul">
                                                                <li>Gaur S, Gupta R, (2019) Video Streaming Services in India: Do the 7 P's of Marketing Apply? Comprehensive Advanced Specific Summarised Studies.3(1), Addendum 3 (Special Issue).</li>
                                                            </ul>

                                                        </div>

                                                        <div id="Button2" class="tabcontent links">
                                                            <p class="factitle">Conference Participation</p>
                                                            <ul class="facul">
                                                                <li>Gaur S, Gupta R, (2019) Video Streaming Services in India: Do the 7 P's of Marketing Apply?  GLRC 2019</li>
                                                                <li>Assessing e-service quality and its impact on customer satisfaction and repurchase intentions in video streaming services. Silky Gaur, Rahul Gupta and Jaspreet Kaur GLRC 2021</li>
                                                                <li>A factor analysis study on relationship across electronic-service quality & behavioral intent with structural equation modeling: Across algo driven shopping apps & fintech platforms GLRC 2023</li>
                                                            </ul>
                                                            <p class="factitle">Edited Chapter</p>
                                                            <ul class="facul">
                                                                <li>Gaur, S., Gupta, R., & Kaur, J. (2022). Assessing E-Services: Satisfaction and Repurchase Intentions Among Viewers of Video Streaming Services. In Multidisciplinary Perspectives Towards Building a Digitally Competent Society (pp. 14). DOI: 10.4018/978-1-6684-5274-5.ch008</li>
                                                            </ul>
                                                        </div>
