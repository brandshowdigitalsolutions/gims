...
<body class="home_four">
	...
	<div class="topslider">
		<div class="main_slider">
			<div>
				<img class="mobileslideimg" src="https://www.gims.net.in/img/slider/iip-banner.webp" alt="International Immersion Program" width="100%">
			</div>
			<!--<div>-->
			<!--	<img class="mobileslideimg" src="https://www.gims.net.in/img/slider/iip2023.webp" alt="International Immersion Program" width="100%">-->
			<!--</div>-->
			<div>
				<img class="mobileslideimg" src="https://www.gims.net.in/img/slider/mou-de.webp" alt="International Immersion Program" width="100%">
			</div>
			<div>
				<img class="mobileslideimg" src="https://www.gims.net.in/img/slider/placement-records.webp" alt="International Immersion Program" width="100%">
			</div>
			<div>
				<img class="mobileslideimg" src="https://www.gims.net.in/img/slider/iip-pgdm.gif" alt="International Immersion Program" width="100%">
			</div>
			<div>
				<img class="mobileslideimg" src="https://www.gims.net.in/img/slider/iimbxa.jpg" alt="International Immersion Program" width="100%">
			</div>
		</div>
	</div>
	<div class="kl-slideshow uh_light_gray kl-revolution-slider">
			...
			<div class="phoneslider">
				<div class="pholesliderslick btncontrolphone">
					<div>
						<img class="mobileslideimg" src="https://www.gims.net.in/img/slider/iip-2023.webp" alt="International Immersion Program">
					</div>
					<!-- <div>
					...
					<div>
						<img class="mobileslideimg" src="https://www.gims.net.in/img/slider/mobile/excellent-placement.webp" alt="placement at gims">
					</div>
					<div>
						<img class="mobileslideimg" src="https://www.gims.net.in/img/slider/mobile/iip-program-gims-greater-noida.webp" alt="international immersion program">
					</div>
					<div>
						<img class="mobileslideimg" src="https://www.gims.net.in/img/slider/mobile/iimbx-accredated.webp" alt="iimb collaboration">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="cstmcontainer">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="recrulogo">
							<img src="img/accreditation/aibpm.jpg" alt="Accreditation">
							<img src="img/accreditation/aicte.jpg" alt="Accreditation">
							<img src="img/accreditation/aiims.jpg" alt="Accreditation">
							<img src="img/accreditation/atal.jpg" alt="Accreditation">
							<img src="img/accreditation/bfsi.jpg" alt="Accreditation">
							<img src="img/accreditation/dcal.jpg" alt="Accreditation">
							<!--<img src="img/accreditation/eim.jpg" alt="Accreditation">-->
							<img src="img/accreditation/iimb.jpg" alt="Accreditation">
							<img src="img/accreditation/lsus.jpg" alt="Accreditation">
							<img src="img/accreditation/msme.jpg" alt="Accreditation">
							<img src="img/accreditation/nhrd.jpg" alt="Accreditation">
							<img src="img/hlact.jpg" alt="Accreditation">
							<img src="img/accreditation/umesh.jpg" alt="Accreditation">
							<img src="img/accreditation/xlri.jpg" alt="Accreditation">
							<img src="img/accreditation/yiuva.jpg" alt="Accreditation">
...
.seeallbtn {
    ...
    border-radius: 50px;
		...
		<section>
			...
			<div class="celebslider">
					...
					<div>
						<div class="celebitem">
							<img src="img/celebrity/ashneer.webp" alt="Ashneer Grover">
							<div class="viewPart">
								<a href="https://youtu.be/r7lGpMcrl5w?si=OWx9zsv8WfqpLx3Q" target="_blank" class="viewPartlink"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-youtube"><path d="M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 1.4-1.4 49.56 49.56 0 0 1 16.2 0A2 2 0 0 1 21.5 7a24.12 24.12 0 0 1 0 10 2 2 0 0 1-1.4 1.4 49.55 49.55 0 0 1-16.2 0A2 2 0 0 1 2.5 17"/><path d="m10 15 5-3-5-3z"/></svg></a>
					...
					<div>
						<div class="celebitem">
							<img src="img/celebrity/panther.webp" alt="Ashish Vidyarthi">
							<div class="viewPart">
								<a href="https://youtu.be/TcCLASni_Jo?si=t-lWGtVXu6oa05Sn" target="_blank" class="viewPartlink"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-youtube"><path d="M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 1.4-1.4 49.56 49.56 0 0 1 16.2 0A2 2 0 0 1 21.5 7a24.12 24.12 0 0 1 0 10 2 2 0 0 1-1.4 1.4 49.55 49.55 0 0 1-16.2 0A2 2 0 0 1 2.5 17"/><path d="m10 15 5-3-5-3z"/></svg></a>
					...
					<div>
						<div class="celebitem">
							<img src="img/celebrity/pranjal-dahiya.webp" alt="Pranjal Dahiya">
							<div class="viewPart">
								<a href="https://youtu.be/63F3BerExDY?si=KywOT7374xapREZB" target="_blank" class="viewPartlink"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-youtube"><path d="M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 1.4-1.4 49.56 49.56 0 0 1 16.2 0A2 2 0 0 1 21.5 7a24.12 24.12 0 0 1 0 10 2 2 0 0 1-1.4 1.4 49.55 49.55 0 0 1-16.2 0A2 2 0 0 1 2.5 17"/><path d="m10 15 5-3-5-3z"/></svg></a>
    ...
    box-shadow: 0px 0px 35px #00000015;
						...
						<img class="placementimg" src="https://www.gims.net.in/img/top-average-placments.webp" alt="Top Average Placments">
					</div>
				</div>
			</div>
		</section>
						...
						<div class="carousel-inner">
							...
							<div class="item">
								<div class="row no-margin pd10">
									...
									<div class="col-lg-4 col-xs-12 col-sm-6 mt-onmob ds-flex">
										<div class="col-lg-12 placestudiv bg1">
											<img src="img/placement/shreya.jpg" alt="Priyanka Srivastava" class="professorpic">
		...
		<section class="section newgrey-bg">
			<div class="container">
				<div class="row wow fadeInUp animated no-margin">
					<div class="col-lg-5 pd30">
						<img src="img/news1.jpg" class="fancyimg" alt="College Fest" />
						<img src="img/news2.jpg" class="fancyimg newimgs" alt="PGDM Admission" style="right: 0;" />
					</div>
					<div class="col-lg-7">
							...
							<div class="carousel-inner">
								<div class="item active">
									<div class="row no-margin pd10">
										...
										<div class="col-lg-6 col-xs-6 col-sm-6 mt-onmob ds-flex">
											<div class="col-lg-12 placedstudiv">
												<img src="img/home/episode1.jpg" alt="GIMS Illuminates Episode 1" class="">
												
												<div class="overlay-div"></div>
												<a href="https://youtu.be/sK5ndEiXySA" target="_blank"><img src="img/home/video-icon.png" alt="" class="youtube-icon">
												</a>	
											</div>
										</div>
										...
										<div class="col-lg-6 col-xs-6 col-sm-6 mt-onmob ds-flex">
											<div class="col-lg-12 placedstudiv">
												<img src="img/home/episode2.jpg" alt="GIMS Illuminates Episode 2" class="">
												<div class="overlay-div"></div>
												<a href="https://youtu.be/t8EPXZu0tok" target="_blank"><img src="img/home/video-icon.png" alt="" class="youtube-icon"></a>
