...
<head>
    ...
    <title>Intellectual Capital @ GIMS | Management Campus in Greater Noida</title>
	<meta name="description" content="Intellectual Capital @ GIMS - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Intellectual Capital @ GIMS</div>
                ...
                <div class="container custom_container">
                    <div class="row align-items-center new-pd4 zoomanimate">
						<div class="col-lg-12">
							<ul class="breadcrumb">
							  <li><a href="#">Home</a></li>
							  <li>Intellectual Capital @ GIMS</li>
							</ul>
						</div>
						<div class="col-lg-12">
							<h1 class="page-t">Intellectual Capital @ GIMS</h1>
							<h3 class="sub-t">Faculty experts at GIMS</h3>
						</div>
							...
							<div class="row">
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<p class="pgdmtext">
											Faculty experts at GIMS have the right blend of industry and academic experience averaging approximately 10 years and are known for depth, rigor and customization. GIMS has a team of academicians and practitioners for PGDM to enthuse, challenge and provoke students to think out of the box in order to develop the art of critical thinking and holistic decision making.
											<br/>
											<br/>
											Highly accomplished Industry Stalwarts are our regular visiting faculties and interact with our students on a continuous basis, imbibing students with the necessary knowledge to understand the nuances of management studies.
											<br/>
											<br/>
										</p>
									</div>
