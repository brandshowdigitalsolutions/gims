...
<head>
    ...
    <title>Infrastructure - GIMS | Top Management Colleges in Greater Noida</title>
	<meta name="description" content="Infrastructure - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Infrastructure</div>
            ...
            <div class="intro">
                <div class="container custom_container">
                    <div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							<h1 class="page-t">IT Infrastructure</h1>
							<h3 class="sub-t">IT Infrastructure - PGDM Campus in Gr. Noida</h3>
						</div>
							...
							<div class="row">
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<p class="pgdmtext">
											Information Technology is unarguably the defining force of this millennium, and GNIOT Institute of Management Studies (GIMS) is poised to break new ground as the most e-enabled institution in India. The initial focus of being system friendly has now resulted in a virtual flood of e-initiatives. Beginning with the upgradation of infrastructure like marching towards Wi-Fi campus, supplemented by the introduction of new courses, workshops, seminars, live projects and setting up a Center for e-Business that aims to facilitate industry-academia interface. Thus enabling the creation of a whole new batch of tech-savy managers with the skills to integrate technology solutions to the workplace environment has begun. The computing resources at GIMS  include latest servers and workstations, a state-of-the-art campus network and WAN connectivity.
											<br/>
											<br/>
										</p>
									</div>
