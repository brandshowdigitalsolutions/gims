                ...
                <div class="intro">
                    <div class="container custom_container">
                        <div class="row align-items-center new-pd4 zoomanimate">
                            ...
                            <div class="col-lg-12">
                                <h1 class="page-t">Employability Scale Index(ESI)</h1>
                            </div>
                            <div class="col-md-12 no-padding">
                                <div class="row">
                                    <div class="col-lg-9">
                                        <div class="col-lg-12 new-pd9 awardbg2">
                                            <h2 class="new-font titlenews black-color">ESI</h2>
                                            <p class="pgdmtext">
                                                The Employability Scale Index is conducted at the beginning of each trimester to understand the diverse readiness levels of our students. By categorizing learners based on their current strengths and developmental needs, ESI enables us to design targeted, need-based training plans. This structured approach ensures that every student receives the right level of support, enhancing their overall employability and placement preparedness.
                                                <br />
                                            </p>
                                        </div>
                                    </div>
