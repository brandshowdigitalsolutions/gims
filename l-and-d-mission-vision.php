...
<head>
    ...
    <title>Mission, Vision and Values | Top Management Colleges in Greater Noida</title>
	<meta name="description" content="Mission and Vision - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Mission, Vision and Values</div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        ...
                        <div class="col-md-12 no-padding">
							...
							<div class="col-lg-12 new-pd9 awardbg2">
											<h2 class="new-font titlenews black-color"><i class="icon-eye"></i>Vision</h2>
										<p class="pgdmtext">
										To create a dynamic learning ecosystem that empowers students and professionals with future-ready skills, enabling them to excel in a rapidly evolving global business environment.
											<br/>
											<br/>
										</p>
									<h2 class="new-font titlenews black-color"><i class="icon-line-target"></i>Mission</h2>
										<p class="pgdmtext">
											<ul>
												<li>
													To design and deliver innovative learning programs that enhance managerial, technical, and behavioral competencies. 
												</li>
												<li>
													To bridge the gap between academia and industry through workshops, corporate engagements, and continuous development initiatives.
												</li>
												<li>
													To foster a culture of lifelong learning, leadership, and professional excellence among students and faculty at GIMS. 
												</li>
												<li>
													To equip learners with practical insights, industry exposure, and skill-based training that strengthen employability and career growth.
												</li>
											</ul>
											<br/>
										...
										<!-- core values -->
										   <h2 class="new-font titlenews black-color">
											<i class="icon-heart"></i> Core Values
										</h2>

										<div class="pgdmtext">
											<h4>1. Excellence</h4>
											<p>We commit to delivering high-quality, impactful learning experiences. </p>

											<h4>2. Innovation</h4>
											<p>We constantly evolve our teaching methods, tools, and programs to meet emerging industry trends. </p>

											<h4>3. Collaboration</h4>
											<p>We encourage teamwork and meaningful partnerships with industry, academia, and learners. </p>

											<h4>4. Growth Mindset</h4>
											<p>We promote curiosity, continuous improvement, and openness to learning. </p>

											<h4>5. Student-Centric Approach</h4>
											<p>We design learning experiences that align with the needs, aspirations, and career goals of our learners. </p>

											<h4>6. Resilience</h4>
											<p>We nurture the ability to adapt, persevere, and remain solution-oriented in the face of challenges, preparing students to thrive in dynamic and uncertain environments. </p>
										</div>
