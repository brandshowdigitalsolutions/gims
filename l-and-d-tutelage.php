...
<html lang="en">
    <head>
        ...
        <title>TUTELAGE | Top Management Colleges in Greater Noida</title>
        <meta
            name="description"
            content="TUTELAGE - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."
        />
        <meta
            name="keywords"
                ...
                <div class="intro">
                    <div class="container custom_container">
                        <div class="row align-items-center new-pd4 zoomanimate">
                            ...
                            <div class="col-lg-12">
                                <h1 class="page-t">TUTELAGE</h1>
                            </div>
                            <div class="col-md-12 no-padding">
                                <div class="row">
                                    <div class="col-lg-9">
                                        <div class="col-lg-12 new-pd9 awardbg2">
                                            <h2 class="new-font titlenews black-color">TUTELAGE</h2>
                                            <p class="pgdmtext">
                                                <img src="img/l&d/tutelage/tut-3.png" alt="TUTELAGE Image" class="img-fluid mb-3" />
                                                <img src="img/l&d/tutelage/tut-4.png" alt="TUTELAGE Image" class="img-fluid mb-3" />
                                                <img src="img/l&d/tutelage/tut-5.png" alt="TUTELAGE Image" class="img-fluid mb-3" />
                                                    </br>
                                                    </br>
                                                The L&D Club of GIMS organized Tutelage, a professional development
                                                session designed to enhance students’ personal and academic growth. The
                                                event featured Mr. Sonu Sharma, a renowned motivational speaker, who
                                                engaged students through an insightful and interactive discourse.</br> 
												His guidance offered students a deeper understanding of essential skills
                                                required for their overall development, encouraging them to reflect on
                                                their strengths, adopt constructive habits, and approach their goals
                                                with renewed clarity and discipline. His impactful delivery resonated
                                                strongly with the audience, inspiring students to pursue continuous
                                                self-improvement. </br>

												Tutelage served as a meaningful learning experience,
                                                contributing to students’ holistic development and reinforcing the
                                                institution’s commitment to nurturing well-rounded, future-ready
                                                professionals.

												</br>
												</br>

                                                <img src="img/l&d/tutelage/tut-1.jpeg" alt="TUTELAGE Image" class="img-fluid mb-3" />
                                                <img src="img/l&d/tutelage/tut-2.jpeg" alt="TUTELAGE Image" class="img-fluid mb-3" />
