...
<html lang="en">
    <head>
        ...
        <title>Lecture Hall | Top Management Colleges in Greater Noida</title>
        <meta
            name="description"
            content="Lecture Hall - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."
        />
        <meta
            name="keywords"
    ...
    <body class="home_four">
        ...
        <div id="wavescroll">
            <section class="section wave_two_section_two">
                ...
                <div class="text" style="font-size: 34px">Lecture Hall</div>
                ...
                <div class="intro">
                    <div class="container custom_container">
                        <div class="row align-items-center new-pd4 zoomanimate">
                            ...
                            <div class="col-lg-12">
                                <h1 class="page-t">Lecture Hall</h1>
                                    ...
                                    <div class="col-lg-9">
                                        <div class="col-lg-12 new-pd9 awardbg2">
                                            <div class="placement-process">
                                                <p class="new-text">
                                                    The avant-garde classrooms are fully air conditioned and well
                                                    equipped with all the modern day facilities from White Boards to
                                                    Smart Boards, from Projectors to Wi-Fi. The students make the
                                                    hundred percent of the knowledge imparted to them in these
                                                    technically aided classrooms. The amphitheatrically designed
                                                    classrooms make it even the more relishing experience to imbibe the
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 popup-box">
                                                            <a
                                                                ...
                                                                href="img/classrooms/new/lecture-hall-1.webp?v=12"
                                                                data-lightbox="example-set"
                                                            >
                                                                <img
                                                                    class="example-image"
                                                                    src="img/classrooms/new/lecture-hall-1.webp?v=12"
                                                                    alt="Gims Classrooms"
                                                                />
                                                            </a>
                                                        </div>
                                                        <div class="col-md-4 popup-box">
                                                            <a
                                                                class="example-image-link"
                                                                href="img/classrooms/new/lecture-hall-2.webp?v=12"
                                                                data-lightbox="example-set"
                                                            >
                                                                <img
                                                                    class="example-image"
                                                                    src="img/classrooms/new/lecture-hall-2.webp?v=12"
                                                                    alt="Gims Classrooms"
                                                                />
                                                            </a>
                                                        </div>
                                                        <div class="col-md-4 popup-box">
                                                            <a
                                                                class="example-image-link"
                                                                href="img/classrooms/new/4.jpg"
                                                                data-lightbox="example-set"
                                                            >
                                                                <img
                                                                    class="example-image"
                                                                    src="img/classrooms/new/4.jpg"
                                                                    alt="Gims Classrooms"
                                                                />
                                                            </a>
                                                        </div>
                                                        <div class="col-md-4 popup-box">
                                                            <a
                                                                class="example-image-link"
                                                                href="img/classrooms/new/lecture-hall-3.webp?v=12"
                                                                data-lightbox="example-set"
                                                            >
                                                                <img
                                                                    class="example-image"
                                                                    src="img/classrooms/new/lecture-hall-3.webp?v=12"
                                                                    alt="Gims Classrooms"
                                                                />
                                                            </a>
                                                        </div>
                                                        <div class="col-md-4 popup-box">
                                                            <a
                                                                class="example-image-link"
                                                                href="img/classrooms/new/lecture-hall-4.webp?v=12"
                                                                data-lightbox="example-set"
                                                                ><img
                                                                    class="example-image"
                                                                    src="img/classrooms/new/lecture-hall-4.webp?v=12"
                                                                    alt="Gims Classroom"
                                                            /></a>
                                                        </div>
                                                        <!-- <div class="col-md-4 popup-box">
                                                            <a
                                                                class="example-image-link"
                                                                href="img/classrooms/classroom-2.webp"
                                                                data-lightbox="example-set"
                                                                ><img
                                                                    class="example-image"
                                                                    src="img/classrooms/classroom-2.webp"
                                                                    alt="Gims Classroom"
                                                            /></a>
                                                        </div> -->
                                                        <!-- <div class="col-md-4 popup-box">
                                                            <a
                                                                class="example-image-link"
                                                                href="img/classrooms/classroom-3.webp"
                                                                data-lightbox="example-set"
                                                                ><img
                                                                    class="example-image"
                                                                    src="img/classrooms/classroom-3.webp"
                                                                    alt="Gims Classroom"
                                                            /></a>
                                                        </div> -->
                                                        <div class="col-md-4 popup-box">
                                                            <a
                                                                class="example-image-link"
                                                                href="img/classrooms/classroom-4.webp"
                                                                data-lightbox="example-set"
                                                                ><img
                                                                    class="example-image"
                                                                    src="img/classrooms/classroom-4.webp"
                                                                    alt="Gims Classroom"
                                                            /></a>
                                                        </div>
                                                        <!-- <div class="col-md-4 popup-box">
                                                            <a
                                                                class="example-image-link"
                                                                href="img/classrooms/classroom-5.webp"
                                                                data-lightbox="example-set"
                                                                ><img
                                                                    class="example-image"
                                                                    src="img/classrooms/classroom-5.webp"
                                                                    alt="Gims Classroom"
                                                            /></a>
                                                        </div> -->
                                                        <!-- <div class="col-md-4 popup-box">
                                                            <a
                                                                class="example-image-link"
                                                                href="img/classrooms/classroom-6.webp"
                                                                data-lightbox="example-set"
                                                                ><img
                                                                    class="example-image"
                                                                    src="img/classrooms/classroom-6.webp"
                                                                    alt="Gims Classroom"
                                                            /></a>
                                                        </div> -->
                                                    </div>
