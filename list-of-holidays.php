...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>List Of Holidays| Top Management Colleges in Greater Noida</title>
        <meta
            name="description"
    ...
    <body class="home_four">
        ...
        <div id="wavescroll">
            <section class="section wave_two_section_two">
                ...
                <div class="text" style="font-size: 34px">List Of Holidays</div>
                ...
                <div class="intro">
                    <div class="container custom_container">
                        <div class="row align-items-center new-pd4 zoomanimate">
                            ...
                            <div class="col-lg-12">
                                <h1 class="page-t">List Of Holidays</h1>
                            </div>
                                    ...
                                    <div class="col-lg-9">
                                        <div class="col-lg-12 new-pd9 awardbg2">
                                            <div class="facdiv">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <ul class="academic-calendar-list">
                                                             <li><a href="pdf/loh/list-of-holidays-2026.pdf?v=14" target="_blank">List 0f Holiday 2026 - Click Here</a></li>
                                                            <li><a href="pdf/loh/list-of-holidays-2025.pdf?v=14" target="_blank">List 0f Holiday 2025 - Click Here</a></li>
                                                            <li><a href="pdf/loh/list-of-holidays-2024.pdf?v=14" target="_blank">List 0f Holiday 2024 - Click Here</a></li>
                                                            <li><a href="pdf/loh/list-of-holidays-2023.pdf?v=14" target="_blank">List 0f Holiday 2023 - Click Here</a></li>
                                                            <li><a href="pdf/loh/list-of-holidays-2022.pdf?v=14" target="_blank">List 0f Holiday 2022 - Click Here</a></li>
                                                            <li><a href="pdf/loh/list-of-holidays-2021.pdf?v=14" target="_blank">List 0f Holiday 2021 - Click Here</a></li>
                                                            <li><a href="pdf/loh/list-of-holidays-2020.pdf?v=14" target="_blank">List 0f Holiday 2020 - Click Here</a></li>
                                                        </ul>
                                                        <style>
                                                            ...
                                                            .academic-calendar-list li {
                                                                margin: 8px 0;
                                                            }

                                                            .academic-calendar-list a {
                                                                color: #000 !important;
