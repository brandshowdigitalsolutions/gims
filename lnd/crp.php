...
<html lang="en">
    <head>
        ...
        <title>CRP | Top Management Colleges in Greater Noida</title>
        <meta
            name="description"
            content="CRP - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."
        />
        <meta
            name="keywords"
    ...
    <body class="home_four">
        ...
        <div id="wavescroll">
            <section class="section wave_two_section_two">
                ...
                <div class="text" style="font-size: 34px">ESI</div>
                ...
                <div class="intro">
                    <div class="container custom_container">
                        <div class="row align-items-center new-pd4 zoomanimate">
                            ...
                            <div class="col-lg-12">
                                <h1 class="page-t">Corporate Readiness Programme(CRP)</h1>
                            </div>
                            <div class="col-md-12 no-padding">
                                <div class="row">
                                    <div class="col-lg-9">
                                        <div class="col-lg-12 new-pd9 awardbg2">
                                            <h2 class="new-font titlenews black-color">CRP</h2>
                                            <p class="pgdmtext">
                                                The L&D Department of GIMS conducts the Corporate Readiness Programme as
                                                an enriching initiative to prepare students for real corporate
                                                challenges. The programme brings together distinguished guests from
                                                diverse industries, each sharing valuable experience and insights from
                                                senior corporate roles. 
                                                </br>
                                                The Corporate Readiness Programme is designed to enhance students’A key highlight of the initiative is the
                                                one-to-one interaction between students and industry professionals.
                                                These personalized sessions allow students to demonstrate and refine
                                                their communication skills, interpersonal abilities, domain knowledge,
                                                and overall corporate readiness. </br>
                                                
                                                Industry experts provide individual
                                                mentoring, offering constructive feedback, career guidance, and
                                                practical suggestions to help students align with current industry
                                                expectations. Their guidance not only boosts students’ confidence but
                                                also deepens their understanding of essential workplace competencies. </br>
                                                The Corporate Readiness Programme ensures continuous development and
                                                strengthens the bridge between academia and industry, offering students
                                                meaningful exposure to professional standards and expectations.
                                                </br></br>
                                                <img
                                                    src="/img/l&d/crp/crp-1.jpg"
                                                    alt="Corporate Readiness Programme Image"
                                                    class="img-fluid mb-3"
                                                />
                                                <img
                                                    src="/img/l&d/crp/crp-2.jpg"
                                                    alt="Corporate Readiness Programme Image"
                                                    class="img-fluid mb-3"
                                                />
                                                <img
                                                    src="/img/l&d/crp/crp-3.jpg"
                                                    alt="Corporate Readiness Programme Image"
                                                    class="img-fluid mb-3"
                                                />
                                                <img
                                                    src="/img/l&d/crp/crp-4.jpg"
                                                    alt="Corporate Readiness Programme Image"
                                                    class="img-fluid mb-3"
                                                />
                                                <img
                                                    src="/img/l&d/crp/crp-5.jpg"
                                                    alt="Corporate Readiness Programme Image"
                                                    class="img-fluid mb-3"
                                                />
