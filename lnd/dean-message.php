...
<html lang="en">
    <head>
        ...
        <title>Dean’s Message | Top Management Colleges in Greater Noida</title>
        <meta
            name="description"
            content="Dean’s Message - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."
        />
        <meta
            name="keywords"
    ...
    <body class="home_four">
        ...
        <div id="wavescroll">
            <section class="section wave_two_section_two">
                ...
                <div class="text" style="font-size: 34px">Dean’s Message</div>
                ...
                <div class="intro">
                    <div class="container custom_container">
                        <div class="row align-items-center new-pd4 zoomanimate">
                            ...
                            <div class="col-lg-12">
                                <h1 class="page-t">Dean’s Message</h1>
                            </div>
                            <div class="col-md-12 no-padding">
                                <div class="row">
                                    <div class="col-lg-9">
                                        <div class="col-lg-12 new-pd9 awardbg2">
                                            <h2 class="new-font titlenews black-color">Dean’s Message</h2>
                                            <p class="pgdmtext">
                                                At GIMS, we believe that learning is not a one-time event—it is a
                                                continuous journey that shapes the leaders of tomorrow. Our Learning &
                                                Development (L&D) Department plays a pivotal role in nurturing this
                                                journey by equipping students with the skills, perspectives, and
                                                confidence needed to excel in today’s dynamic business landscape.
                                                <br />
                                            </p>

                                            <p class="pgdmtext">
                                                Through structured training programs, industry collaborations,
                                                skill-enhancement initiatives, and experiential learning opportunities,
                                                the L&D team ensures that our students are prepared not just for their
                                                first job, but for long-term career success. The department’s commitment
                                                to innovation, excellence, and student-centric learning reflects the
                                                core values of GIMS.
                                                <br />
                                            </p>
                                            <p class="pgdmtext">
                                                I am confident that the L&D initiatives will continue to inspire
                                                curiosity, encourage growth, and empower our learners to become
                                                impactful professionals and responsible leaders.
                                                <br />
                                            </p>

                                            <strong>— Dean L&D, GIMS Greater Noida</strong>
                                        </div>
                                    </div>
