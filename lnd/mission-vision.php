							...
							<div class="col-lg-12 new-pd9 awardbg2">
									...
									<h2 class="new-font titlenews black-color"><i class="icon-line-target"></i>Mission</h2>
										...
										<div class="pgdmtext">
											...
											<h4>6. Resilience</h4>
											<p>We nurture the ability to adapt, persevere, and remain solution-oriented in the face of challenges, preparing students to thrive in dynamic environments.</p>
										</div>
