...
<html lang="en">
    <head>
        ...
        <title>Mandatory Disclosure | Top PGDM Colleges in Greater Noida</title>
        <meta
            name="description"
    ...
    <body class="home_four">
        ...
        <div id="wavescroll">
            <section class="section wave_two_section_two">
                ...
                <div class="text" style="font-size: 34px">PGDM Campus</div>
                ...
                <div class="intro">
                    <div class="container custom_container">
                        <div class="row align-items-center new-pd4 zoomanimate">
                            ...
                            <div class="col-lg-12">
                                <h1 class="page-t">Mandatory Disclosure</h1>
                                ...
                                <div class="row">
                                    <div class="col-lg-9">
                                        <div class="col-lg-12 new-pd9 awardbg2">
                                            <a
                                                href="/pdf/md/mandatory-disclosure-2025-27.pdf"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                class="md-btn md-blinking"
                                            >
                                                <span class="md-text">Mandatory Disclosure 2025–27</span>
                                            </a>

                                            <!-- <a
                                                href="/pdf/md/annexure-18-mandatory-disclosures.pdf"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                class="md-btn md-blinking"
                                            >
                                                <span class="md-text">Annexure 18 – Mandatory Disclosures</span>
                                            </a> -->
                                        </div>
                                        ...
                                        <style>
                                            ...
                                            /* 🔔 Default blinking: bg + text opacity 1 ↔ 0 */
                                            .md-blinking {
                                                animation: mdBlinkBg 2s infinite;
                                            }
                                            ...
                                            /* 🛑 Hover: stop bg blinking completely */
                                            .md-btn:hover {
                                                animation: none;
                                                opacity: 1;
                                                background: #084298;
                                            ...
                                            /* 🔔 Hover: text keeps blinking (1 ↔ 0) */
                                            .md-btn:hover .md-text {
                                                animation: mdBlinkText 2s infinite;
                                                color: white;
                                            }

                                            /* Background blink (full disappear) */
                                            @keyframes mdBlinkBg {
                                                0%   { opacity: 1; }
                                                50%  { opacity: 0; }
                                                100% { opacity: 1; }
                                            ...
                                            /* Text blink (full disappear) */
                                            @keyframes mdBlinkText {
                                                0%   { opacity: 1; }
                                                50%  { opacity: 0; }
                                                100% { opacity: 1; }
                                            }
