...
<head>
    <meta charset="utf-8">
    <title>Prof. Meenakshi Dabas</title>
    <meta name="description"
        content="With 13 years of experience as a verbal and soft skills trainer, she enhances interpersonal communication through impactful sessions that blend academic knowledge and real-world experience. A qualified POSH trainer, she fosters respectful workplaces and equips participants with the tools for effective communication and teamwork to support personal and professional development." />
    ...
    <!-- Favicon -->
    <link rel="alternate" href="https://www.gims.net.in/meenakshi-dabas.php" hreflang="es-us" />
    <link rel="canonical" href="https://www.gims.net.in/meenakshi-dabas.php"> <!-- Search Engine -->
    <meta name="image" content="https://www.gims.net.in/img/gims-logo.jpg"> <!-- Facebook Open Graph -->
    <meta property="og:type" content="website">
    <meta property="og:title" content=" Prof. Meenakshi Dabas">
    <meta property="og:description"
        content="With 13 years of experience as a verbal and soft skills trainer, she enhances interpersonal communication through impactful sessions that blend academic knowledge and real-world experience. A qualified POSH trainer, she fosters respectful workplaces and equips participants with the tools for effective communication and teamwork to support personal and professional development.">
    <meta property="og:url" content="https://www.gims.net.in/meenakshi-dabas.php">
    <meta property="fb:app_id" content="573928583391257">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:site" content="@GNIOTCollege">
    <meta name="twitter:title" content="Prof. Meenakshi Dabas ">
    <meta name="twitter:description"
        content="With 13 years of experience as a verbal and soft skills trainer, she enhances interpersonal communication through impactful sessions that blend academic knowledge and real-world experience. A qualified POSH trainer, she fosters respectful workplaces and equips participants with the tools for effective communication and teamwork to support personal and professional development.">
    <!-- Open Graph general (Facebook, Pinterest & Google+) -->
    <meta name="og:title" content="Prof. Meenakshi Dabas" />
    <meta name="og:url" content="https://www.gims.net.in/meenakshi-dabas.php">
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "https://www.gims.net.in/meenakshi-dabas.php",
            "sameAs": [
...
<body class="home_four">
    ...
    <div id="wavescroll">
        <section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Ms. Meenakshi Dabas</div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        <div class="col-lg-12">
                            <ul class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li>Faculty</li>
                                <li>Ms. Meenakshi Dabas</li>
                            </ul>
                        </div>
                        <div class="col-lg-12">
                            <h1 class="page-t">Ms. Meenakshi Dabas</h1>
                                ...
                                <div class="col-lg-9">
                                    <div class="col-lg-12 new-pd9 awardbg2">
                                        <div class="facdiv">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="img/faculty/meenakshi-dabas.webp"
                                                        alt="Prof. Meenakshi Dabas" width="100%">
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="facpinfo">
                                                        <p class="facdetail">
                                                            <span>Name:</span> Ms. Meenakshi Dabas<br>
                                                            <span>Designation:</span> Assistant Professor<br>
                                                            <span>Area:</span> Communication & Development<br>
                                                            <span>Email id:</span> <a
                                                                href="mailto:Teamlnd9@gims.net.in">Teamlnd6@gims.net.in</a>
                                                        ...
                                                        <p class="brfprofile">She has 13 years of expertise as a
                                                            seasoned verbal and soft skills trainer, helping a wide
                                                            range of audiences improve their interpersonal and
                                                            communication abilities. With an M.A. and M.Ed., she is able
                                                            to conduct impactful sessions by fusing academic knowledge
                                                            with real-world experience. As a qualified POSH trainer, her
                                                            area of expertise lies in creating respectful and safe
                                                            workplaces. Her interactive approach equips participants
                                                            with the tools they need to communicate effectively and
                                                            confidently, utilizing real-world scenarios and personalized
                                                            feedback. Her goal is to foster effective communication and
                                                            teamwork among employees to support their personal and
