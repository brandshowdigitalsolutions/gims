...
<html lang="en">
    <head>
        ...
        <title>Mission and Vision | Top Management Colleges in Greater Noida</title>
        <meta
            name="description"
            content="Mission and Vision - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."
        />
        <meta
            name="keywords"
                ...
                <div class="intro">
                    <div class="container custom_container">
                        <div class="row align-items-center new-pd4 zoomanimate">
                            ...
                            <div class="col-lg-12">
                                <h1 class="page-t">Vision and Mission</h1>
                                    ...
                                    <div class="col-lg-9">
                                        <div class="col-lg-12 new-pd9 awardbg2">
                                            <h2 class="new-font titlenews black-color">
                                                <i class="icon-eye"></i> Vision
                                            </h2>
                                            <p class="pgdmtext">
                                                To become a globally recognised and sustainable management school that
                                                contributes to management education, research, and innovation by
                                                developing socially responsible ethical business leaders and centres of
                                                excellence across all functional domains of management.
                                                <br />
                                                <br />
                                            </p>

                                            <h2 class="new-font titlenews black-color">
                                                <i class="icon-line-target"></i> Mission
                                            </h2>
                                            <p class="pgdmtext">
                                                <strong>M1:</strong> Developing a dynamic, outcome-based
                                                teaching-learning process that cultivates critical thinking, leadership,
                                                and industry readiness.
                                                <br />
                                                <strong>M2:</strong> Creating an ecosystem that nurtures research,
                                                innovation, and entrepreneurship.
                                                <br />
                                                <strong>M3:</strong> Developing globally aware, ethical, and socially
