...
<head>
    ...
    <title>Mr. Chandrakant Singh | Additional Director : CRC, L&D, Academics</title>

    <meta name="description"
        content="Mr. Chandrakant Singh, an Professor at GNIOT Institute of Management Studies, is an award-winning academician and prolific researcher in Sales Management and Digital Marketing. " />

    <meta name="keywords"
        content="Mr. Chandrakant Singh, GIMS faculty members,GIMS faculty profiles,GIMS faculty directory,GIMS faculty qualifications,GIMS faculty expertise,GIMS faculty research areas,GIMS faculty publications,GIMS faculty contact information,GIMS faculty achievements,GIMS faculty experience,GIMS faculty specializations,GIMS faculty academic background,GIMS faculty professional affiliations,GIMS faculty teaching philosophy." />
    ...
    <!-- Favicon -->
    <link rel="alternate" href="https://www.gims.net.in/mr-chandrakant-singh.php" hreflang="es-us" />

    <link rel="canonical" href="https://www.gims.net.in/mr-chandrakant-singh.php"> <!-- Search Engine -->

    <meta name="image" content="https://www.gims.net.in/img/gims-logo.jpg"> <!-- Facebook Open Graph -->

    <meta property="og:type" content="website">

    <meta property="og:title" content="Mr. Chandrakant Singh,Additional Director : CRC, L&D, Academics ">

    <meta property="og:description"
        content="Mr. Chandrakant Singh, Additional Director : CRC, L&D, Academics  at GNIOT Institute of Management Studies, is an award-winning academician and prolific researcher in Sales Management and Digital Marketing..">

    <meta property="og:url" content="https://www.gims.net.in/mr-chandrakant-singh.php">
    ...
    <meta name="twitter:title" content="Mr. Chandrakant Singh:Additional Director : CRC, L&D, Academics ">

    <meta name="twitter:description"
        content="Mr. Chandrakant Singh:Additional Director : CRC, L&D, Academics  at GNIOT Institute of Management Studies, is an award-winning academician and prolific researcher in Sales Management and Digital Marketing..">
    <!-- Open Graph general (Facebook, Pinterest & Google+) -->

    <meta name="og:title" content="Mr. Chandrakant Singh:Additional Director : CRC, L&D, Academics " />

    <meta name="og:url" content="https://www.gims.net.in/mr-chandrakant-singh.php">

    <meta name="og:site_name" content="GNIOT Institute of Management Studies">

    <meta name="fb:admins" content="573928583391257">

    <meta name="og:type" content="website"> <!-- Geotag Start -->
    ...
    <script type="application/ld+json">

        {
            ...
            "url": "https://www.gims.net.in/mr-chandrakant-singh.php",
...
<body class="home_four">
    ...
    <div id="wavescroll">
        <section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;"> Mr. Chandrakant Singh</div>
                ...
                <div class="container custom_container">
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        ...
                        <div class="col-lg-12">
                            ...
                            <h1 class="page-t">Mr. Chandrakant Singh </h1>
                                        ...
                                        <div class="facdiv">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <img src="img/faculty/new/mr-chandrakant-singh-1.webp"
                                                        alt="Mr. Chandrakant Singh" width="100%">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="facpinfo">
                                                        ...
                                                        <p class="facdetail">
                                                            ...
                                                            <span>Name:</span>Mr. Chandrakant Singh<br>

                                                            <span>Designation:</span> Additional Director CRC, L&D,
                                                            Academics<br>

                                                            <!-- <span>Degree: </span>MBA, Ph.D., FDPM-IIMA<br> -->

                                                            <!-- <span>Email id:</span> <a
                                                                href="mailto:amitkumarbhanja@gims.net.in">amitkumarbhanja@gims.net.in</a> -->
                                                            <br>

                                                            <!-- <span>ORCID ID: </span>0000-0001-8908-0374<br> -->

                                                            <!-- <span>Vidwan ID: </span> 161563<br> -->
                                                            <!-- <span>Scopus ID: </span>57208426164<br> -->

                                                            <!-- <span></span> <a class="linkedinic"
                                                                  href="https://www.linkedin.com/in/dr-amit-kumar-bhanja-703011a9/"
                                                        ...
                                                        <div class="brfprofile">
                                                            <p>
                                                                Chandrakant Singh is a dynamic academic leader and
                                                                industry professional with close to 14 years of diverse
                                                                experience spanning Education and IT/ITES. Known for
                                                                building strong industry-academia bridges, he brings
                                                                deep expertise in talent development, corporate
                                                                engagement, and student career acceleration.<br>

                                                                In his current role, he leads Academics, Learning &
                                                                Development, and Corporate Relations & Career Services
                                                                (CRC), driving initiatives that enhance employability,
                                                                strengthen industry partnerships, and align academic
                                                                delivery with evolving corporate expectations. His work
                                                                focuses on creating “day-zero professionals” equipped to
                                                                thrive in competitive business environments.<br>

                                                                Chandrakant began his career with INFINITE Computer
                                                                Solutions, Bangalore (a CMM Level 5 organization), where
                                                                he quickly emerged as a top performer, earning a
                                                                promotion within his first year. He later moved to AXA
                                                                Business Services (a Fortune 500 company), where he
                                                                played a key role in Talent Acquisition, leading campus
                                                                hiring strategies across multiple verticals.<br>

                                                                A defining turning point in his journey came in 2017,
                                                                when a recruitment assignment to a B-School in Pune led
                                                                him to transition into the education sector. Starting in
                                                                Training & Placements, he rapidly rose through the ranks
                                                                to Head of Department and later Director, leading
                                                                Corporate Connect and Student Acquisition functions.<br>

                                                                Prior to his current role, he served as Country Head at
                                                                MULTIFIT Wellness Private Limited, Pune, managing
                                                                operations across 33 centres in India, UAE, and the
                                                                UK—demonstrating his ability to lead large,
                                                                multi-geography teams and drive business growth.<br>

                                                                A passionate mentor and lifelong learner, Chandrakant is
                                                                known for his practical insights, engaging speaking
                                                                style, and strong belief in values-driven leadership.
                                                                His sessions often focus on career readiness, industry
                                                                alignment, and making informed choices in an
                                                                ever-evolving professional landscape.<br>

                                                                Beyond his professional pursuits, he is a complete
                                                                family man, and his bio on Facebook reads—“A father’s
                                                                son and a son’s father.” He enjoys staying updated, has
                                                                a passion for reading, and loves watching Bollywood
                                                                movies, ensuring he catches new releases over the
                                                                weekends. He is also passionate about cars and bikes and
                                                                enjoys road trips with friends and family.<br>

                                                                He is a man of principles and places a strong emphasis
                                                                on ethics and values…!!<br>
                                                        ...
                                                        <script>
                                                            ...
                                                            function toggleProfile() {
                                                                ...
                                                                var button = document.querySelector('.moreread'); profile.classList.toggle('contshow');
    ...
    </div> <?php include "footer-bottom.php"; ?>
    <style>
        .tab {
