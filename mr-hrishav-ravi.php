...
<head>
	<meta charset="utf-8">
	<title>Mr. Hrishav Ravi: Assistant Professor / Marketing </title>
	<meta name="description" content="Prof. Hrishav Ravi is an Assistant Professor of Marketing at GIMS, Greater Noida. Specializing in interactive and case-based learning, he focuses on practical business applications and student mentoring to build professional competence." />

    <meta name="keywords" content="Prof. Hrishav Ravi, GIMS Marketing Faculty, Assistant Professor Marketing, GNIOT Institute of Management Studies, GIMS faculty profiles, Marketing education Greater Noida, MBA Marketing faculty, Hrishav Ravi GIMS, case-based learning marketing, GIMS faculty directory" />
...
<body class="home_four">
	...
	<div id="wavescroll">
		...
		<section class="section wave_two_section_two">
			...
			<div class="text" style="font-size:34px;">Mr. Hrishav Ravi</div>
					...
					<div class="row align-items-center new-pd4 zoomanimate">
						<div class="col-lg-12">
							<ul class="breadcrumb">
								<li><a href="#">Home</a></li>
								<li>Faculty</li>
								<li>Mr. Hrishav Ravi</li>
							</ul>
						</div>
						<div class="col-lg-12">
							<h1 class="page-t">Mr. Hrishav Ravi </h1>
								...
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<div class="facdiv">
											<div class="row">
												<div class="col-md-4">
													<img src="img/faculty/new/hrishav-ravi.webp?v=1" alt="Mr. Hrishav Ravi" width="100%">
												</div>
												<div class="col-md-8">
													<div class="facpinfo">
														<p class="facdetail">
															<span>Name:</span> Mr. Hrishav Ravi <br>
														...
														<p class="brfprofile"><br>Prof. Hrishav Ravi is currently working as an Assistant Professor at GNIOT Institute of Management Studies (GIMS), Greater Noida. He has completed his graduation (BBA) from Chaudhary Charan Singh University and post-graduation (MBA) from Dr. A.P.J. Abdul Kalam Technical University (AKTU).
                                                            <br>
                                                            He specializes in the area of Marketing and is actively involved in teaching, academic coordination, curriculum support, and student mentoring. His teaching approach focuses on interactive learning, case-based discussions, and practical business applications, enabling students to develop strong conceptual clarity and professional competence.
                                                            </br>
                                                        </p>
