...
<head>
	...
	<title>Corporate Mentor - Mr. Shivendra Mishra | Top Management Colleges in Greater Noida</title>

	<meta name="description"

		content="Corporate Mentor - Mr. Shivendra Mishra  - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India." />
...
<body class="home_four">
	...
	<div id="wavescroll">
		...
		<section class="section wave_two_section_two">
			...
			<div class="text" style="font-size:34px;">Corporate Mentor - Mr. Shivendra Mishra </div>
					...
					<div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							...
							<ul class="breadcrumb">
								...
								<li>Corporate Mentor - Mr. Shivendra Mishra </li>
						...
						<div class="col-lg-12">
							...
							<h3 class="sub-t">Mr. Shivendra Mishra</h3>
							...
							<div class="row">
								...
								<div class="col-lg-9">
									...
									<p class="pgdmtext">
											...
											<img src="img/corporate-mentor/shivendra.webp" class="msgs"
										...
										It was indeed my privilege to be a part of GIMS. An Institution at par with academic and corporate excellence.  A practical road map for ongoing and upcoming Management batch will create a pivotal role in terms of corporate exposure of Management students. My best wishes to PGDM batch students. Go all out to create a new ambitious corporate exposure for yourself<br><br>
										...
										<strong>Associate Vice President,</strong> <br>
