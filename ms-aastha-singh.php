...
<head>
	<meta charset="utf-8">
	<title>Aastha Singh | Assistant Professor - Marketing</title>
...
<body class="home_four">
	...
	<div id="wavescroll">
		...
		<section class="section wave_two_section_two">
			...
			<div class="text" style="font-size:34px;">Aastha Singh </div>
			...
			<div class="intro">
				<div class="container custom_container">
					<div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							<h1 class="page-t">Aastha Singh </h1>
								...
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<div class="facdiv">
											<div class="row">
												<div class="col-md-4">
													<img src="img/faculty/new/ms-aastha-singh.webp?v=1"
														alt="ms-aastha-singh" width="100%">
												</div>
												<div class="col-md-8">
													<div class="facpinfo">
														<p class="facdetail">
															<span>Name:</span>  Ms. Aastha Singh <br>
															<span>Designation:</span> Assistant Professor<br>
															<span>Area:</span> Marketing<br>
															<!-- <span>Email id:</span> pranav@gims.net.in<br> -->
														...
														<p class="brfprofile"><b>Brief Profile:</b> Ms. Aastha is an
															Assistant Professor at GIMS, specializing in the field of
															Marketing. She holds a BA (Hons) in Economics from the
															University of Delhi and an MBA from Chandigarh University.
															With a strong academic foundation and interest in management
															education, she is committed to teaching, learning, and
															academic development.
															</b>
															She demonstrates a keen interest in research, curriculum
															development, and student mentoring, and strives to bridge
															theoretical concepts with practical insights in the
															classroom. Her academic approach emphasizes analytical
															thinking, industry relevance, and continuous professional
															growth, contributing positively to the academic environment
															at the institution.
														</p>
												...
												<div class="col-md-12">
													<div class="tab">
														...
														<button class="tablinks"
															...
															<button class="tablinks"
																onclick="openTab(event, 'Button3')">Conference</button>
														<button class="tablinks"
															onclick="openTab(event, 'Button4')">Teaching Innovation</button>
														<button class="tablinks"
															onclick="openTab(event, 'Button5')">Others Achievements</button>
													</div>
