...
<head>
    ...
    <title>Ms. Sonia Gupta</title>

    <meta name="description" content="Ms. Sonia Gupta, a Ph.D. candidate, combines 4 years at KPMG with 4 years in academia. She has published in Scopus journals, edited academic books, and specializes in corporate training and student soft skills development." />
    ...
    <meta property="og:title" content="Ms. Sonia Gupta">

    <meta property="og:description" content="Ms. Sonia Gupta, a Ph.D. candidate, combines 4 years at KPMG with 4 years in academia. She has published in Scopus journals, edited academic books, and specializes in corporate training and student soft skills development.">
    ...
    <meta name="twitter:title" content="Ms. Sonia Gupta">

    <meta name="twitter:description" content="Ms. Sonia Gupta, a Ph.D. candidate, combines 4 years at KPMG with 4 years in academia. She has published in Scopus journals, edited academic books, and specializes in corporate training and student soft skills development. ">

    <!-- Open Graph general (Facebook, Pinterest & Google+) -->

    <meta name="og:title" content="Ms. Sonia Gupta" />
...
<body class="home_four">
    ...
    <div id="wavescroll">
        ...
        <section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Ms. Sonia Gupta</div>
                ...
                <div class="container custom_container">
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        ...
                        <div class="col-lg-12">
                            ...
                            <h1 class="page-t">Ms. Sonia Gupta</h1>
                                        ...
                                        <div class="facdiv">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <img src="img/faculty/new/girl.jpg" alt="Ms. Sonia Gupta" width="100%">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="facpinfo">
                                                        ...
                                                        <p class="facdetail">
                                                            ...
                                                            <span>Name:</span> Ms. Sonia Gupta<br>

                                                            <span>Designation:</span> : Learning and Development Trainer<br>

                                                            <span>Area:</span> Learning & Development<br>

                                                            <span>Email id:</span> <a href="mailto:teamlnd3@gims.net.in"> teamlnd3@gims.net.in</a><br>
                                                            ...
                                                            <!-- <a class="linkedinic" href="https://www.linkedin.com/in/ina-singh-69b71572?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank">
...
A certified training professional with over 7 years of experience in corporate training, content development, and communication coaching. She has delivered impactful learning programs across organizations like Henry Harvin Education and Tech Mahindra. Her expertise spans soft skills, personality development, digital marketing, and content writing. A certified NLP and life coach with TOEFL credentials, she specializes in building confidence, clarity, and workplace readiness through structured learning interventions. Her strength lies in designing practical, behavior-driven modules that lead to measurable learner transformation.                                                        </p>
                                            ...
                                            <div style="height:20px;"></div>
                                                ...
                                                <!-- <div class="col-md-12">
                                                    ...
                                                    <div class="tab">
                                                        ...
                                                        <button class="tablinks active" onclick="openTab(event, 'Button1')">Award & Research </button>

                                                        <button class="tablinks" onclick="openTab(event, 'Button2')">Certifications</button>
                                                       
                                                        

                                                        <button class="tablinks" onclick="openTab(event, 'Button3')">Area of Interest</button>

                                                        <button class="tablinks" onclick="openTab(event, 'Button4')">Book Published</button>

                                                         <button class="tablinks" onclick="openTab(event, 'Button5')">Other Achievements</button>
                                                    ...
                                                    <p class="factitle">Award & Research </p>

                                                        <ul class="facul links">

                                                             <li>Performance Award - Regional Head Rajasthan, Chhattisgarh, Madhya Pradesh and Pune, GIMS</li>
  <li>Quality Contribution Award, 2021, GIMS</li>
  <li>Quality Performance Award, 2022, GIMS</li>
  <li>Quality Contribution Award, 2023, GIMS</li>
  <li>Placement Coordinator Award, and Quality Performance Award</li>
                                                    ...
                                                    <p class="factitle">Certifications</p>
                                                        ...
                                                        <ul class="facul links">
<li>Preventing Harassment in the Workplace (2018) - Project Management Institute (PMI)</li>
  <li>Certified in Reference Management using “Mendeley”</li>
  <li>Train The Trainer Certified</li>
  <li>POSH Certified</li>
  <li>Six Sigma “White Belt” Certified</li>
  <li>Generative AI</li>
  <li>NLP</li>
  <li>Certificate of Appreciation from Curtin University, Singapore</li>
  <li>Certificate of Appreciation and Participation from De Montfort University, Dubai</li>
  <li>Soft Skill Trainer Certification - 30 PDC's towards SHRM Recertification (HRCI - SPHR/PHR)</li>
  <li>Innovation Ambassador (IA)</li>
  <li>Corporate Trainer and Facilitator Certification - CPD</li>
  <li>Corporate Trainer and Facilitator Certification - HRCI</li>
  <li>Certified in Automation – AutoCAD Map 2009, Arch GIS 9.1, AGIS Erdas 9.1, MAP Info 9.0</li>
</ul>
                                                    ...
                                                    <p class="factitle">Area of Interest</p>
<li>Soft Skill Training</li>
  <li>Strategic Planning</li>
  <li>Instructional Design</li>
  <li>Business Communication</li>
  <li>Need Assessment & Evaluation</li>
  <li>Personality Development</li>
  <li>Team Leadership</li>
  <li>Communication</li>
  <li>Operations Management</li>
  <li>Public Speaking</li>
  <li>Dashboards (Power BI & Data Studio)</li>
  <li>Generative AI</li>
  <li>NLP</li>
                                                    </div>
                                                    ...
                                                    <p class="factitle">Book Published</p>
                                                    ...
                                                    <div id="Button5" class="tabcontent">
                                                           ...
                                                           <ul class="facul" >
  <li>Conducted an EDP on “Mastering The Art of Communication”</li>
  <li>Conducted an online webinar on “Hiring Trends & Employability Skills” & “Resume Defending”</li>
  <li>Coached more than 2000+ management students on their journey to mastering essential Business Communication skills</li>
  <li>Conducted a workshop on "Business Presentation & Public Speaking" in an Executive Development Program, GIMS for international and national participants</li>
  <li>Conducted a workshop on POSH in a corporate engagement program and for PGDM students</li>
</ul>
