...
<head>
    ...
    <title>Music room | Top Management Colleges in Greater Noida</title>
	<meta name="description" content="music-room - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Music room</div>
								...
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<div class="placement-process">
                                            <p class="new-text">
                                            A Music room is a dedicated space where individuals can explore, practice, and enjoy the art of music. Designed to inspire creativity and foster concentration, these rooms are often equipped with musical instruments, soundproofing materials, and comfortable seating. Whether it is a space in a college, or a professional studio, music-rooms serve as sanctuaries for musicians and music enthusiasts alike. They provide an environment free from distractions, allowing people to connect with the rhythms and melodies that express their emotions and ideas.   
                                            </p>
                                            <br>
                                            <div class="gallery-box">
                                                <div class="row">
                                                    <div class="col-md-4 popup-box">
                                                        <a class="example-image-link" href="img/music-room/music-room-1.webp" data-lightbox="example-set" >
                                                            <img class="example-image" src="img/music-room/music-room-11.webp" alt="Gims music-room"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-md-4 popup-box">
                                                        <a class="example-image-link" href="img/music-room/music-room-2.webp" data-lightbox="example-set" >
                                                            <img class="example-image" src="img/music-room/music-room-12.webp" alt="Gims music-room"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-md-4 popup-box">
                                                        <a class="example-image-link" href="img/music-room/music-room-3.webp" data-lightbox="example-set" >
                                                            <img class="example-image" src="img/music-room/music-room-3.webp" alt="Gims music-room"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-md-4 popup-box">
                                                        <a class="example-image-link" href="img/music-room/music-room-4.webp" data-lightbox="example-set" >
                                                            <img class="example-image" src="img/music-room/music-room-4.webp" alt="Gims music-room"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-md-4 popup-box">
                                                        <a class="example-image-link" href="img/music-room/music-room-5.webp" data-lightbox="example-set" >
                                                            <img class="example-image" src="img/music-room/music-room-5.webp" alt="Gims music-room"/>
                                                        </a>
                                                    </div>
                                                    <div class="col-md-4 popup-box">
                                                        <a class="example-image-link" href="img/music-room/music-room-9.webp" data-lightbox="example-set" ><img class="example-image" src="img/music-room/music-room-19.webp" alt="Gims music-room"/></a>
                                                    </div>
                                                    <div class="col-md-4 popup-box">
                                                        <a class="example-image-link" href="img/music-room/music-room-8.webp" data-lightbox="example-set" ><img class="example-image" src="img/music-room/music-room-18.webp" alt="Gims music-room"/></a>
                                                    </div>
                                                    <div class="col-md-4 popup-box">
                                                        <a class="example-image-link" href="img/music-room/music-room-16.webp" data-lightbox="example-set" ><img class="example-image" src="img/music-room/music-room-6.webp" alt="Gims music-room"/></a>
                                                    </div>
                                                    <div class="col-md-4 popup-box">
                                                        <a class="example-image-link" href="img/music-room/music-room-17.webp" data-lightbox="example-set" ><img class="example-image" src="img/music-room/music-room-7.webp" alt="Gims music-room"/></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
