...
<head>
    ...
    <title>Placement Record GIMS | GNIOT Institute of Management Studies</title>
	<meta name="description" content="Placement Record Placement Record GIMS - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
	...
	<meta property="og:title" content="Placement Record GIMS | GNIOT Institute of Management Studies">
	<meta property="og:description" content="Placement Record GIMS - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India.">
	...
	<meta name="twitter:title" content="Placement Record GIMS | GNIOT Institute of Management Studies">
	<meta name="twitter:description" content="Placement Record GIMS - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India.">
            ...
            <div class="intro">
                <div class="container-fluid custom_container">
                    <div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							<h1 class="page-t">Placement Record </h1>
							<h3 class="sub-t">Placement @ GIMS</h3>
						</div>
                        <div class="col-md-12 no-padding">
							<div class="row">
								<div class="col-lg-12">
									<iframe src="https://www.gims.net.in/GIMS-Placement-Results_compressed.pdf" style="border: none; height: 1000px; width: 100%;" frameborder="0"></iframe>
