...
<head>
    ...
    <title>Best Management/PGDM College in Greater Noida</title>
	<meta name="description" content="Placemet Updates - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Placement Updates</div>
            ...
            <div class="intro">
                <div class="container custom_container">
                    <div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							<h1 class="page-t">Placement Updates</h1>
							<h3 class="sub-t">Top PGDM Campus in Greater Noida</h3>
						</div>
                        <div class="col-md-12 no-padding">
							<div class="row">
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<div class="hp-placement2">
											<ul>
												<?php 
													global $conn;
													$sql=mysqli_query($conn,"select * from tbl_placement_updates ORDER BY id DESC LIMIT $start_from, $limit");
													while($row=mysqli_fetch_array($sql)){
												
												?>
												<li class="">
													<h3 class="no-margin pu-text">
										...
										<ul class="pagination-center">
											<?php   
												$sql = "SELECT COUNT(*) FROM tbl_placement_updates";   
												...
												for ($i=1; $i<=$total_pages; $i++) { 
												  if ($i==$pn) { 
													  $pagLink .= "<li class='active bg-white'><a href='placement-updates.php?page="
																						.$i."'>".$i."</a></li>"; 
												  }             
												  else  { 
													  $pagLink .= "<li><a href='placement-updates.php?page=".$i."'> 
																						".$i."</a></li>";   
												  } 
												};   
												echo $pagLink;
