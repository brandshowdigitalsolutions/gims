...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Privacy Policy | Top Management Colleges in Greater Noida</title>
        <meta name="description" content="Privacy Policy - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India." />
        ...
        <!-- Favicon -->
        <link rel="alternate" href="https://www.gims.net.in/privacy-policy.php" hreflang="es-us" />
        <link rel="canonical" href="https://www.gims.net.in/privacy-policy.php" />
        <!-- Search Engine -->
        <meta name="image" content="https://www.gims.net.in/img/gims-logo.jpg" />
        <!-- Facebook Open Graph -->
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Privacy Policy | Top Management Colleges in Greater Noida" />
        <meta property="og:description" content="Privacy Policy - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India." />
        <meta property="og:url" content="https://www.gims.net.in/privacy-policy.php" />
        <meta property="fb:app_id" content="573928583391257" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:site" content="@gims_net_in" />
        <meta name="twitter:title" content="Privacy Policy | Top Management Colleges in Greater Noida" />
        <meta name="twitter:description" content="Privacy Policy - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India." />
        <!-- Open Graph general (Facebook, Pinterest & Google+) -->
        <meta name="og:title" content="Privacy Policy | Top Management Colleges in Greater Noida" />
        <meta name="og:url" content="https://www.gims.net.in/privacy-policy.php" />
        ...
        <script type="application/ld+json">
            {
                ...
                "url": "https://www.gims.net.in/chairmans-message.php",
                "sameAs": [
    ...
    <body class="home_four">
        ...
        <div id="wavescroll">
            <section class="section wave_two_section_two">
                ...
                <div class="text" style="font-size: 34px;">Privacy Policy</div>
        ...
        <div class="row align-items-center new-pd4 zoomanimate">
            ...
            <div class="col-lg-12">
                <h1 class="page-t">Privacy Policy</h1>
                <h3 class="sub-t">GIMS - Greater Noida Institute of Management Studies</h3>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="col-lg-12 new-pd9 awardbg2">
                            <p class="pgdmtext">
                                At <strong>GIMS (Greater Noida Institute of Management Studies)</strong>, we value the trust you place in us and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, and safeguard the information you provide while using our website <a href="https://www.gims.net.in">www.gims.net.in</a>.
                                <br><br>

                                <strong>1. Information We Collect</strong><br>
                                We may collect personal details such as your name, email address, phone number, academic details, and any other information you voluntarily provide through forms, registrations, or applications.
                                <br><br>
                                ...
                                <ul>
                                    ...
                                    <li>Provide academic updates and notifications</li>
                                    <li>Improve our website and services</li>
                                    <li>Communicate important announcements and events</li>
                                </ul>
                                <br>

                                <strong>3. Information Sharing</strong><br>
                                We do not sell, trade, or rent your personal information. Your data may be shared only with trusted partners or regulatory bodies when legally required.
                                <br><br>

                                <strong>4. Data Security</strong><br>
                                We employ strict security measures to protect your personal data against unauthorized access, alteration, or disclosure. However, no method of transmission over the internet can be guaranteed 100% secure.
                                <br><br>

                                <strong>5. Cookies Policy</strong><br>
                                Our website may use cookies to enhance user experience and track website performance. You may choose to disable cookies through your browser settings.
                                <br><br>
                                ...
                                We reserve the right to update or modify this Privacy Policy at any time. Updates will be posted on this page with the revised date.
                                <br><br>

                                <strong>9. Contact Us</strong><br>
                                If you have any questions or concerns regarding this Privacy Policy, please contact us at:<br>
                                Email: <a href="mailto:admission@gims.net.in">admission@gims.net.in</a><br>
                                Phone: 8860606606/63<br>
                                Address: Plot No. 7, Chanakya Block, Knowledge Park-II, Greater Noida, (U.P.), Bharat
                                <br><br>
