...
<head>
    ...
    <title>Faculty Profile of Prof. Anirudh Chakrabarty  | Top Management Colleges in Greater Noida</title>
	<meta name="description" content="Faculty Profile of Prof. Anirudh Chakrabarty  - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
						<div class="col-lg-12">
							<ul class="breadcrumb">
							  ...
							  <li>Prof. Anirudh Chakrabarty</li>
							</ul>
						</div>
						<div class="col-lg-12">
							...
							<div class="row">
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<p class="pgdmtext">
											<img src="img/faculty/anirudh.jpg" class="msgs" alt="Prof. Anirudh Chakrabarty" />
											Prof. Anirudh Chakrabarty is a PGDM from IIM Bangalore with 19 years of corporate experience in some of the leading FMCG and lifestyle brands of India. He is also UGC NET Qualified in Management and completed a Certificate Course in Advance Management from Michigan Ross University. He is a Visiting Faculty in GNIOT, Fortune Institute of International Business, Sunstone University, NIFT and AIMA. He takes various papers in Operations Management and Strategy. Prof Anirudh is also an empaneled trainer with IOCL Retail Academy and is also other training bodies. 
											<br/>
											<br/>
											<br/>
											<br/>
											<strong>
												Prof. Anirudh Chakrabarty<br/>
											</strong>
										</p>
									</div>
								</div>
