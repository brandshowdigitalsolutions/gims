...
<head>
    <meta charset="utf-8">
    <title>Prof. Atul Kumar Singh: Renowned Professor of Practice of Entreprenurship </title>
    <meta name="description" content="Prof. Atul Kumar Singh, an IIM Ahmedabad PGDM and IIT Roorkee B.Tech graduate, brings 15+ years of rich startup and industry experience. As a serial entrepreneur, he co-founded successful ventures in student housing and daily meals. He secured significant funding for Placio, a pioneering student housing startup. With leadership roles and a background in contesting elections, he is a dynamic Professor of Entrepreneurship and Strategy. " />
    <meta name="keywords" content="Prof. Atul Kumar Singh, GIMS faculty members,GIMS faculty profiles,GIMS faculty directory,GIMS faculty qualifications,GIMS faculty expertise,GIMS faculty research areas,GIMS faculty publications,GIMS faculty contact information,GIMS faculty achievements,GIMS faculty experience,GIMS faculty specializations,GIMS faculty academic background,GIMS faculty professional affiliations,GIMS faculty teaching philosophy." />
    ...
    <link rel="alternate" href="https://www.gims.net.in/prof-atul-kumar-singh.php" hreflang="es-us" />
    <link rel="canonical" href="https://www.gims.net.in/prof-atul-kumar-singh.php">
    ...
    <meta property="og:title" content="Prof. Atul Kumar Singh: Renowned Professor of Practice of Entreprenurship ">
    <meta property="og:description" content="Prof. Atul Kumar Singh, an IIM Ahmedabad PGDM and IIT Roorkee B.Tech graduate, brings 15+ years of rich startup and industry experience. As a serial entrepreneur, he co-founded successful ventures in student housing and daily meals. He secured significant funding for Placio, a pioneering student housing startup. With leadership roles and a background in contesting elections, he is a dynamic Professor of Entrepreneurship and Strategy.">
    <meta property="og:url" content="https://www.gims.net.in/prof-atul-kumar-singh.php">
    <meta property="fb:app_id" content="573928583391257">


    <meta name="twitter:card" content="summary">
    <meta name="twitter:site" content="@GNIOTCollege">
    <meta name="twitter:title" content="Prof. Atul Kumar Singh: Renowned Professor of Practice of Entreprenurship ">
    <meta name="twitter:description" content="Prof. Atul Kumar Singh, an IIM Ahmedabad PGDM and IIT Roorkee B.Tech graduate, brings 15+ years of rich startup and industry experience. As a serial entrepreneur, he co-founded successful ventures in student housing and daily meals. He secured significant funding for Placio, a pioneering student housing startup. With leadership roles and a background in contesting elections, he is a dynamic Professor of Entrepreneurship and Strategy.">

    <!-- Open Graph general (Facebook, Pinterest & Google+) -->
    <meta name="og:title" content="Prof. Atul Kumar Singh: Renowned Professor of Practice of Entreprenurship " />
    <meta name="og:url" content="https://www.gims.net.in/prof-atul-kumar-singh.php">
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "https://www.gims.net.in/prof-atul-kumar-singh.php",
            "sameAs": [
...
<body class="home_four">
    ...
    <div id="wavescroll">
        ...
        <section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;"> Prof. Atul Kumar Singh</div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        <div class="col-lg-12">
                            <ul class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li>Faculty</li>
                                <li>Prof. Atul Kumar Singh</li>
                            </ul>
                        </div>
                        <div class="col-lg-12">
                            <h1 class="page-t">Prof. Atul Kumar Singh</h1>
                                ...
                                <div class="col-lg-9">
                                    <div class="col-lg-12 new-pd9 awardbg2">
                                        <div class="facdiv">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="https://www.gims.net.in/img/faculty/atul-kumar-singh.jpg" alt="Prof. Atul Kumar Singh " width="100%">
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="facpinfo">
                                                        <p class="facdetail">
                                                            <span>Name: </span> Prof. Atul Kumar Singh<br>
                                                            <span>Designation: </span>Professor of Practice<br>
                                                            <span>Area: </span>Entreprenurship <br>
                                                            <span>Email id: </span> <a href="mailto:atulsingh.pgdm@gniot.net.in">atulsingh.pgdm@gniot.net.in</a> <br>
                                                            <!-- <span>Researchgate ID:</span><a href=" https://www.researchgate.net/profile/Ranu-Saxena" target="_blank" rel="nofolllow"> Ajay-Varshney-2</a><br> -->
                                                            <!-- <span>ORICID ID: </span>0009-0006-0873-5142 <br> -->
                                                            <span>Vidwan ID: </span> 384758<br>
                                                            <span></span> <a class="linkedinic" href="https://www.linkedin.com/in/atulkumarsinghiim/" target="_blank"><svg width="80px" height="20px" viewBox="20 0 500 140" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                                                                    <g>
                                                        ...
                                                        <p class="brfprofile">Prof. Atul Kumar Singh is a PGDM from IIM Ahmedabad and B.Tech from IIT Roorkee. He has a total of 15+ years of rich startups and industry experience. He had been a serial entrepreneur and co-founded two startup ventures one in Student Housing space and another in Daily meals. The Student Housing startup, Placio, was one of the first movers in Student Housing in India in which he had secured $2 Million funding for Placio from Pre-Stellar Ventures, a Singapore based Venture Capital firm. He also has the distinction of contesting Lok Sabha elections in the year 2014. In the organisations where he has worked, he has primarily held leadership positions. He is a dynamic and enterprising individual with the ability to build the organisation from scratch and identify real-life problems and develop solutions to solve them. He is a Professor of Entrepreneurship and Strategy.</p>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div id="Button2" class="tabcontent links" style="display: block;">
                                                        ...
                                                        <ul class="facul">
                                                            <li>Consulted two companies on paid basis: SKV india and OfficeBanao. </li>
                                                            <li>Consulting two companies on pro-bono basis: Sibrooms Pvt. Ltd, Burlycare Pvt. Ltd.</li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div id="Button5" class="tabcontent links">
                                                        ...
                                                        <ul class="facul">
                                                            <li>Currently, Visiting faculty at Bennett University.</li>
                                                            <li>Guest Lecture in Amity University on Entreprenurship</li>
                                                        </ul>
