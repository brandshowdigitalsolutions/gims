...
<head>
    <meta charset="utf-8">
    <title>Prof. Dr Neetu Bali Kamra: Professor</title>
    <meta name="description" content="Explore the profile of Dr. Neetu Bali Kamra, a certified design thinking professional from IBM with 18 years of experience in Industry and Academia. Specializing in Management for Business 4.0, ERP SAP-HCM, and BI tools like Qlik, Power BI, and Tableau, she contributes expertise in HR function, research, and development. Winner of the Best Young Faculty Award at Skill Up 2021 for Data Analytics, Dr. Kamra is a recognized trainer for Management Workshops and an Empanelled Expert with Delhi Productivity Council.
" />
    <meta name="keywords" content="Dr. Neetu Bali Kamra, Design Thinking, Business Analytics, Management, HR Function, ERP SAP-HCM, BI Tools, Qlik, Power BI, Tableau, Research and Development, Data Analytics, Industry Expert, Academia, Best Young Faculty Award, Skill Up 2021, Delhi Productivity Council, Management Workshops, Trainer, Creative Skills Development, Lateral Thinking, People Management, SAP-ERP Specialist, Projects, Workshops, Training Programs, Skill Development, Petronet, ICAI." />
    ...
    <link rel="alternate" href="https://www.gims.net.in/prof-dr-neetu-bali-kamra.php" hreflang="es-us" />
    <link rel="canonical" href="https://www.gims.net.in/prof-dr-neetu-bali-kamra.php">
    ...
    <meta property="og:title" content="Dr. Neetu Bali Kamra - Expert in Design Thinking, Management, and Business Analytics
">
    <meta property="og:description" content="Explore the profile of Dr. Neetu Bali Kamra, a certified design thinking professional from IBM with 18 years of experience in Industry and Academia. Specializing in Management for Business 4.0, ERP SAP-HCM, and BI tools like Qlik, Power BI, and Tableau, she contributes expertise in HR function, research, and development. Winner of the Best Young Faculty Award at Skill Up 2021 for Data Analytics, Dr. Kamra is a recognized trainer for Management Workshops and an Empanelled Expert with Delhi Productivity Council.">
    <meta property="og:url" content="https://www.gims.net.in/prof-dr-neetu-bali-kamra.php">
    <meta property="fb:app_id" content="573928583391257">


    <meta name="twitter:card" content="summary">
    <meta name="twitter:site" content="@GNIOTCollege">
    <meta name="twitter:title" content="Dr. Neetu Bali Kamra - Expert in Design Thinking, Management, and Business Analytics
">
    <meta name="twitter:description" content="Explore the profile of Dr. Neetu Bali Kamra, a certified design thinking professional from IBM with 18 years of experience in Industry and Academia. Specializing in Management for Business 4.0, ERP SAP-HCM, and BI tools like Qlik, Power BI, and Tableau, she contributes expertise in HR function, research, and development. Winner of the Best Young Faculty Award at Skill Up 2021 for Data Analytics, Dr. Kamra is a recognized trainer for Management Workshops and an Empanelled Expert with Delhi Productivity Council.">

    <!-- Open Graph general (Facebook, Pinterest & Google+) -->
    <meta name="og:title" content="Dr. Neetu Bali Kamra - Expert in Design Thinking, Management, and Business Analytics" />
    <meta name="og:url" content="https://www.gims.net.in/prof-dr-neetu-bali-kamra.php">
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "https://www.gims.net.in/prof-dr-neetu-bali-kamra.php",
            "sameAs": [
...
<body class="home_four">
    ...
    <div id="wavescroll">
        ...
        <section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Prof. Dr Neetu Bali Kamra</div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        <div class="col-lg-12">
                            <ul class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li>Faculty</li>
                                <li>Prof. Dr Neetu Bali Kamra</li>
                            </ul>
                        </div>
                        <div class="col-lg-12">
                            <h1 class="page-t">Prof. Dr Neetu Bali Kamra</h1>
                                ...
                                <div class="col-lg-9">
                                    <div class="col-lg-12 new-pd9 awardbg2">
                                        <div class="facdiv">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="img/faculty/new/prof-dr-neetu-bali-kamra.png" alt="Prof. Dr Neetu Bali Kamra" width="100%">
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="facpinfo">
                                                        <p class="facdetail">
                                                            <span>Name:</span> Prof. Dr Neetu Bali Kamra<br>
                                                            <span>Designation:</span> Professor<br>
                                                            <span>Area:</span> HR & Analytics<br>
                                                            <span>Email id:</span> <a href="neetu.bali.pgdm@gniot.net.in">neetu.bali.pgdm@gniot.net.in</a><br>
                                                            <!-- <span>Researchgate ID:</span> <a href="https://www.researchgate.net/profile/Mudit-Tomar-3" target="_blank" rel="nofollow"> Mudit-Tomar-3</a><br> -->
                                                            <!-- <span>Vidwan ID:</span>  384585<br>
                                                            <span>ORICID ID:</span> 0000-0002-0731-1691<br> -->
                                                            <!-- <span></span> <a class="linkedinic" href="https://www.linkedin.com/feed/" target="_blank"><svg width="80px" height="20px" viewBox="20 0 500 140" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                                                                    <g>
                                                        ...
                                                        <p class="brfprofile">
                                                            ...
                                                            <b>Dr Neetu Bali Kamra</b>, certified in design thinking from IBM, I currently am practicing a techno-functional role in the field of Management for Business 4.0 augmentation in imparting skills in Management domain. With the expertise of Human Resources Function, ERP SAP-HCM and BI tools like Qlik, Power BI and Tableau, and with the research skills from my Doctorate program, I aspire to contribute my knowledge in the areas of research and development and designing business solutions through qualitative and quantitative reasoning approach. With an experience of 18years in Industry and Academia I have been enabling organizations through projects, workshops, and training program for Industry with skills of analytics through design thinking . I am Empanelled with Delhi productivity Council (A Tripartite Autonomous Organization under Delhi Administration Govt. of NCT of Delhi and Affiliated to National Productivity Council) of Experts as Trainer, for Management Workshops for Industry. Also, Winner of Best Young Faculty Award at Skill Up 2021 for Data Analytics by Analytics India Magazine (AIM) these manifestations have been possible through use of design thinking through business analytics. A trained Propellor and Change Leader during my stint with TCS the exposure to people management development was very dominant in early days of my career. Also a SAP-ERP specialist in HRM have been closely associated with projects for redesigning their Human resource systems. I have been conducting workshops and trainings for creative skills development, design thinking & lateral thinking for corporates, students, and faculties for numerous Organizations in the past like Petronet, ICAI and many more.
                                                        </p>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="tab">
                                                        <button class="tablinks active" onclick="openTab(event, 'Button2')">Publications & Conferences</button>
                                                        <button class="tablinks" onclick="openTab(event, 'Button3')">FDP and MDP</button>
                                                    </div>
  
                                                    <div id="Button2" class="tabcontent" style="display:block;">
                                                        <!-- <p class="factitle">Publications & Conferences</p> -->
                                                        <ul class="facul links">
                                                        <li>Copyrights Publishing in Progress titled “SUSTAPRENUER” under IPR (Intellectual Property Rights) (In Progress)</li>
                                                        <li>Paper Tiltled “Sense making of Online Digital Platform as Business Model Reengineering in Management
                                                        Education during the Covid-19 pandemic through ‘Sociomateriality’ view of technology” ( In progress , Scopus Indexed)</li> 
                                                        <li>Paper Titled “A study to explore the factors that impact organizational effectiveness through a socio-technical perspective in Organizations: A case in Information Technology Organizations in India” SCMS Journal of Indian Management (In progress Scopus, Indexed)</li>
                                                        <li>Role of Emerging Job Skills for Adjusting to Digital Work–Life Challenges , Bali, N., Sinha, C. Vision,2023 ,14(1),pp1-14 . DOI: 10.1177/09722629221145806 (ABDC C category and Scopus)</li>
                                                        <li>Sense-making of socio-materiality of technology in organizations: Using qualitative technique through social construction Bali, N., Sinha, C. International Journal of Scientific and Technology Research, 2020, 9(2), pp. 4946–4952 (Scopus IndexedSense making of the socio-material implementation of ERP tool in IT organizations Bali, N., Sinha, C., 2020, 8(3-4), pp. 299–322 (Scopus Indexed)</li>
                                                        <li>Exploring the mediating role of technology between human realms and institutional properties of organizations with special reference to it industry in India Bali, N., Sinha, C. International Journal of Recent Technology and Engineering, 2019, 8(2), pp. 1437–1442 (Scopus Indexed)</li>
                                                        <li>Exploring the growth of Business Intelligence in developing performative practices in organizations , 2022 January issue for Journal for Delhi Productivity Council, Delhi Productivity Council of India.</li> 
                                                        <li>Driving Managerial Excellence Amongst Students Through Intervention of Digital Pedagogy – Sensemaking, Proceedings of International Conference on Digital Pedagogies (ICDP) 2019, (SSRN)</li>
                                                        <li>
                                                        Dr. Neetu Kamra presented the paper Titled “Study to explore the Sociomateriality of Online Learning through Design Thinking, in the Human Resources” 7,th Global Leadership Research Conference 2022 on the theme ‘Leading in the New Reality: Insights into Actions’ held at AmityBusiness School, Noida,India.16-18th Feb 2022.
                                                        </li>
                                                        <li>Dr Neetu Kamra , presented the  paper Tiltled “A study to analyze the churn rate for customers in Telecom sector using Predictive Analytics in data science”, International E-Conference on “Computing and Data Science” on 25th September,2021</li>
                                                        <li>Dr Neetu Bali Kamra,presented the paper titled A study on Sociomateriality view of Technology on Social factors in Organizations for Harmonization of material (technology) and non-material (humans) aspects of Organizations. in the 8th International Conference on Sustainability (SUSCON 2021) held at the Indian Institute of Management Shillong (virtual) during 26-30 July 2021</li>
                                                        </ul>
                                                    </div>
                                                    <div id="Button3" class="tabcontent">
                                                        <!-- <p class="factitle">FDP and MDP</p> -->
                                                        <ul class="facul links">
                                                            <li>Series of rigorous 8 workshops for Petronet India Ltd, as  Trainer for Team development in 2022.</li>
                                                            <li>Conducted workshop for Delhi Productivity Council (DPC)  in March 2022 on 3Ds (Data Analytics, data science and digital Transformation) for Industry</li>
                                                            <li>FDP ON 16TH July 2021, Block chain and its applications , AICTE ATAL Initiative</li>
                                                            <li>
                                                            Conducted Workshop for ICAI on Managerial Effectiveness (The Institute of Chartered Accountants Of India)
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
