...
<head>
    ...
    <title>Faculty Profile of Prof. Gouri Shankar Sharma  | Top Management Colleges in Greater Noida</title>
	<meta name="description" content="Faculty Profile of Prof. Gouri Shankar Sharma - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
						<div class="col-lg-12">
							<ul class="breadcrumb">
							  ...
							  <li>Prof. Gouri Shankar Sharma</li>
							</ul>
						</div>
						<div class="col-lg-12">
							...
							<div class="row">
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<p class="pgdmtext">
											<img src="img/faculty/gouri-shankar-sharma.jpg" class="msgs" alt="Prof. Gouri Shankar Sharma" />
											Gouri Shankar Sharma holds a master’s degree MBA (HR & Marketing), at present he is pursuing PhD in the area of social media learning. He qualified UGC-NET (2013, 2018) in management discipline. Before joining GIMS-Greater Noida as a visiting faculty he has eight years of industry and academic experience. He has national and international publications including UGC-Care indexed journals. He attended various workshops organized by IITs & IIMs. He presented research papers in IIM-Bodhgaya, NIT-Hamirpur, and Central Universities etc. 
											<br/>
                                            <br>
                                            He taught subjects like HRM, OB, Learning and Development, Industrial Relations & IR, Organizational Development, Managerial Economics, Research Methodology and Human Values & Professional Ethics. He conducted various industries and academic oriented training programs. He provides soft skill training to students for industry ready. 
                                            <br>
                                            <br>
                                            His research interest is in the field of online learning, motivation, OCB, spiritual intelligence, social media learning, technology adoption for learning, ICT based learning etc.
                                            <br>
                                            <br>
											<strong>
												Prof. Gouri Shankar Sharma<br/>
                                                PhD(Management)*, MBA
