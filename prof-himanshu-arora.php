...
<head>
    ...
    <title>Faculty Profile of Prof. Himanshu Arora   | Top Management Colleges in Greater Noida</title>
	<meta name="description" content="Faculty Profile of Prof. Himanshu Arora   - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
							...
							<div class="row">
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<p class="pgdmtext">
											<img src="img/faculty/prof-himanshu-arora.jpg" class="msgs" alt="Prof. Himanshu Arora "/>
											Prof. Himanshu is an experienced finance professional with over a decade of industry, training and teaching experience. He has worked at senior positions in reputed companies in India. His area of specialization include Financial Modelling & Corporate Valuation, Financial Derivatives, Mergers & Acquisitions, Financial Management, etc. Prof. Himanshu is currently associated as Visiting Faculty with multiple management institutes.
											<br/>
											<br/>
											<strong>
												Prof. Himanshu Arora 
