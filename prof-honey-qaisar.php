...
<head>
    <meta charset="utf-8">
    <title>Prof. Honey Qaisar : Renowned Assistant Professor of Learning & Development </title>
    <meta name="description" content="Prof. Honey Qaisar, a renowned Assistant Professor specializing in Learning & Development, brings expertise and experience in the field. " />
    <meta name="keywords" content="Prof. Honey Qaisar , GIMS faculty members,GIMS faculty profiles,GIMS faculty directory,GIMS faculty qualifications,GIMS faculty expertise,GIMS faculty research areas,GIMS faculty publications,GIMS faculty contact information,GIMS faculty achievements,GIMS faculty experience,GIMS faculty specializations,GIMS faculty academic background,GIMS faculty professional affiliations,GIMS faculty teaching philosophy." />
    ...
    <link rel="alternate" href="https://www.gims.net.in/prof-honey-qaisar.php" hreflang="es-us" />
    <link rel="canonical" href="https://www.gims.net.in/prof-honey-qaisar.php">
    ...
    <meta property="og:title" content="Prof. Honey Qaisar : Renowned Assistant Professor of Learning & Development ">
    <meta property="og:description" content="Prof. Honey Qaisar, a renowned Assistant Professor specializing in Learning & Development, brings expertise and experience in the field.">
    <meta property="og:url" content="https://www.gims.net.in/prof-honey-qaisar.php">
    <meta property="fb:app_id" content="573928583391257">


    <meta name="twitter:card" content="summary">
    <meta name="twitter:site" content="@GNIOTCollege">
    <meta name="twitter:title" content="Prof. Honey Qaisar : Renowned Assistant Professor of Learning & Development ">
    <meta name="twitter:description" content="Prof. Honey Qaisar, a renowned Assistant Professor specializing in Learning & Development, brings expertise and experience in the field.">

    <!-- Open Graph general (Facebook, Pinterest & Google+) -->
    <meta name="og:title" content="Prof. Honey Qaisar : Renowned Assistant Professor of Learning & Development " />
    <meta name="og:url" content="https://www.gims.net.in/prof-honey-qaisar.php">
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "https://www.gims.net.in/prof-honey-qaisar.php",
            "sameAs": [
...
<body class="home_four">
    ...
    <div id="wavescroll">
        ...
        <section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;"> Prof. Honey Qaisar </div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        <div class="col-lg-12">
                            <ul class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li>Faculty</li>
                                <li>Prof. Honey Qaisar </li>
                            </ul>
                        </div>
                        <div class="col-lg-12">
                            <h1 class="page-t">Prof. Honey Qaisar </h1>
                                ...
                                <div class="col-lg-9">
                                    <div class="col-lg-12 new-pd9 awardbg2">
                                        <div class="facdiv">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="img/faculty/new/honey-qaisar.webp" alt="Prof. Honey Qaisar  " width="100%">
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="facpinfo">
                                                        <p class="facdetail">
                                                            <span>Name:</span> Prof. Honey Qaisar <br>
                                                            <span>Designation:</span>Assistant Professor <br>
                                                            <span>Area:</span>Learning & Development <br>
                                                            <span>Email id:</span> <a href="mailto:honeyqaisar.pgdm@gniot.net.in">honeyqaisar.pgdm@gniot.net.in</a> <br>
                                                            ...
                                                            <!-- <span></span> <a class="linkedinic" href="https://www.linkedin.com/in/anshika-rajvanshi-03a27017b/ " target="_blank"><svg width="80px" height="20px" viewBox="20 0 500 140" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                                                                    <g>
                                                        ...
                                                        <p class="brfprofile">Prof.Honey Qaisar Masters in English Literature,from Aligarh Muslim University,Bachelor's in Education,Jamia Millia Islamia, Graduated in English Literature and Linguistics from Aligarh Muslim University.Certified Trainer from British Council with over 10 years of cross Industry experience ,Trained and coached students and professionals across verticals and locations.Corporate Trainer specialization in designing,developing and delivering successful training programme. Worked as a trainer with British Council ,Corporates and Educational Institutes to name a few IBM Gurgaon,Redington India,Hcl and Private and Govt Colleges of IP University ,Sharda University and many more..Have conducted various training for teaching and non teaching staff and exclusive Empathy building sessions for Medical students and healthcare professionals in Sharda Hospital Greater Noida. Training and motivating 1000s of mind in last 7 years,Passionate about making the students" Industry ready " and assist them in their transition from college to corporate.</p>
