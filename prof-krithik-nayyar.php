...
<html lang="en"><head>
    ...
    <title>Prof. Krithik Nayyar</title>

    <meta name="description" content="GIMS- Soft skills trainer with 3+ years in aviation and an MBA in HR. I enhance communication and teamwork through tailored training, boosting employee engagement and customer service." />
    ...
    <!-- Favicon -->    <link rel="alternate" href="https://www.gims.net.in/prof-krithik-nayyar.php" hreflang="es-us" />

    <link rel="canonical" href="https://www.gims.net.in/prof-krithik-nayyar.php">    <!-- Search Engine -->

    <meta name="image" content="https://www.gims.net.in/img/gims-logo.jpg">    <!-- Facebook Open Graph -->

    <meta property="og:type" content="website">

    <meta property="og:title" content="Prof. Krithik Nayyar ">

    <meta property="og:description" content="GIMS: Soft skills trainer with 3+ years in aviation and an MBA in HR. I enhance communication and teamwork through tailored training, boosting employee engagement and customer service.">

    <meta property="og:url" content="https://www.gims.net.in/prof-krithik-nayyar.php">
    ...
    <meta name="twitter:title" content="Prof. Krithik Nayyar ">

    <meta name="twitter:description" content="GIMS: Soft skills trainer with 3+ years in aviation and an MBA in HR. I enhance communication and teamwork through tailored training, boosting employee engagement and customer service.">    <!-- Open Graph general (Facebook, Pinterest & Google+) -->

    <meta name="og:title" content="Prof. Krithik Nayyar" />

    <meta name="og:url" content="https://www.gims.net.in/prof-krithik-nayyar.php">
    ...
    <!-- Geotag End -->    <script type="application/ld+json">
    ...
    <script type="application/ld+json">

        {
            ...
            "url": "https://www.gims.net.in/prof-krithik-nayyar.php",
    ...
    </script>    <link rel="apple-touch-icon" sizes="57x57" href="img/fevicon/apple-icon-57x57.png">
...
</head><body class="home_four">

    <?php include "top-menu.php"; ?>    <div id="wavescroll">        <section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;"> Prof. Krithik Nayyarr</div>
                ...
                <div class="container custom_container">
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        ...
                        <div class="col-lg-12">
                            ...
                            <h1 class="page-t">Prof. Krithik Nayyar </h1>
                                        ...
                                        <div class="facdiv">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <img src="img/faculty/new/prof-krithik-nayyar.webp" alt="Prof. Krithik Nayyar " width="100%">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="facpinfo">
                                                        ...
                                                        <p class="facdetail">
                                                            ...
                                                            <span>Name:</span> Prof. Krithik Nayyar<br>

                                                            <span>Designation:</span> Assistant Professor<br>

                                                            <span>Area:</span> Learning and Development<br>

                                                            <span>Email id:</span> <a href="mailto:teamlnd8@gims.net.in">teamlnd8@gims.net.in</a>

                                                            <!-- <span>ORICID ID: </span>0000-0002-8636-8417<br>

                                                            <span>Vidwan ID: </span> 161563<br> -->

                                                            <span></span> <a class="linkedinic" href="https://www.linkedin.com/in/krithik-nayyar-46211619b/" target="_blank"><svg width="80px" height="20px" viewBox="20 0 500 140" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                                                        ...
                                                        <p class="brfprofile">Prof. Krithik Nayyar is an Assistant Professor at GIMS in the Department of Learning & Development, with over three years of experience as a soft skills trainer in the aviation industry and an MBA in Human Resource Management. He specializes in enhancing interpersonal, communication, and customer service skills, tailored to industry-specific needs.

                                                            <br>He has successfully designed and delivered impactful training programs focused on teamwork, conflict resolution, and professional development, leading to improved employee engagement and customer satisfaction. At GIMS, he also develops certification modules and collaborates with industry leaders to address real-world challenges.

                                                            <br>Recently, he has earned certifications in Generative ID for Everyone, and his areas of interest include emotional intelligence, digital learning, and leadership development. Krithik remains committed to promoting a culture of continuous growth and soft skill excellence across organizations.
                                                        </p>
    ...
    </div>    <?php include "footer-bottom.php"; ?>    <style>
