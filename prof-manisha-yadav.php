...
<head>
    <meta charset="utf-8">
    <title>Prof. Manisha Yadav : Renowned Assistant Professor of French Language</title>
    <meta name="description" content="Prof. Manisha, a Masters in French from the University of Delhi, specializes in the language with a Delf B1 certification. With prior experience in Aviation, she brings a unique perspective to her teaching. " />
    <meta name="keywords" content="Prof. Manisha Yadav 	, GIMS faculty members,GIMS faculty profiles,GIMS faculty directory,GIMS faculty qualifications,GIMS faculty expertise,GIMS faculty research areas,GIMS faculty publications,GIMS faculty contact information,GIMS faculty achievements,GIMS faculty experience,GIMS faculty specializations,GIMS faculty academic background,GIMS faculty professional affiliations,GIMS faculty teaching philosophy." />
    ...
    <link rel="alternate" href="https://www.gims.net.in/prof-manisha-yadav.php" hreflang="es-us" />
    <link rel="canonical" href="https://www.gims.net.in/prof-manisha-yadav.php">
    ...
    <meta property="og:title" content="Prof. Manisha Yadav : Renowned Assistant Professor of French Language	">
    <meta property="og:description" content="Prof. Manisha, a Masters in French from the University of Delhi, specializes in the language with a Delf B1 certification. With prior experience in Aviation, she brings a unique perspective to her teaching.">
    <meta property="og:url" content="https://www.gims.net.in/prof-manisha-yadav.php">
    <meta property="fb:app_id" content="573928583391257">


    <meta name="twitter:card" content="summary">
    <meta name="twitter:site" content="@GNIOTCollege">
    <meta name="twitter:title" content="Prof. Manisha Yadav : Renowned Assistant Professor of French Language	">
    <meta name="twitter:description" content="Prof. Manisha, a Masters in French from the University of Delhi, specializes in the language with a Delf B1 certification. With prior experience in Aviation, she brings a unique perspective to her teaching.">

    <!-- Open Graph general (Facebook, Pinterest & Google+) -->
    <meta name="og:title" content="Prof. Manisha Yadav : Renowned Assistant Professor of French Language	" />
    <meta name="og:url" content="https://www.gims.net.in/prof-manisha-yadav.php">
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "https://www.gims.net.in/prof-manisha-yadav.php",
            "sameAs": [
...
<body class="home_four">
    ...
    <div id="wavescroll">
        ...
        <section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;"> Prof. Manisha Yadav 	</div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        <div class="col-lg-12">
                            <ul class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li>Faculty</li>
                                <li>Prof. Manisha Yadav 	</li>
                            </ul>
                        </div>
                        <div class="col-lg-12">
                            <h1 class="page-t">Prof. Manisha Yadav 	</h1>
                                ...
                                <div class="col-lg-9">
                                    <div class="col-lg-12 new-pd9 awardbg2">
                                        <div class="facdiv">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="https://www.gims.net.in/img/faculty/prof-manisha-yadav.jpg" alt="Prof. Manisha Yadav" width="100%">
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="facpinfo">
                                                        <p class="facdetail">
                                                            <span>Name:</span> Prof. Manisha Yadav 	<br>
                                                            <span>Designation:</span>Assistant Professor <br>
                                                            <span>Area:</span>French Language<br>
                                                            <span>Email id:</span> <a href="mailto:manishayadav.pgdm@gniot.net.in">manishayadav.pgdm@gniot.net.in</a> <br>
                                                            ...
                                                            <span></span> <a class="linkedinic" href="https://www.linkedin.com/in/manisha-yadav-57900325b" target="_blank"><svg width="80px" height="20px" viewBox="20 0 500 140" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                                                                    <g>
                                                        ...
                                                        <p class="brfprofile">Prof. Manisha, Masters in French, from Department of GRS, University of Delhi (2019). Delf B1 from Alliance Francaise de Delhi. With prior experience in Aviation.</p>
