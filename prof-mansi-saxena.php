...
<head>
    <meta charset="utf-8">
    <title>Ms. Mansi Saxena, Assistant Professor </title>
    <meta name="description"
        content="Prof. Mansi Saxena, Assistant Professor / AI and BA at GNIOT Institute of Management with 20+ years of academic experience. He specializes in Information Systems, Business Intelligence, Data Visualization, and related IT & Management subjects, holding a Ph.D. in Computer Science and Engineering." />
    <meta name="keywords"
        content="Prof. Mansi Saxena, Assistant Professor / AI and BA, Professor, GNIOT Institute of Management, Business Analytics, IT, Information Systems Management, Business Intelligence, Data Visualization, Data Mining, Business Statistics, Ph.D. in CSE, Advanced Excel, SQL, RDBMS." />
    ...
    <link rel="alternate" href="https://www.gims.net.in/bhupender-singh.php" hreflang="es-us" />
    <link rel="canonical" href="https://www.gims.net.in/bhupender-singh.php">
    ...
    <meta property="og:title" content="Prof. Mansi Saxena, Assistant Professor / AI and BA">
    <meta property="og:description"
        content="Prof. Mansi Saxena, Assistant Professor / AI and BA at GNIOT Institute of Management with over 20 years of academic experience. He specializes in Information Systems, Business Intelligence, Data Visualization, and Business Analytics, and holds a Ph.D. in Computer Science and Engineering.">
    <meta property="og:url" content="https://www.gims.net.in/bhupender-singh.php">
    <meta property="fb:app_id" content="573928583391257">


    <meta name="twitter:card" content="summary">
    <meta name="twitter:site" content="@GNIOTCollege">
    <meta name="twitter:title" content="Prof. Mansi Saxena, Assistant Professor / AI and BA">
    <meta name="twitter:description"
        content="Prof. Mansi Saxena, Assistant Professor / AI and BA specializes in Business Analytics, IT, and Data Visualization with over 20 years of academic experience. Dean (Business Analytics) & HOD (IT).">

    <!-- Open Graph general (Facebook, Pinterest & Google+) -->
    <meta name="og:title" content="Prof. Mansi Saxena, Assistant Professor / AI and BA" />
    <meta name="og:url" content="https://www.gims.net.in/bhupender-singh.php">
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "https://www.gims.net.in/bhupender-singh.php",
            "sameAs": [
...
<body class="home_four">
    ...
    <div id="wavescroll">
        ...
        <section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Ms. Mansi Saxena</div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        <div class="col-lg-12">
                            <ul class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li>Faculty</li>
                                <li>Ms. Mansi Saxena</li>
                            </ul>
                        </div>
                        <div class="col-lg-12">
                            <h1 class="page-t">Ms. Mansi Saxena</h1>
                                ...
                                <div class="col-lg-9">
                                    <div class="col-lg-12 new-pd9 awardbg2">
                                        <div class="facdiv">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="img/faculty/new/prof-mansi-saxena.webp?v=1"
                                                        alt="Dr. Swati Gautam" width="100%">
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="facpinfo">
                                                        <p class="facdetail">
                                                            <span>Name:</span>Ms. Mansi Saxena<br>
                                                            <span>Designation:</span>Assistant Professor<br>
                                                            <span>Area:</span>Finance<br>
                                                            <span>Email id:</span><a href="mansi.saxena@gims.net.in">
                                                                mansi.saxena@gims.net.in</a> <br>
                                                            <span>Vidwan ID:</span> 703681<br>
                                                            <span>Orcid Id: </span> <a
                                                                href="https://orcid.org/0009-0004-1613-780X">0009-0004-1613-780X</a><br>
                                                            <span>linkedin:</span> <a class="linkedinic"
                                                                href="https://www.linkedin.com/in/mansi-saxena-292852296?utm_source=share_via&utm_content=profile&utm_medium=member_ios"
                                                        ...
                                                        <p class="brfprofile"><b>Brief Profile:</b> Mansi Saxena is an
                                                            accomplished academic professional with over 13 years of
                                                            experience in higher education, specializing in Finance and
                                                            Business Communication. She is currently pursuing a Ph.D. in
                                                            Finance, demonstrating her dedication to research and
                                                            continuous learning.
                                                            <br>
                                                            Throughout her career, she has contributed significantly to
                                                            teaching, curriculum development, academic coordination, and
                                                            student mentoring, ensuring a balance between academic rigor
                                                            and practical exposure.
                                                            <br>
                                                            Known for her interactive teaching style and ability to
                                                            connect classroom concepts with real-world applications, she
                                                            aims to bridge the gap between academia and industry,
                                                            fostering professional competence and holistic growth among
                                                            learners.
                                                        </p>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div id="Button2" class="tabcontent links">
                                                        <p class="factitle">FDPs</p>
                                                        <ul class="facul">
                                                            <li>Attended Two Days Faculty Development Program on “Case
                                                                Study Writing and Case Method Teaching” program at IIM
                                                                Rohtak scheduled on 8th-9th November 2025.</li>
                                                            <li>Participated in Five Days Faculty Development Program on
                                                                “Empowering Educators with Generative AI: Transforming
                                                                Teaching & Learning” scheduled on 13th-17th April 2026
                                                                hosted by GNIOT Institute of Professional Studies,
                                                                Greater Noida.</li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div id="Button3" class="tabcontent">
                                                        ...
                                                        <ul class="facul">
                                                            <li>Presented paper in International Conference titled as
                                                                “Role of AI in promoting Green Banking Practices” on AI
                                                                for Multidisciplinary Innovation & Sustainability
                                                                organized by Noida International University, Noida on
                                                                23rd Jan’2026.</li>
                                                            <li>Presented paper on 5th International Conference titled
                                                                as “A Study on the Role of Artificial Intelligence in
                                                                Enhancing Student Learning Experience” on The Role of
                                                                Artificial Intelligence in Education organized by
                                                                Rajdhani College, University of Delhi held on 25th-26th
                                                                April 2026.</li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div id="Button4" class="tabcontent">
                                                        ...
                                                        <p class="facpara">
                                                            Prof. Mansi Saxena believes that effective learning happens
                                                            when students can connect classroom concepts with real-world
                                                            experiences. Her teaching approach combines academic rigor
                                                            with practical exposure, creating an engaging and
                                                            interactive learning environment that encourages curiosity,
                                                            participation, and critical thinking.
                                                        </p>

                                                        <p class="facpara">
                                                            She regularly integrates case studies, group discussions,
                                                            role plays, presentations, industry examples, and
                                                            project-based learning into her courses to help students
                                                            understand the practical relevance of management concepts.
                                                            By encouraging students to analyze business situations,
                                                            solve real-world problems, and share diverse perspectives,
                                                            she promotes active learning and deeper conceptual
                                                            understanding.
                                                        </p>

                                                        <p class="facpara">
                                                            To make learning more relevant and impactful, Prof.Mansi
                                                            leverages digital tools, multimedia resources, and
                                                            collaborative platforms that enhance classroom engagement
                                                            and support diverse learning styles. She also encourages
                                                            students to work on contemporary business issues,
                                                            research-based assignments, and industry-oriented projects,
                                                            enabling them to develop analytical, communication, and
                                                            decision-making skills.
                                                        </p>

                                                        <p class="facpara">
                                                            Her learner-centered pedagogy fosters a culture of
                                                            collaboration, creativity, and continuous improvement.
                                                            Through mentoring, constructive feedback, and experiential
                                                            learning opportunities, she motivates students to become
                                                            confident, independent learners who can apply theoretical
                                                            knowledge in professional settings.
                                                        </p>

                                                        <p class="facpara">
                                                            By blending innovative teaching practices with practical
                                                            application, Prof.Mansi Saxena creates a dynamic learning
                                                            experience that not only strengthens academic understanding
                                                            but also prepares students to meet the challenges of today’s
                                                            evolving business environment with confidence, adaptability,
                                                            and professionalism.
                                                        </p>
                                                    </div>
