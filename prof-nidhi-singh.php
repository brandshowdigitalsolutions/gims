...
<head>
    ...
    <title>Prof Nidhi Singh</title>

    <meta name="description" content="Prof Nidhi Singh, a Ph.D. candidate, combines 4 years at KPMG with 4 years in academia. She has published in Scopus journals, edited academic books, and specializes in corporate training and student soft skills development." />
    ...
    <meta property="og:title" content="Professor Nidhi Singh">

    <meta property="og:description" content="Professor Nidhi Singh, a Ph.D. candidate, combines 4 years at KPMG with 4 years in academia. She has published in Scopus journals, edited academic books, and specializes in corporate training and student soft skills development.">
    ...
    <meta name="twitter:title" content="Professor Nidhi Singh">

    <meta name="twitter:description" content="Professor Nidhi Singh, a Ph.D. candidate, combines 4 years at KPMG with 4 years in academia. She has published in Scopus journals, edited academic books, and specializes in corporate training and student soft skills development. ">

    <!-- Open Graph general (Facebook, Pinterest & Google+) -->

    <meta name="og:title" content="Professor Nidhi Singh" />
...
<body class="home_four">
    ...
    <div id="wavescroll">
        ...
        <section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Prof. Nidhi Singh</div>
                ...
                <div class="container custom_container">
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        ...
                        <div class="col-lg-12">
                            ...
                            <h1 class="page-t">Prof. Nidhi Singh</h1>
                                        ...
                                        <div class="facdiv">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <img src="img/faculty/new/prof-nidhi-singh.webp?v=1" alt="Dr. Bhawna Singh" width="100%">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="facpinfo">
                                                        ...
                                                        <p class="facdetail">
                                                            ...
                                                            <span>Name:</span> Prof. Nidhi Singh<br>

                                                            <span>Designation:</span> Assistant Professor<br>

                                                            <span>Area:</span> Human Resource Management<br>

                                                            <span>Email id:</span> <a href="mailto:nidhisingh@gims.net.in">nidhisingh@gims.net.in</a><br>
                                                            ...
                                                            <!-- <a class="linkedinic" href="https://www.linkedin.com/in/dr-bhawna-singh26" target="_blank">
                                                        ...
                                                        <p class="brfprofile">
                                                            ...
                                                            Prof. Nidhi is currently serving as an Assistant Professor at Gniot Institute Of Management Studies, with a strong academic in Labour Laws and Industrial Relations. With over three years of teaching experience at the undergraduate and postgraduate levels, she has demonstrated academic excellence and pedagogical commitment in the areas of HRM, organizational behavior, and Employment legislation.
															<br>
															She has successfully qualified the University Grants Commission’s National Eligibility Test (UGC-NET) three times in Human Resource Management and Labour Laws—a testament to her in-depth subject knowledge and dedication to continuous learning. Her teaching approach integrates theoretical foundations with contemporary industry practices, aiming to develop critical thinking, ethical values, and practical HR skills among students.
															<br>
															Her areas of interest include strategic human resource management, employee relations, labor welfare legislation, and HR analytics. She has also participated in faculty development programs, workshops, and conferences aimed at enhancing academic engagement and interdisciplinary research.
															<br>
															Professor Nidhi is committed to fostering a learning environment that encourages innovation, inclusivity, and professional growth, and aspires to contribute meaningfully to both academia and industry through research, collaboration, and student development.
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <!-- <div class="tab">
                                                        ...
                                                        <button class="tablinks" onclick="openTab(event, 'Button2')">Book Editor</button>
                                                        <button class="tablinks" onclick="openTab(event, 'Button5')">Book Editor</button>
                                                        

                                                        <button class="tablinks" onclick="openTab(event, 'Button3')">Conference</button>

                                                        <button class="tablinks" onclick="openTab(event, 'Button4')">Patents</button>
                                                        <button class="tablinks" onclick="openTab(event, 'Button6')">MDP/FDP</button>
                                                    ...
                                                    <!-- <div id="Button1" class="tabcontent" style="display:block;">
                                                        ...
                                                        <ul class="facul links">
                                                            ...
                                                            <li>Research Paper titled, “Analyzing How AI And Emotional Intelligence Affect Indian IT Professionals' Decision-Making”, EAI SUS-DEV 2023; published in SCOPUS and Google Scholar, Publishing Partner SPRINGER (Doi: 10.4108/eetpht.9.4654).</li>
                                                            <li>Research Paper titled, “From Traditional to Digital: Analyzing New Age Consumer Behaviour in India’s Market Place” published in YMER: Volume 24, Issue 07, July 2025(Peer Reviewed UGC Care Group II Journal).</li>
															<li>· Research Paper published in Seybold Report, Index – SCOPUS& UGC-CARE, paper titled, “The Role of Technology in Enabling Sustainable Business Practices: A Review of Challenges and Opportunities” in Vol. 18, No 03 (2023)</li>
                                                    ...
                                                    <div id="Button2" class="tabcontent">
                                                        ...
                                                        <ul class="facul links">
                                                            ...
                                                            <li>Co-Authored a book titled ‘Next – Gen Digital Marketing, Transformative Intelligence for Immersive Business World”, ISBN 9789349554078, published by Bharat Global Publications in July 2025.</li>
													...
													<div id="Button5" class="tabcontent">
                                                        ...
                                                        <ul class="facul links">
                                                            ...
                                                            <li>Book Chapter published in Edited Book titled “Exploring the Sustainable Business World in the Era of Digital Transformation”, Chapter titled, “Green Marketing: Component of Sustainable Development in new normal."</li> 
															<li>Book Chapter published in the Edited Book titled,” Management Education in the Light of NEP 2020”, Chapter titled “Navigating Uncertainty: Strategies for Restructuring Management Education in the Wake of the Pandemic.” I.S.B.N.: 978-81-958338-6-3.</li>
                                                    ...
                                                    <div id="Button3" class="tabcontent">
                                                        ...
                                                        <ul class="facul links">
                                                            ...
                                                            <li>Presented a paper on the topic “Analyzing How AI And Emotional Intelligence Affect Indian IT Professionals' Decision-Making”, EAI SUS-DEV 2023 – EAI International conference on Innovative Practices for Sustainable Development: Business Management and Analytics, October 13-14, 2023, at NIET, Greater Noida.</li>
                                                            <li>Paper presentation on “Coffee industry in India”. (BHU).</li>
															<li>Paper presentation on “Branding – Strategic Brand Management, Value, Strategy & Equity” (BHU)</li>
                                                    ...
                                                    <div id="Button4" class="tabcontent">
                                                        ...
                                                        <ul class="facul links">
															...
															<li>Granted patent for “Emotion Scanning Apparatus”, Certificate of Registration for a UK Design, Design number: 6305821, Grant date: 05 September 2023, Registration date: 25 August 2023.</li>
															<li>Patent application granted for “An IoT (Internet of Things) Based Business Management Kiosk”, Design number 406938-001, Date of Issue 16th April 2024.</li>
													...
													<div id="Button6" class="tabcontent">
                                                        ...
                                                        <ul class="facul links">
															...
															<li>Participation in the National Faculty Development Program (FDP) on "Case Analysis & Case Writing", held from 22nd to 26th September 2025, organized by Birla Institute of Technology, Noida Campus.</li>
															<li>Participated in FDP on "Indian Knowledge System - Roots, Relevance and Reimagination" - organized by GNIT, GGSIP University New Delhi, July-2025. Duration: 5 days, Mode: Online</li>
															<li>Participated in the Training Program on "NAAC-New Reforms-2024 An Introduction to Binary Accreditation Framework, New Education Policy 2020" - organized by Research Foundation of India, Mar-2025, Duration: 3 days, Mode: Online</li>
															<li>Participated in FDP on "Outcome Based Education and Accreditation" - organized by Department of Computer Science & Engineering, GNIT, GGSIP University New Delhi, Jan 2025. Duration: 5 days, Mode: Online.</li>
															<li>Attended a one-week Faculty Development Program as a resource person on “Advanced Pedagogy in Higher Education” (8th-13th July 2024), at Harlal Institute of Management and Technology (HIMT), Greater Noida.</li>
