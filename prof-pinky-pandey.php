...
<head>
    ...
    <meta property="og:title" content="Dr. Pinky Pandey">
    ...
    <meta name="twitter:title" content="Dr. Pinky Pandey">
    ...
    <meta name="og:title" content="Dr. Pinky Pandey" />
...
<body class="home_four">
    ...
    <div id="wavescroll">
        ...
        <section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Dr. Pinky Pandey</div>
                ...
                <div class="container custom_container">
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        ...
                        <div class="col-lg-12">
                            ...
                            <h1 class="page-t">Dr. Pinky Pandey</h1>
                                        ...
                                        <div class="facdiv">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <img src="img/faculty/prof-pinky-pandey.webp"
                                                        alt="prof-pinky-pandey" width="100%">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="facpinfo">
                                                        ...
                                                        <p class="facdetail">
                                                            ...
                                                            <span>Name:</span> Dr. Pinky Pandey<br>

                                                            <span>Designation:</span> Assistant Professor<br>

                                                            <span>Area: </span>Operations and Business Analytics<br>

                                                            <span>Email id: </span> <a
                                                                href="mailto:pinkypandey@gims.net.in ">
                                                                pinkypandey@gims.net.in </a><br>

                                                            <span>ORCID ID: </span> 0009-0001-5397-6037<br>



                                                            <span>Vidwan ID: </span> 675152<br>

                                                            <a class="linkedinic"
                                                                href="https://www.linkedin.com/in/dr-pinky-pandey-02736172/"
                                                                target="_blank">
                                                        ...
                                                        <p class="brfprofile">
                                                            ...
                                                            Dr. Pinky Pandey is experienced academician with around 7
                                                            years of expertise in Statistics, Operations Management, and
                                                            Business Research Methods. She holds degree of Ph.D in
                                                            Statistics from Amity University, Noida, M.Sc in Statistics
                                                            from Chaudhary Charan Singh University, Meerut, and PGDBM
                                                            from IMT Ghaziabad. She has published research papers in
                                                            different national and international journals and also
                                                            presented her work in different national and international
                                                            conferences.
                                                        </p>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div id="Button1" class="tabcontent" style="display:block;">
                                                        ...
                                                        <ul class="facul">
                                                            ...
                                                            <li>Spatial and Logistic Regression Analysis of Factors
                                                                Influencing Antenatal Care in Uttar Pradesh, India.
                                                                [Working Papers]</li>
                                                            <li>
                                                                A Multilevel Modelling Approach to Predicting Women
                                                                Empowerment in Uttar Pradesh. [Working Papers]
                                                            </li>
                                                        </ul>
                                                        ...
                                                        <ul class="facul">
                                                            ...
                                                            <li>
                                                                Pinky Pandey, Mritunjay Pal Singh, Niraj Kr. Singh,
                                                                Mukesh Kumar (2025).
                                                                “<strong>Family Planning Dynamics in Uttar Pradesh,
                                                                    India: Key Determinants and Trends</strong>”
                                                                in <em>International Journal of Agricultural and
                                                                    Statistical Sciences</em>, Web of Science
                                                                Indexed.
                                                                <br>
                                                                DOI: <a
                                                                    href="https://doi.org/10.59467/IJASS.2025.21.105"
                                                                    target="_blank">https://doi.org/10.59467/IJASS.2025.21.105</a>
                                                            </li>
                                                            <li>
                                                                Pinky Pandey, Sacheendra Shukla, Niraj Kr. Singh,
                                                                Mukesh
                                                                Kumar (2025).
                                                                “<strong>Predicting child mortality determinants in
                                                                    Uttar Pradesh using Machine Learning: Insights
                                                                    from
                                                                    the National Family and Health Survey
                                                                    (2019–21)</strong>”
                                                                in <em>Clinical Epidemiology and Global Health</em>,
                                                                Scopus Indexed. <br>
                                                                DOI: <a
                                                                    href="https://doi.org/10.1016/j.cegh.2025.101949"
                                                                    target="_blank">https://doi.org/10.1016/j.cegh.2025.101949</a>
                                                            </li>
                                                            <li>
                                                                Pinky Pandey, Abhishek Bharti, Niraj Kr. Singh
                                                                (2024).
                                                                “<strong>Spatial Clustering of Infant Mortality in
                                                                    Uttar
                                                                    Pradesh, India</strong>”
                                                                in <em>International Journal of Agricultural and
                                                                    Statistical Sciences</em>, Web of Science
                                                                Indexed.
                                                                <br>
                                                                DOI: <a
                                                                    href="https://doi.org/10.59467/IJASS.2024.20.429"
                                                                    target="_blank">https://doi.org/10.59467/IJASS.2024.20.429</a>
                                                            </li>
                                                        ...
                                                        <ul class="facul">
                                                            ...
                                                            <li>Understanding Child Deaths in Uttar Pradesh Using
                                                                Survival Analysis: A Roadmap for Healthcare Planning
                                                                in
                                                                Uttar Pradesh communicated in Public Health.</li>
                                                            <li>
                                                                Spatial and Logistic Regression Analysis of Factors
                                                                Influencing Antenatal Care in Uttar Pradesh, India
                                                                communicated in Clinical Epidemiology and Global
                                                                Health.
                                                            </li>
                                                    ...
                                                    <div id="Button2" class="tabcontent">
                                                        ...
                                                        <p class="factitle">FDP</p>
                                                        <ul class="facul">
                                                            <li>Participated in 2- days FDP organized in IIM Rohtak on
                                                                “Case Study Writing and Case Method Teaching”</li>
                                                            <li>Participated in 5 days FDP organized by GNIOT Institute
                                                                of Professional Studies on “Empowering Educators with
                                                                Generative AI: Transforming Teaching and Learning”</li>
                                                            <li>Participated in FDP organized by Accurate Institute of
                                                                Management & Technology on “Case Teaching for Management
                                                                Teachers”.</li>
                                                            <li>Participated in FDP held at Indian Institute of
                                                                Management (IIM), Rohtak.</li>
                                                            <li>Participated in 2- days FDP organized in IIM Rohtak on
                                                                “Case Study Writing and Case Method Teaching”</li>
                                                            <li>Participated in 5 days FDP organized by GNIOT Institute
                                                                of Professional Studies on “Empowering Educators with
                                                                Generative AI: Transforming Teaching and Learning”
                                                            </li>
                                                    ...
                                                    <div id="Button3" class="tabcontent">
                                                        ...
                                                        <ul class="facul">
                                                            <li>XXIV Bhopal Seminar 2026, POPULATION DIMENSIONS OF
                                                                SUSTAINABILITY, 2026 Understanding child deaths in Uttar
                                                                Pradesh using survival analysis: a roadmap for
                                                                healthcare planning
                                                            </li>
                                                            <li>
                                                                Paper presented entitled <strong>“Survival analysis on
                                                                    child mortality, Uttar Pradesh”</strong>,
                                                                in the <em>44th Annual Conference</em> organized by IASP
                                                                in collaboration with the Centre of Excellence Public
                                                                Health Nutrition,
                                                                NIT Rourkela, Odisha, <strong>8–10 November
                                                                    2023</strong>.
                                                            </li><br>
                                                            <li>
                                                                Paper presented entitled <strong>“A study on
                                                                    determinants of family planning in Uttar
                                                                    Pradesh”</strong>,
                                                                in the <em>UGC-sponsored two-day National Conference on
                                                                    “Advanced Statistics and Applied Sciences -2022
                                                                    (ASAS 2022)”</em>,
                                                                <strong>30–31 March 2022</strong>.
                                                            </li><br>
                                                            <li>
                                                                Paper presented entitled <strong>“Examining the change
                                                                    in female marital age in Uttar Pradesh”</strong>,
                                                                in the <em>International Conference on “Contextualising
                                                                    Health in Social Sciences: Global and National
                                                                    Perspectives”</em>,
                                                                organized by Sharda School of Humanities and Social
                                                                Sciences in collaboration with IASSH,
                                                                <strong>15–17 March 2023</strong>.
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div id="Button4" class="tabcontent">
                                                        ...
                                                        <p class="facpara">
                                                            Dr. Pinky Pandey adopts innovative teaching methods in
                                                            Operations and Supply Chain Management at GIMS by
                                                            integrating theoretical concepts with experiential,
                                                            analytical, and technology-enabled learning approaches. Her
                                                            pedagogy emphasizes the practical application of management
                                                            concepts through case-based discussions, real-world
                                                            datasets. She extensively incorporates tools such as
                                                            Microsoft Excel and statistical analysis techniques to help
                                                            students understand forecasting, inventory management,
                                                            logistics planning, demand analysis, regression,
                                                            correlation, hypothesis testing, and data-driven
                                                            decision-making.
                                                        </p>

                                                        <p class="facpara">
                                                            To enhance quantitative reasoning and analytical skills, she
                                                            engages students in hands-on exercises involving data
                                                            visualization, trend analysis, time-series forecasting,
                                                            optimization problems, and business analytics applications.
                                                            Students are encouraged to work with real business data to
                                                            interpret patterns, draw meaningful insights, and support
                                                            managerial decisions using statistical evidence. Through
                                                            collaborative learning, problem-solving activities, and
                                                            contemporary case studies on supply chain disruptions and
                                                            operational challenges, she fosters critical thinking,
                                                            analytical rigor, and evidence-based decision-making.
                                                        </p>

                                                        <p class="facpara">
                                                            Her learner-centric approach bridges the gap between theory
                                                            and practice by integrating quantitative techniques with
                                                            managerial applications. By combining experiential learning,
                                                            digital tools, and practical analytics, she creates an
                                                            engaging learning environment that enhances conceptual
                                                            understanding and prepares students to address complex
                                                            business problems with confidence, precision, and a
                                                            data-driven mindset. This innovative teaching methodology
                                                            equips students with the analytical and managerial
                                                            competencies required to succeed in today's dynamic,
                                                            technology-driven, and highly competitive business
                                                            environment.
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div id="Button5" class="tabcontent">
                                                        ...
                                                        <ul class="facul">
                                                            ...
                                                            <li>Patent Title: Interactive Training Kiosk for Green HR
                                                                Training Program, Date of Issue:
                                                                11/12/2025, Patent No. 473226-001
                                                            </li>
                                                        </ul>
                                                    </div>
