...
<head>
    <meta charset="utf-8">
    <title>Prof. Poonam Mahtolia</title>
    <meta name="description" content="Ms. Poonam Mahtolia is a certified HR professional with experience at IBM. She specializes in team engagement and personal development, embracing diversity and inclusion. Currently pursuing certifications in soft skills and NLP, she volunteers as a personality development trainer and event manager with HR SUCCESS TALK." />
    ...
    <!-- Favicon -->
    <link rel="alternate" href="https://www.gims.net.in/prof-poonam-mahtolia.php" hreflang="es-us" />
    <link rel="canonical" href="https://www.gims.net.in/prof-poonam-mahtolia.php"> <!-- Search Engine -->
    <meta name="image" content="https://www.gims.net.in/img/gims-logo.jpg"> <!-- Facebook Open Graph -->
    <meta property="og:type" content="website">
    <meta property="og:title" content="Prof. Poonam Mahtolia">
    <meta property="og:description" content="Ms. Poonam Mahtolia is a certified HR professional with experience at IBM. She specializes in team engagement and personal development, embracing diversity and inclusion. Currently pursuing certifications in soft skills and NLP, she volunteers as a personality development trainer and event manager with HR SUCCESS TALK.">
    <meta property="og:url" content="https://www.gims.net.in/ prof-poonam-mahtolia.php">
    <meta property="fb:app_id" content="573928583391257">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:site" content="@GNIOTCollege">
    <meta name="twitter:title" content="Prof. Poonam Mahtolia">
    <meta name="twitter:description" content="Ms. Poonam Mahtolia is a certified HR professional with experience at IBM. She specializes in team engagement and personal development, embracing diversity and inclusion. Currently pursuing certifications in soft skills and NLP, she volunteers as a personality development trainer and event manager with HR SUCCESS TALK."> <!-- Open Graph general (Facebook, Pinterest & Google+) -->
    <meta name="og:title" content="Prof. Poonam Mahtolia" />
    <meta name="og:url" content="https://www.gims.net.in/prof-poonam-mahtolia.php">
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "https://www.gims.net.in/ prof-poonam-mahtolia.php",
            "sameAs": [
...
<body class="home_four">
    <?php include "top-menu.php"; ?> <div id="wavescroll">
        <section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;"> Prof. Poonam Mahtoliar</div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        <div class="col-lg-12">
                            <ul class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li>Faculty</li>
                                <li>Prof.Poonam Mahtolia </li>
                            </ul>
                        </div>
                        <div class="col-lg-12">
                            <h1 class="page-t">Prof. Poonam Mahtolia </h1>
                                ...
                                <div class="col-lg-9">
                                    <div class="col-lg-12 new-pd9 awardbg2">
                                        <div class="facdiv">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="img/faculty/new/poonam-mahtolia.webp" alt="Prof. Poonam Mahtolia" width="100%">
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="facpinfo">
                                                        <p class="facdetail">
                                                            <span>Name:</span> Prof. Poonam Mahtolia<br>
                                                        ...
                                                        <p class="brfprofile">Ms. Poonam Mahtolia is a globally certified HR Professional with extensive experience in Team Engagement, Personal Development and Communication. She has worked with corporates like IBM India, IBM Canada. A decade of living abroad enriched her understanding of diverse work cultures, enhancing her adaptability and cross-cultural communication skill. <br><br>
                                                            Her exposure to international human resource practices has provided her with a broader perspective on employee engagement and workplace dynamics. By working with teams across various regions, she has gained insights into different leadership styles, collaborative approaches, and cultural sensitivities. These experiences have empowered her to create inclusive learning environments that embrace diversity, making her a well-rounded professional with a global mind-set fostering holistic student growth. <br> <br>
                                                            Ms. Poonam Mahtolia is currently pursuing Certifications in Soft Skills Training and Neuro-Linguistic Programming. She is also volunteering as a Personality Development Trainer with Amrita Devi Foundation, an NGO, and Event Manager with HR SUCCESS TALK.</p>
