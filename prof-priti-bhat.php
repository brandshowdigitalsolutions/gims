...
<head>
    <meta charset="utf-8">
    <title>Prof. Priti Bhat</title>
    <meta name="description" content="A seasoned professional with over 9 years of experience in quality and training, specializing in soft skills for US, UK, and domestic campaigns like Amplifon. Skilled in identifying and implementing improvement plans to enhance communication skills and drive team performance." />
    ...
    <!-- Favicon -->
    <link rel="alternate" href="https://www.gims.net.in/prof-priti-bhat.php" hreflang="es-us" />
    <link rel="canonical" href="https://www.gims.net.in/prof-priti-bhat.php"> <!-- Search Engine -->
    <meta name="image" content="https://www.gims.net.in/img/gims-logo.jpg"> <!-- Facebook Open Graph -->
    <meta property="og:type" content="website">
    <meta property="og:title" content="Prof. Priti Bhat">
    <meta property="og:description" content="
A seasoned professional with over 9 years of experience in quality and training, specializing in soft skills for US, UK, and domestic campaigns like Amplifon. Skilled in identifying and implementing improvement plans to enhance communication skills and drive team performance.">
    <meta property="og:url" content="https://www.gims.net.in/prof-priti-bhat.php">
    <meta property="fb:app_id" content="573928583391257">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:site" content="@GNIOTCollege">
    <meta name="twitter:title" content="Prof. Priti Bhat ">
    <meta name="twitter:description" content="
A seasoned professional with over 9 years of experience in quality and training, specializing in soft skills for US, UK, and domestic campaigns like Amplifon. Skilled in identifying and implementing improvement plans to enhance communication skills and drive team performance."> <!-- Open Graph general (Facebook, Pinterest & Google+) -->
    <meta name="og:title" content="Prof. Priti Bhat" />
    <meta name="og:url" content="https://www.gims.net.in/prof-priti-bhat.php">
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "https://www.gims.net.in/prof-priti-bhat.php",
            "sameAs": [
...
<body class="home_four">
    <?php include "top-menu.php"; ?> <div id="wavescroll">
        <section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;"> Prof. Priti Bhat</div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        <div class="col-lg-12">
                            <ul class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li>Faculty</li>
                                <li>Prof.Priti Bhat</li>
                            </ul>
                        </div>
                        <div class="col-lg-12">
                            <h1 class="page-t">Prof. Priti Bhat</h1>
                                ...
                                <div class="col-lg-9">
                                    <div class="col-lg-12 new-pd9 awardbg2">
                                        <div class="facdiv">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="img/faculty/Prof-Priti-Bhat.webp" alt="Prof. Priti Bhat" width="100%">
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="facpinfo">
                                                        <p class="facdetail">
                                                            <span>Name:</span> Prof. Priti Bhat<br>
                                                            <span>Designation:</span> Assistant Professor<br>
                                                            <span>Area:</span> Learning and Development<br>
                                                            <span>Email id:</span> <a href="mailto:Teamlnd6@gims.net.in">Teamlnd6@gims.net.in</a>
                                                            <!-- <span>ORICID ID: </span>0000-0002-8636-8417<br>
                                                            <span>Vidwan ID: </span> 161563<br> -->
                                                            <!-- <span></span> <a class="linkedinic" href="https://in.linkedin.com/in/ca-sowmya-ram-iyer-82725636" target="_blank"><svg width="80px" height="20px" viewBox="20 0 500 140" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                                                                    <g>
                                                        ...
                                                        <p class="brfprofile">A trained corporate professional with a decade of experience in heading quality and training while working with well reputed organizations like Concentrix, Coforge and British School of Language. Seasoned soft skills and communication trainer with specialization in both US and UK campaigns and also one of the leading domestic campaign by the name of Amplifon, she completed her MBA from Symbiosis in HRM .Her forte lies in project initiation and completion, identifying and implementing plans for the bottom quartile. As a part of Learning and Development at Gims she aims at bringing the students up the learning curve by instilling confidence, removing hesitation and stage fear, converse in clear and concise in English with precise voice modulation and intonation to make an impact and getting the message across during internships interview and GD’s. With hands on experience in developing training material and module, monitor progress and keeping up with new communication trends, tools and teaching methods, she aims at making every student at Gims “ Corporate Ready”</p>
