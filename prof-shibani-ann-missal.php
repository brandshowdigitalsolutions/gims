...
<head>
    <meta charset="utf-8">
    <title>Prof. Shibani Ann Missal</title>
    <meta name="description" content="Prof. Shibani Ann Missal, Assistant Professor at GNIOT Institute of Management Studies, Professional with 24 years of experience in Teaching, R&D, and Marketing. Educated at St. Stephen's College, DU, and trained as a Soft Skills expert for Kingfisher Airlines and Lufthansa." />
    ...
    <!-- Favicon -->
    <link rel="alternate" href="https://www.gims.net.in/prof-shibani-ann-missal.php" hreflang="es-us" />
    <link rel="canonical" href="https://www.gims.net.in/prof-shibani-ann-missal.php">
    <!-- Search Engine -->
    <meta name="image" content="https://www.gims.net.in/img/gims-logo.jpg">
    <!-- Facebook Open Graph -->
    <meta property="og:type" content="website">
    <meta property="og:title" content="Prof. Shibani Ann Missal">
    <meta property="og:description" content="Prof. Shibani Ann Missal, Assistant Professor at GNIOT Institute of Management Studies, Professional with 24 years of experience in Teaching, R&D, and Marketing. Educated at St. Stephen's College, DU, and trained as a Soft Skills expert for Kingfisher Airlines and Lufthansa.">
    <meta property="og:url" content="https://www.gims.net.in/prof-shibani-ann-missal.php">
    <meta property="fb:app_id" content="573928583391257">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:site" content="@GNIOTCollege">
    <meta name="twitter:title" content="Prof. Shibani Ann Missal">
    <meta name="twitter:description" content="Prof. Shibani Ann Missal, Assistant Professor at GNIOT Institute of Management Studies, Professional with 24 years of experience in Teaching, R&D, and Marketing. Educated at St. Stephen's College, DU, and trained as a Soft Skills expert for Kingfisher Airlines and Lufthansa.">
    <!-- Open Graph general (Facebook, Pinterest & Google+) -->
    <meta name="og:title" content="Prof. Shibani Ann Missal" />
    <meta name="og:url" content="https://www.gims.net.in/prof-shibani-ann-missal.php">
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "https://www.gims.net.in/prof-shibani-ann-missal.php",
            "sameAs": [
...
<body class="home_four">
    ...
    <div id="wavescroll">
        <section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Prof. Shibani Ann Missal</div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        <div class="col-lg-12">
                            <ul class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li>Faculty</li>
                                <li>Prof. Shibani Ann Missal</li>
                            </ul>
                        </div>
                        <div class="col-lg-12">
                            <h1 class="page-t">Prof. Shibani Ann Missal</h1>
                                ...
                                <div class="col-lg-9">
                                    <div class="col-lg-12 new-pd9 awardbg2">
                                        <div class="facdiv">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="img/faculty/prof-shibani-ann-missal-1.jpg" alt="Prof. Shibani Ann Missal" width="100%">
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="facpinfo">
                                                        <p class="facdetail">
                                                            <span>Name:</span> Prof. Shibani Ann Missal<br>
                                                            <span>Designation:</span> Assistant Professor<br>
                                                            <!-- <span>Area:</span> Operations<br> -->
                                                            <span>Email id:</span> <a href="mailto:teamlnd4@gims.net.in">  teamlnd4@gims.net.in</a><br>
                                                            ...
                                                            <!-- <span>Vidwan ID:</span> 235157<br>
                                                            <span>ORCID ID:</span> 0000-0003-3786-3398<br>
                                                            <br>
                                                            <span></span> -->
                                                            <a class="linkedinic" href="https://www.linkedin.com/in/shibani-missal-b9812783/" target="_blank">
                                                        ...
                                                        <p class="brfprofile">
                                                            <b>Brief Profile:</b>
                                                            She is a qualified Professional with 24 years of rich, in-depth and extensive experience in Teaching, Research & Development and marketing. Distinction of having gained education from reputed institutes including Mater Dei Convent school.Graduation from St.Stephens College DU .Worked for Kingfisher Airlines and Lufthansa as a Soft Skills trainer. Was associated with Hero Mindmine, NIS and reputed business schools as a Communication and Soft Skills Facilitator.
                                                        </p>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="tab">
                                                    <!-- <button class="tablinks" onclick="openTab(event, 'Button1')">Copyrights</button>
                                                    <button class="tablinks" onclick="openTab(event, 'Button2')">Patents:</button>
                                                       -->
                                                    </div>
                                                    <!-- <div id="Button1" class="tabcontent" style="display:block;">
                                                        <ul class="facul links">
                                                            <li>Titled , “The Impact of Artificial Intelligence and Business Analytics in Diversified Sectors In India” Diary Number : 337/2023-CO/L </li>
                                                            <li>Titled , “Artificial Intelligence & E-Commerce”, Diary Number : 1519/2022-CO/L</li>
                                                            <li>Titled , “An Analysis of Monitoring Attendance and Optimizing time with GPS  Tracking System”, Diary Number: 13121/2022-CO/L</li>
                                                            <li>Titled , “Merger Of Banks: The Humane Factor”, Diary Number : 11733/2021-CO/L</li>
                                                            <li>Titled, “ A Glimpse Of Market Research Industry”, Diary Number : 11734/2021-CO/L</li>
                                                        </ul>
                                                        <br>
                                                    </div> -->
