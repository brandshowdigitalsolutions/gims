...
<head>
    ...
    <title>Faculty Profile of Prof. Silky Gaur | Top Management Colleges in Greater Noida</title>
	<meta name="description" content="Faculty Profile of Prof. Silky Gaur - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
							...
							<div class="row">
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<p class="pgdmtext">
											<img src="img/faculty/silky-gaur.jpg" class="msgs" alt="Prof. Silky Gaur" />
											Ms. Silky Gaur is an Assistant Professor with over 7 years of experience specializing in marketing, consumer behavior and communication studies. She is pursuing her Ph.D. from Amity University, Noida in e-service quality in ecommerce. Along with a passion for teaching, she has organized curricular and co-curricular programs and also compéred in numerous programs. Her current research project includes analysis of service quality in e grocery apps in India.
											<br/>
											<br/>
											<strong>
												Prof. Silky Gaur<br/>Assistant Professor/Marketing
											</strong>
										</p>
									</div>
								</div>
