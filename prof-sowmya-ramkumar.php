...
<html lang="en"><head>
    <meta charset="utf-8">
    <title>Prof.Sowmya Ramkumar</title>
    <meta name="description" content="
Sowmya Ramkumar is a Soft Skills Trainer with 19 years of experience, having trained over 5,000 professionals. She is a TESOL-certified coach and an Iconic Woman 2021 awardee." />
    ...
    <!-- Favicon -->    <link rel="alternate" href="https://www.gims.net.in/ dr-nishant.php" hreflang="es-us" />
    <link rel="canonical" href="https://www.gims.net.in/ dr-nishant.php">    <!-- Search Engine -->
    <meta name="image" content="https://www.gims.net.in/img/gims-logo.jpg">    <!-- Facebook Open Graph -->
    <meta property="og:type" content="website">
    <meta property="og:title" content="Prof. Sowmya Ramkumar ">
...
Sowmya Ramkumar is a Soft Skills Trainer with 19 years of experience, having trained over 5,000 professionals. She is a TESOL-certified coach and an Iconic Woman 2021 awardee.">
    ...
    <meta name="twitter:title" content="Prof. Sowmya Ramkumar ">
    <meta name="twitter:description" content="
Sowmya Ramkumar is a Soft Skills Trainer with 19 years of experience, having trained over 5,000 professionals. She is a TESOL-certified coach and an Iconic Woman 2021 awardee.">    <!-- Open Graph general (Facebook, Pinterest & Google+) -->
    <meta name="og:title" content="Prof. Sowmya Ramkumar" />
    ...
    <?php include "top-menu.php"; ?>    <div id="wavescroll">        <section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;"> Prof.Sowmya Ramkumar</div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        <div class="col-lg-12">
                            <ul class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li>Faculty</li>
                                <li>Prof. Sowmya Ramkumar</li>
                            </ul>
                        </div>
                        <div class="col-lg-12">
                            <h1 class="page-t">Prof. Sowmya Ramkumar </h1>
                                ...
                                <div class="col-lg-9">
                                    <div class="col-lg-12 new-pd9 awardbg2">
                                        <div class="facdiv">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img src="img/faculty/new/prof-sowmya-ramkumar.webp" alt="Prof. Sowmya Ramkumar " width="100%">
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="facpinfo">
                                                        <p class="facdetail">
                                                            <span>Name:</span> Prof. Sowmya Ramkumar<br>
                                                            <span>Designation:</span> Director L&D<br>
                                                            <span>Area:</span> Learning & Development <br>
                                                            <span>Email id:</span> <a href="mailto:sowmya@gims.net.in">sowmya@gims.net.in</a> <br>
                                                        ...
                                                        <p class="brfprofile">Sowmya Ramkumar is a distinguished Soft Skills Trainer with 19 years of global experience, blending Chartered Accountant expertise with exceptional interpersonal skills. Renowned for delivering high-impact workshops, she has trained over 5,000 professionals worldwide, enhancing communication, leadership, and team dynamics. Sowmya’s tailored training solutions have significantly improved organizational culture and employee engagement. Recognized as the Iconic Woman 2021 for her contributions in the field of skills development by the Indian Women’s Foundation and a Guinness awardee in 2023, she is also an Ambassador of English by Cesaro Edigo Serrano, Spain. Her comprehensive background spans corporate coaching, curriculum development, and mentoring, making her a leader in Learning & Development. She is also a member of the Institute of Chartered Accountants of India for the past 2 decades. She is a TESOL (global) certified English language coach and an ALLISON USA certified POSH facilitator too. </p>
