...
<head>
    ...
    <title>Prof. Sudhanshu Kumar</title>

    <meta name="description" content="Prof. Sudhanshu Kumar, with over 30 years of industry experience at leading MNCs like Coca-Cola and PepsiCo, joins GIMS, Greater Noida as Assistant Professor in Supply Chain. He specializes in procurement, supply chain digitization, and ERP implementation, and is pursuing a PhD in Supply Chain Management. " />
    ...
    <link rel="alternate" href="https://www.gims.net.in/prof-sudhanshu-kumar.php" hreflang="es-us" />

    <link rel="canonical" href="https://www.gims.net.in/prof-sudhanshu-kumar.php">
    ...
    <meta property="og:title" content="Prof. Sudhanshu Kumar">

    <meta property="og:description" content="Prof. Sudhanshu Kumar, with over 30 years of industry experience at leading MNCs like Coca-Cola and PepsiCo, joins GIMS, Greater Noida as Assistant Professor in Supply Chain. He specializes in procurement, supply chain digitization, and ERP implementation, and is pursuing a PhD in Supply Chain Management. ">

    <meta property="og:url" content="https://www.gims.net.in/prof-sudhanshu-kumar.php">
    ...
    <meta name="twitter:title" content="Prof. Sudhanshu Kumar">

    <meta name="twitter:description" content="Prof. Sudhanshu Kumar, with over 30 years of industry experience at leading MNCs like Coca-Cola and PepsiCo, joins GIMS, Greater Noida as Assistant Professor in Supply Chain. He specializes in procurement, supply chain digitization, and ERP implementation, and is pursuing a PhD in Supply Chain Management. ">

    <!-- Open Graph general (Facebook, Pinterest & Google+) -->

    <meta name="og:title" content="Prof. Sudhanshu Kumar" />

    <meta name="og:url" content="https://www.gims.net.in/prof-sudhanshu-kumar.php">
    ...
    <script type="application/ld+json">

        {
            ...
            "url": "https://www.gims.net.in/prof-sudhanshu-kumar.php",
...
<body class="home_four">
    ...
    <div id="wavescroll">
        ...
        <section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Prof. Sudhanshu kumar</div>
                ...
                <div class="container custom_container">
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        ...
                        <div class="col-lg-12">
                            ...
                            <h1 class="page-t">Prof. Sudhanshu Kumar</h1>
                                        ...
                                        <div class="facdiv">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <img src="img/faculty/prof-sudhanshu-kumar.webp" alt="Prof. Sudhanshu Kumar" width="100%">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="facpinfo">
                                                        ...
                                                        <p class="facdetail">
                                                            ...
                                                            <span>Name:</span> Prof. Sudhanshu Kumar<br>

                                                            <span>Designation:</span>  Professor of Practice<br>

                                                            <span>Area:</span> Chair-International Business<br>

                                                            <span>Email id:</span> <a href="mailto:sudhanshu@gims.net.in">sudhanshu@gims.net.in</a><br>

                                                            <!-- <span>Web of Science ResearcherID:</span> JKI-7013-2023<br>

                                                            <span>Researchgate ID:</span> <a href="https://www.researchgate.net/profile/Charul-Sharma-5" target="_blank" rel="nofollow"> Charul-Sharma-5</a><br>

                                                            <span>Vidwan ID:</span>  450638<br>

                                                            <span>ORICID ID:</span> 0009-0003-3480-033X<br>

                                                            <br>

                                                            <span></span> -->

                                                            <a class="linkedinic" href="https://www.linkedin.com/in/sudhanshu-kumar-4051931b/" target="_blank">
                                                        ...
                                                        <p class="brfprofile">
                                                            ...
                                                            Prof. Sudhanshu Kumar has been elevated as Professor of Practice and Area Chair-IB w.e.f. from Jan'25. He joined GIMS, Greater Noida as an Asst Professor (Supply Chain) in Jul'24. He is having a rich Industry Experience of more than 30 years in various capacities in leading MNCs (Coca-Cola, PepsiCo-Frito Lays & GSK) and Indian Business Houses (Dabur, Emami, Radico Khaitan etc). He has been associated with some of the Leading Organisation as Consultant/Trainer as well – Merino Industries, Truepower, Cold Roll Ice Cream, Rollick Ice Cream, TAPMI, NIU, Careerera (SNVA Technologies) etc. During his Career journey, he has worked in various domain of Procurement & Supply Chain function e.g. Setting-up Systems & Process in Green Field Projects, Driving Digitization, S&Op Process, New Product Development, Spearheading CFTs, Finalising ERP’s Implementation Partner, SAP Roll Out @ PAN India Level (MM Module), Material Resource Planning, Production Planning, Inbound & Outbound Supply Chain, Procurement, Vendor Development, Inventory Management, Identification, Onboarding and Managing 3P Facilities for e-Commerce Business, Stores, Warehousing, Cold Chain Operation, Team Management etc. He is currently pursuing PhD in Supply Chain Management from Noida International University. He has done PG Diploma in Supply Chain Management from IMT Ghaziabad, Diploma In Materials Management from IERT Allahabad and Graduation from Allahabad University.
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="tab">
                                                        ...
                                                        <button class="tablinks" onclick="openTab(event, 'Button3')">FDP/Workshops</button>

                                                        

                                                        <button class="tablinks" onclick="openTab(event, 'Button4')">Others</button>
                                                    ...
                                                    <div id="Button1" class="tabcontent" style="display:block;">
                                                        ...
                                                        <ul class="facul links">
                                                            ...
                                                            <li>Som, B. K.,Daipuria, P.,Sharma, C.,(2023).Effectiveness of Organizational Justice on Workplace Deviance, with Job Satisfaction as a Mediating Driver Among Nurses and Healthcare Workers -A</li>

                                                            <li>Sensitive Analysis, Journal of Informatics Education and Research, 3(2).</li>
                                                    ...
                                                    <div id="Button2" class="tabcontent">
                                                        ...
                                                        <li>Presented a paper titled-”Effectiveness of organizational justice on workplace deviance, with job satisfaction as a mediating driver among nurses and healthcare workers in Delhi-NCR” in the International HR Conference cum Conclave-2023 ( IHRCC ’23 ) under the theme: “HR IN DYNAMIC BUSINESS ENVIRONMENT,” organized by Indian Institute of Management Jammu, on 14th -15th October 2023 at the Indian Institute of Management Jammu.</li>

                                                        <li>Presenting a paper titled - “ UnderstandingYouth Attitudes Towards Diversity,Equity and Inclusion : A comparative Analysis “in the International ICAMP 2023  Conference under theme of -TECHNOLOGY,,INNOVATION,and Sustainability  In Management organized by JIMS,ROHINI.</li>
                                                    ...
                                                    <div id="Button3" class="tabcontent">
                                                        ...
                                                        <ul class="facul links">
                                                            ...
                                                            <li>Attended Five day Faculty Development Programme on “Scale Development and Data Analysis Using Smart  PLS - 4” organized by Koach Scholar from 25 -29 October, 2023.</li>

                                                            <li>Attending Six day Faculty Development Programme on “ Time Series Analysis Using R” organized by Delhi Institute of Advanced Studies (DIAS) on 25th November to 30 November 2023.</li>

                                                            <li>Attended two-day Pre-conference workshops on "Qualitative and Quantitative Research Methodologies and Publication" at the Indian Institute of Management Jammu on 12th-13th October 2023.</li>

                                                        </ul>

                                                        <p class="factitle">Working paper :</p>

                                                        <ul class="facul links">

                                                            <li>1.	Working on - Impact of Local Language on Quality of Education and Employment." with IISC- Bangalore</li>

                                                            <li>2.	WORKING CONCEPTUAL PAPER TITLE- " ROLE OF EMOTIONAL INTELLIGENCE ON DIVERSITY, EQUITY AND INCLUSION"</li>
                                                    ...
                                                    <div id="Button4" class="tabcontent">
                                                        ...
                                                        <ul class="facul links">
                                                            ...
                                                            <li>PROJECT WITH PHD Chamber of Commerce and Industry - TITLED -"YOUTH PERCEPTION SURVEY ABOUT INDIA AND THE WORLD POST COVID-19" </li>

                                                            <li>EVENT COORDINATION - "Hosted and coordinated research talk series lectures by a professor at Jamia Millia Islamia University (former Secretary-General, AIU)."</li>

                                                            <li>IRIS  AWARD" for recruiting the highest number of employees in a week at JBM GROUP </li>

                                                            <li>BEST TEACHING AWARD" - FILO "CERTIFICATE OF EXCELLENCE" - FOR OUTSTANDING PERFORMANCE CONSECUTIVE 6 MONTHS.</li>

                                                            <li>WEBINAR- Success Factors for the Use of Simulation Games in Higher Education Curriculum organized by - Shri Vaishnav Vidyapeeth Vishwavidyalaya, Indore</li>
