...
<head>
    <meta charset="utf-8">
    <title>Dr. Zia Zehra Zaidi</title>
    <meta name="description" content="An Assistant Professor at GNIOT Institute of Management and Technology, Best Academician Award at Influential Indian Awards 2021" />
    ...
    <!-- Favicon -->
    <link rel="alternate" href="https://www.gims.net.in/dr-zia-zehra-zaidi.php" hreflang="es-us" />
    <link rel="canonical" href="https://www.gims.net.in/dr-zia-zehra-zaidi.php">
    <!-- Search Engine -->
    <meta name="image" content="https://www.gims.net.in/img/gims-logo.jpg">
    <!-- Facebook Open Graph -->
    <meta property="og:type" content="website">
    <meta property="og:title" content="Dr. Zia Zehra Zaidi">
    <meta property="og:description" content="An Assistant Professor at GNIOT Institute of Management and Technology, Best Academician Award at Influential Indian Awards 2021 ">
    <meta property="og:url" content="https://www.gims.net.in/dr-zia-zehra-zaidi.php">
    <meta property="fb:app_id" content="573928583391257">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:site" content="@GNIOTCollege">
    <meta name="twitter:title" content="dr-zia-zehra-zaidi">
    <meta name="twitter:description" content="An Assistant Professor at GNIOT Institute of Management and Technology, Best Academician Award at Influential Indian Awards 2021 ">
    <!-- Open Graph general (Facebook, Pinterest & Google+) -->
    <meta name="og:title" content="Dr. Zia Zehra Zaidi" />
    <meta name="og:url" content="https://www.gims.net.in/dr-zia-zehra-zaidi.php">
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "https://www.gims.net.in/dr-zia-zehra-zaidi.php",
            "sameAs": [
...
<body class="home_four">
    ...
    <div id="wavescroll">
        <section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Dr. Zia Zehra Zaidi</div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
                        <div class="col-lg-12">
                            <ul class="breadcrumb">
                                <li><a href="#">Home</a></li>
                                <li>Faculty</li>
                                <li>Dr. Zia Zehra Zaidi</li>
                            </ul>
                        </div>
                        <div class="col-lg-12">
                            <h1 class="page-t">Dr. Zia Zehra Zaidi</h1>
                                ...
                                <div class="col-lg-9">
                                    <div class="col-lg-12 new-pd9 awardbg2">
                                        <div class="facdiv">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <!-- <img src="img/faculty/new/dr-zia-zehra-1.jpg" alt="Dr. Zia Zehra Zaidi" width="100%"> -->
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="facpinfo">
                                                        <p class="facdetail">
                                                            ...
                                                            <span>Area:</span> Communication and General Management/Marketing<br>
                                                            <span>Email id:</span> <a href="mailto:ziazaidi.gims@gims.net.in">ziazaidi.gims@gims.net.in</a><br>
                                                            <span>Vidwan ID:</span> 552364<br>
                                                            <span>ORCID ID:</span> 0009-0006-9466-4327<br>
                                                            <br>
                                                            <span></span>
                                                            <a class="linkedinic" href="https://www.linkedin.com/in/dr-zia-zehra-zaidi-05250210/" target="_blank">
                                                        ...
                                                        <p class="brfprofile">
                                                            <b>Brief Profile:</b>
                                                            A qualified Professional (Ph.D. in Management) with 14 years of rich, in depth and extensive experience in Teaching, Research & Development and administration in the reputed Educational Institutions, Dr. Zia Zehra Zaidi is currently working as an Assistant Professor (Business Communication) at GIMS, Greater Noida. As an academician, she has received Women of Excellence 2023 (Education) Award organised by Crazy Tales, Best Academician Award at Influential Indian Awards 2021, Most Dynamic Personality Award at Powerful Women Awards 2021, Best Guru Award Female at GERA from Miss India Universe, 2019. She has published a patent on Artificial Intelligence-Driven Supply Chain Management System with an application no-202311018915. She has been appointed as a fellow member of International Institute of Organised Research (I2OR) registered with Ministry of MSME, Government of India. Dr. Zaidi's research includes papers in national and international journals.
                                                        </p>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="tab">
                                                        ...
                                                        <button class="tablinks" onclick="openTab(event, 'Button2')">FDP's</button>
                                                        <button class="tablinks" onclick="openTab(event, 'Button3')">Conferences</button>
                                                    </div>
  
                                                    <div id="Button1" class="tabcontent" style="display:block;">
                                                        <ul class="facul links disc-out">
                                                            <li>Paper published entitled “Marketing strategies for Socially Responsible products- Company Brand name and market scenario: An Industry Cross-Sectional Study." in LBS Journal Of Management & Research (Online ISSN 0974 -1852; Print 0972- 8031) (Volume XIV,No.1,January-June,2016).</li>
                                                            <li>Paper published entitled “Marketing strategies for Socially Responsible products and Brand name of the company: An Impact Assessment Study Across Industry Verticles" in International Journal Of Emerging Research in Management and Technology (ISSN 2278-9359) (Volume-6,Issue-1,January 2017).</li>
                                                            <li>Paper published entitled “B-Schools: Roadmap For Excellence" in International Journal Of Science, Technology and Management (ISSN 2394-1537) (Vol.No.5,Issue No.06,June 2016).</li>
                                                            <li>Paper published entitled “Marketing strategies for Socially Responsible products and Brand name of the company: A Cross-Industry Study" in The International Journal Research Publication's Research Journal of Social Science & Management (ISSN 2251- 1571) (Vol-6, No 10 (2017): 01 February 2017).</li>
                                                        </ul>
                                                        <br>
                                                    </div>
                                                    <div id="Button2" class="tabcontent">
                                                        ...
                                                        <ul class="facul links disc-out">
                                                        <li>8 days FDP on ‘Universal Human Values and Professional Ethics’ organized by TEQIP-III and Value Education Cell ,AKTU Lucknow at KIET, Ghaziabad from 26 Dec 2019 to 2 Jan 2020.</li>
                                                        <li>8 days FDP for Student Induction (FDP-SI) organised by AICTE from 6th to 13th April,2022 at AKGEC, Ghaziabad.</li>
                                                        <li>1 week International Faculty Development Program on Digital Learning with Multidisciplinary Approaches (DLMA) held from 12-17 June,2020 conducted at JSS Academy of Technical Education ,Noida.</li>
                                                        </ul>
                                                    </div>
                                                    <div id="Button3" class="tabcontent ">
                                                        <ul class="facul links disc-out">
                                                            <li>Attended National Conference held at Llyod Institute of Management and Technology on 10th May, 2014.</li>
                                                            <li>Attended National Seminar on Changing Dynamics of International Business Environment:-Issues and Opportunities for India held on Nov 29,2014 at Gitarattan International Business School.</li>
                                                            <li>Attended 2 day ISTE Workshop on Aakash for Education conducted by IIT,Bombay on 10th & 11th Nov, 2012 held under National Mission on Education through ICT(MHRD).</li>
                                                            <li>Attended International Management Research Conference on Mindset, Gender and strategy at Faculty of Management Studies, Amity University, U.P., Noida. </li>
                                                            <li>Participated in International Level Online Panel discussion on "Leading the way forward in Unprecedented Times:With A Special Reference To The Global Market and Economy", on 6th July 2020 ,organised by CMS,JAIN,Bengaluru.</li>
                                                            <li>Attended a Webinar on "Intellectual Property Rights and Patents" on 16th June 2020, organised by Vaageswari College of Engineering, Karimnagar, Telangana.</li>
                                                            <li>Participated in Online Panel discussion on "Reimagining Pandemic: WOMEN in management & Challenges", on 30.5.2020 ,organised by KCG College of Technology.</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
