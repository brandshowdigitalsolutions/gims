...
<head>
    ...
    <title>Prabodhan Talk Series</title>
	<meta name="description" content="Prabodhan Talk Series - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Prabodhan Talk Series</div>
                    ...
                    <div class="row align-items-center new-pd4 zoomanimate">
						<div class="col-lg-12">
							<ul class="breadcrumb">
							  ...
							  <li>Prabodhan Talk Series</li>
							</ul>
						</div>
						<div class="col-lg-12">
							<h1 class="page-t">Prabodhan Talk Series</h1>
							...
							<div class="row">
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <img src="img/crc/pts1.jpg" alt="">
                                            </div>
                                            <div class="col-md-6">
                                                <img src="img/crc/pts2.jpg" alt="">
                                            </div>
                                            <div class="col-md-6">
                                                <img src="img/crc/pts3.jpg" alt="">
                                            </div>
                                            <div class="col-md-6">
                                                <img src="img/crc/pts4.jpg" alt="">
                                            </div>
