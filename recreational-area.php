...
<head>
    ...
    <title>Recreational Area | Top Management Colleges in Greater Noida</title>
	<meta name="description" content="Recreational Area - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Recreational Area</div>
            ...
            <div class="intro">
                <div class="container custom_container">
                    <div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							<h1 class="page-t">Recreational Area</h1>
								...
								<div class="col-lg-9">
									<div class="col-lg-12 new-pd9 awardbg2">
										<div class="placement-process">
                                            <p class="new-text">
                                                The sprawling lawn and the playground equipped with the outdoor games facilities like Basket-Ball, Cricket and Football and the cafeteria are the best hang-outs for these millennials to chill out and relax, rejuvenate themselves after a hectic day and recharge their soul, body and mind for the next happening day. GIMS also provides various indoor games facilities also like Table-tennis, Carrom-board, Chess and Badminton and the like. GIMS has a dedicated Sports Club- Spardhaa which organizes various inter and intra collegiate championships. The latest was YuvSpandan- which was the interjection of industry and academia to play and learn together.   
                                            </p>
                                        ...
                                        <div class="gallery-box">
                                            <div class="row">
                                                <div class="col-md-4 popup-box">
                                                    <a class="example-image-link" href="img/recreational-area/1.jpg" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/recreational-area/1.jpg" alt="Recreational Area"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-4 popup-box">
                                                    <a class="example-image-link" href="img/recreational-area/2.jpg" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/recreational-area/2.jpg" alt="Recreational Area"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-4 popup-box">
                                                    <a class="example-image-link" href="img/recreational-area/3.jpg" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/recreational-area/3.jpg" alt="Recreational Area"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-4 popup-box">
                                                    <a class="example-image-link" href="img/recreational-area/4.jpg" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/recreational-area/4.jpg" alt="Recreational Area"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-4 popup-box">
                                                    <a class="example-image-link" href="img/recreational-area/5.jpg" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/recreational-area/5.jpg" alt="Recreational Area"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-4 popup-box">
                                                    <a class="example-image-link" href="img/recreational-area/6.jpg" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/recreational-area/6.jpg" alt="Recreational Area"/>
                                                    </a>
                                                </div>
                                                <div class="col-md-4 popup-box">
                                                    <a class="example-image-link" href="img/recreational-area/7.jpg" data-lightbox="example-set" >
                                                        <img class="example-image" src="img/recreational-area/7.jpg" alt="Recreational Area"/>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
