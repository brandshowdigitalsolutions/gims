...
<head>
    ...
    <title>Research Council  | Top PGDM Institute | GIMS</title>
	<meta name="description" content="Research Council  - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India."/>
...
<body class="home_four">
    ...
    <div id="wavescroll">
		...
		<section class="section wave_two_section_two">
            ...
            <div class="text" style="font-size:34px;">Research Council </div>
            ...
            <div class="intro">
                <div class="container custom_container">
                    <div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							<h1 class="page-t">Research Council </h1>
							<h3 class="sub-t">Best PGDM Institute - Greater Noida</h3>
						</div>
									...
									<div class="col-lg-12 new-pd9 awardbg2">
										<table class="tablegims">
											...
											<tbody>
												<tr>
													<td>1</td>
													<td>Dr. Shikha Bhardwaj</td>
													<td>Assistant Professor, IIM, Sambalpur</td>
												</tr>
												<tr>
                                                    <td>2</td>
													<td>Dr. Prabhat Mittal</td>
													<td>Professor, Satyavarti College, University of Delhi </td>
												</tr>
                                                <tr>
                                                    <td>3</td>
													<td>Dr. Chirag Malik</td>
													<td>Associate Professor, Indian School of Hospitality </td>
												</tr>
                                                <tr>
                                                    <td>4</td>
													<td>Mr. Deepak Kumar</td>
													<td>GM-Analytics,CLICFLYER</td>
												</tr>
                                                <tr>
                                                    <td>5</td>
													<td>Dr. Samik Shome</td>
													<td>Associate Professor- Eco, Nirma University </td>
												</tr>
											</tbody>
										</table>
									</div>
