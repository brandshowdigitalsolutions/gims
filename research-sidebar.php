...
<div class="col-lg-12 awardbg2 sticky">
	<div class="datedivimp">
		<h3 class="sidebartt"><strong>Important Dates :</strong></h3>
		<p class="dateimp">
			<span class="datetitle">Abstract & Full Paper Submission</span>
			<span class="dateinfo"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calendar"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg> 20th December, 2023</span>
		</p>
		<p class="dateimp">
			<span class="datetitle">Notification For Paper Acceptance</span>
			<span class="dateinfo"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calendar"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg> 10th January, 2024</span>
		</p>
		<p class="dateimp">
			<span class="datetitle">Last Date of Registration</span>
			<span class="dateinfo"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calendar"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg> 12th January, 2024</span>
		</p>
		<p class="dateimp">
			<span class="datetitle">Review Time</span>
			<span class="dateinfo"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calendar"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg> 30th January, 2024</span>
		</p>
		<p class="researchbrochlinkTitle">Download Brochure</p>
		<a class="researchbrochlink" target="_blank" href="pdf/international-conference-2024.pdf">
		    <img src="img/download-brochure.jpg" alt="download-brochure.jpg"/>
		</a>
	</div>
