...
<head>
	...
	<title>Corporate Mentor - Mrs. Shaweta Berry | Top Management Colleges in Greater Noida</title>

	<meta name="description"

		content="Corporate Mentor - Mrs. Shaweta Berry  - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India." />
...
<body class="home_four">
	...
	<div id="wavescroll">
		...
		<section class="section wave_two_section_two">
			...
			<div class="text" style="font-size:34px;">Corporate Mentor - Mrs. Shaweta Berry </div>
					...
					<div class="row align-items-center new-pd4 zoomanimate">
						...
						<div class="col-lg-12">
							...
							<ul class="breadcrumb">
								...
								<li>Corporate Mentor - Ms. Shaweta Berry </li>
						...
						<div class="col-lg-12">
							...
							<h3 class="sub-t">Ms. Shaweta Berry</h3>
								...
								<div class="col-lg-9">
									...
									<div class="col-lg-12 new-pd9 awardbg2">
										...
										<p class="pgdmtext">
											...
											<img src="img/banner/shweta.webp" class="msgs"

												alt="shweta" />

											<span

												style=" font-size: 60px; float: left; line-height: 51px; margin-right: 6px; font-family: auto; ">D</span>

											<b>ear Budding Managers,</b>

											<br>

											As your corporate mentor, I am thrilled to embark on this journey with you.

											This is an exciting time in your careers, and I’m here to help you navigate

											the complexities of the professional world. My goal is to share my

											experiences, provide guidance, and support your growth as you develop your

											technical and leadership skills. Feel free to reach out with any questions

											or challenges your encounter. Together, we can identify new opportunities,

											turn them into meaningful advancements, and set a strong foundation for your

											future successes. Let’s make this experience both rewarding and
											...
											<strong>Mahanadaya Universal Consultancy Private Limited</strong>
