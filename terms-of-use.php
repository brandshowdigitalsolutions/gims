...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Terms of Use | Top Management Colleges in Greater Noida</title>
        <meta name="description" content="Terms of Use - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India." />
        ...
        <!-- Favicon -->
        <link rel="alternate" href="https://www.gims.net.in/terms-of-use.php" hreflang="es-us" />
        <link rel="canonical" href="https://www.gims.net.in/terms-of-use.php" />
        <!-- Search Engine -->
        <meta name="image" content="https://www.gims.net.in/img/gims-logo.jpg" />
        <!-- Facebook Open Graph -->
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Terms of Use | Top Management Colleges in Greater Noida" />
        <meta property="og:description" content="Terms of Use - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India." />
        <meta property="og:url" content="https://www.gims.net.in/terms-of-use.php" />
        <meta property="fb:app_id" content="573928583391257" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:site" content="@gims_net_in" />
        <meta name="twitter:title" content="Terms of Use | Top Management Colleges in Greater Noida" />
        <meta name="twitter:description" content="Terms of Use - GNIOT Institute of Management Studies One of The Best PGDM Campus and Top College for PGDM provides Best PGDM private Colleges in Delhi, India." />
        <!-- Open Graph general (Facebook, Pinterest & Google+) -->
        <meta name="og:title" content="Terms of Use | Top Management Colleges in Greater Noida" />
        <meta name="og:url" content="https://www.gims.net.in/terms-of-use.php" />
    ...
    <body class="home_four">
        ...
        <div id="wavescroll">
            <section class="section wave_two_section_two">
                ...
                <div class="text" style="font-size: 34px;">Terms of Use</div>
                ...
                <div class="intro">
                    <div class="container custom_container">
                        <div class="row align-items-center new-pd4 zoomanimate">
                            ...
                            <div class="col-lg-12">
                                <h1 class="page-t">Terms of Use</h1>
                                ...
                                <div class="row">
                                    <div class="col-lg-9">
                                        <div class="col-lg-12 new-pd9 awardbg2">
                                            <p class="pgdmtext">
                                                Welcome to <strong>GIMS (Greater Noida Institute of Management Studies)</strong>. 
                                                By accessing and using our website <a href="https://www.gims.net.in">www.gims.net.in</a>, 
                                                ...
                                                By using our website, you acknowledge that you have read, understood, and agree to be legally bound by these Terms of Use, along with our Privacy Policy.
                                                <br><br>
                                                ...
                                                All content, logos, text, graphics, images, and materials on this website are the intellectual property of GIMS unless otherwise stated. 
                                                Unauthorized copying, reproduction, or distribution is strictly prohibited.
                                                <br><br>

                                                <strong>4. Accuracy of Information</strong><br>
                                                While we strive to keep the information on our website accurate and up to date, GIMS makes no warranties or representations regarding the completeness, reliability, or accuracy of the content.
                                                <br><br>

                                                <strong>5. Limitation of Liability</strong><br>
                                                GIMS shall not be held liable for any direct, indirect, incidental, or consequential damages arising from the use of or inability to use our website.
                                                <br><br>
                                                ...
                                                Users must not upload, post, or transmit any content that is harmful, offensive, defamatory, or violates any applicable laws.
                                                <br><br>

                                                <strong>8. Changes to Terms</strong><br>
                                                GIMS reserves the right to update or modify these Terms of Use at any time. 
                                                Continued use of the website after changes are posted will be deemed as acceptance of the revised terms.
                                                <br><br>
                                                ...
                                                Any disputes shall be subject to the jurisdiction of the courts in Greater Noida, Uttar Pradesh.
                                                <br><br>

                                                <strong>10. Contact Us</strong><br>
                                                For any queries regarding these Terms of Use, please contact us at:<br>
