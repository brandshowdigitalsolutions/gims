...
#gdpiImg {
 ...
 <button data-toggle="modal" class="btn-admition" data-target="#myModalR4"><a href="upcoming-gd.php" style="
    color: white;">GD/PI session</a></button>
...
<img src="https://www.gims.net.in/img/admisson.jpeg" alt="GD-PI session">
			</div>
		</div>
	</div>
</div> -->
...
<div class="msc">
	<div>
		<marquee style="margin-left: 130px;" width="80%" onmouseover="this.stop();" onmouseout="this.start();"  direction="right" scrollamount="5" loop="infinite" ><span style="margin-left: 350px">Admission Open for PGDM Session 2025 Intake</span></marquee>
	</div>
    		...
    		<div class="shortmenu">
    			<ul>
					...
					<li class="expandlin">
                                    ...
                                    <div class="expandmenu">
                                        <div class="listul">
                                            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right"><path d="m9 18 6-6-6-6"/></svg> SCM Dept. Newsletter</a>
                                            
                                        </div>
                                    </div>
                                    <div class="expandmenu">
                                        <div class="listul">
                                            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right"><path d="m9 18 6-6-6-6"/></svg> Marketing Dept.Newsletter</a>
                                    ...
                                    <div class="expandmenu">
                                        <div class="listul">
                                            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right"><path d="m9 18 6-6-6-6"/></svg> BA Dept.Newsletter.</a>                                            
                                        </div>
                                    </div>
                                </li>
    			</ul>
							...
							<div class="col-md-6 pr-3">
								<div  class="right_mega_menu">
									<ul>
										...
										<li><a href="../head-pgp.php"><i class="icon-line-speech-bubble"></i> Executive Director</a></li>
									...
									<div class="col-md-6">
										<div class="bullet_menu">
											<ul>
												...
												<li><a href="https://www.gims.net.in/head-pgp.php"><i class="icon-user2"></i> Executive Director</a></li>
												...
												<li><a href="https://www.gims.net.in/course-structure-2023-25.php">Course structure and curriculum</a></li>
												<li><a href="https://www.gims.net.in/foreign-national-courses.php">Foreign National Courses</a></li>
												<li><a href="https://www.gims.net.in/working-professional-courses.php">Working Professional Courses</a></li>
											</ul>
										</div>
									</div>
									<div class="col-md-6">
						...
						<div class="row no-gutters">
							<div class="col-md-12 pr-3">
								<div class="row no-gutters menu_col4 ">
									...
									<div class="col-md-3">
										<a href="music-room.php"><img src="../img/menu/cafeteria.jpg" alt="Music Room" class="img-fluid"/>
											<div class="menu_boxx"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-music"><path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/></svg> Music Room</div>
										</a>
									</div>
									<div class="col-md-3">
									...
									<div class="col-md-3">
										<a href="../conference-hall.php"><img src="../img/menu//new/conference-hall.jpg" alt="Conference Hall" class="img-fluid"/>
					...
					<div class="mega_menu pt-5 hidden-xs">
						<div class="row no-gutters">
							<div class="col-md-4 pr-3 pl-3 admission">
								...
								<div  class="right_mega_menu">
									<ul>
										<li><a href="https://www.gims.net.in/dean-academics.php"><i class="icon-user2"></i>Message of the Dean- Outreach and Student Welfare(OSW)</a></li>
										<li><a href="https://www.gims.net.in/admissions-at-gims.php"><i class="icon-line2-graduation"></i>Selection Process</a></li>
										<li><a href="https://www.gims.net.in/fee-structure.php"><i class="icon-fast-forward"></i> Fee Structure</a></li>
										<li><a href="https://www.gims.net.in/pgdm-in-delhi-ncr.php"><i class="icon-rupee"></i> Education Loan</a></li>
										<li><a href="https://www.gims.net.in//pdf/gims-Eform.pdf" target="_blank"><i class="icon-download-alt"></i> GIMS Admission Form</a></li>
										...
										<li><a href="https://www.gims.net.in/intellectual-capital-at-gims.php"><i class="icon-fast-forward"></i> Intellectual Capital @ GIMS</a></li>
    ...
    margin-top: 10px;
								...
								<div class="admissionproc">
									...
									<div class="processdiv">
										...
										<p>
											<b>Mr.Pradeep Dey</b> <br /> Vice President <br /> West Bengal/North East/Odisha <br /> 069012 21139, 081308 23386 <br />  pradee.dey@gniot.net.in
										</p>
									</div>
								</div>
									...
									<div class="col-md-4">
										<div class="bullet_menu2">
											<ul>
												...
												<li class="expandlin">
													<a href="https://www.gims.net.in/placement-record-2022-24.php?v=1" class="halfmenu ">Placements</a><span class="halfmenu hlfmenuopen"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-plus"><path d="M5 12h14"/><path d="M12 5v14"/></svg></span>
													<div class="expandmenu">
														<div class="listul">
															<a href="https://www.gims.net.in/placement-record-2023-25.php?v=1"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right"><path d="m9 18 6-6-6-6"/></svg> Placement 2023-2025</a>
															<a href="https://www.gims.net.in/placement-record-2022-24.php?v=1"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right"><path d="m9 18 6-6-6-6"/></svg> Placement 2022-2024</a>
															<a href="https://www.gims.net.in/placement-2021-23.php"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right"><path d="m9 18 6-6-6-6"/></svg> Placement 2021-2023</a>
															<a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right"><path d="m9 18 6-6-6-6"/></svg> Placement 2020-2022</a>
            ...
            <!-- <li class="nav-item"><a class="nav-link c-black" href="mandatory-disclosure.php">Mandatory Disclosure </a>
				...
				<li class="nav-item"><a class="nav-link c-black" href="pdf/gims-mandatory-di.pdf">Mandatory Disclosure </a>
				</li>
				...
				<li class="nav-item"><a class="blink_me nav-link apply_btn" href="https://www.gims.net.in/apply-now/" target="_blank"> Apply Now</a></li>
			</ul>
		</div>
    ...
    <div class="hamburger_menu_wrepper" id="menu">
        <div class="animation-box">
            ...
            <div class="menu-box navbar">
				...
				<li class="nav-item" style="animation-delay: 0.4s; margin-bottom: 16px; "><a href="https://www.gims.net.in/apply-now/" style="font-weight: 600; color: #fff;    background: #023e96;padding-left: 5px;padding-right: 5px; " data-toggle="modal" data-target="#myModal4">Apply Now</a></li>
				<li class=""><a href="https://gniotims.edugrievance.com/" target="_blank" class="blink_meg blinkhover" style="font-weight: 600;color: #313232;background-color: #ffc300;padding-left: 5px;padding-right: 5px;">Grievance Cell</a></li>
					<li class="nav-item"><a href="https://aicte-india.org/feedback/" target="_blank">AICTE Feedback</a></li>
		            <li class="nav-item"><a href="aicte.php" target="_blank">AICTE Pledge</a></li>
                    ...
                    <li class="nav-item dropdown submenu active">
                        ...
                        <ul class="dropdown-menu">
							<li class="nav-item"><a href="https://www.gims.net.in/about-gims.php" class="nav-link">About GIMS</a></li>
							<li class="nav-item"><a href="https://www.gims.net.in/history.php" class="nav-link">History</a></li>
							<li class="nav-item"><a href="https://www.gims.net.in/mission-vision.php" class="nav-link">Vision & Mission</a></li>
							<li class="nav-item"><a href="https://www.gims.net.in/blessings-of-founder.php" class="nav-link">Founder Chairman's Message</a></li>
							<li class="nav-item"><a href="https://www.gims.net.in/chairmans-message.php" class="nav-link">Chairman Message</a></li>
							<li class="nav-item"><a href="https://www.gims.net.in/ceo-message.php" class="nav-link">CEO Message</a></li>
							<li class="nav-item"><a href="https://www.gims.net.in/director.php" class="nav-link">Director Message</a></li>
							<!-- <li class="nav-item"><a href="https://www.gims.net.in/approval-letter.php" class="nav-link">Approval Letter</a></li> -->
							<li class="nav-item"><a href="https://www.gims.net.in/head-pgp.php" class="nav-link">Executive Director</a></li>
							<!-- <li class="nav-item"><a href="https://www.gims.net.in/head-pgp.php" class="nav-link">Deputy Director</a></li> -->
							<li class="nav-item"><a href="https://www.gims.net.in/dean-academic.php" class="nav-link">Dean Academics</a></li>
							<li class="nav-item"><a href="https://www.gims.net.in/dean-academics.php" class="nav-link">Dean-Outreach & Student Welfare</a></li>
							<li><a href="#"><i class="icon-line-speech-bubble"></i> Accreditation</a></li>
							<li><a href="#"><i class="icon-line-speech-bubble"></i> Audited Statements</a></li>
							...
							<li class="nav-item"><a href="../head-pgp.php" class="nav-link">Dean PGP</a></li>
                    ...
                    <li class="nav-item dropdown submenu">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Program</a>
                        <ul class="dropdown-menu">
							<!-- <li><a href="https://www.gims.net.in/head-pgp.php"><i class="icon-user2"></i> Deputy Director</a></li> -->
							<li><a href="https://www.gims.net.in/head-pgp.php"><i class="icon-user2"></i> Executive Director</a></li>
							<li><a href="https://www.gims.net.in/pgdm.php#programhighlight">About PGDM@GIMS</a></li>
							...
							<li><a href="https://www.gims.net.in/foreign-national-courses.php">Foreign National Courses</a></li>
												<li><a href="https://www.gims.net.in/working-professional-courses.php">Working Professional Courses</a></li>
							<!-- <li class="nav-item"><a class="nav-link" href="https://www.gims.net.in/head-pgp.php"><i class="icon-user2"></i> Dean PGP</a></li>
							<li class="nav-item"><a class="nav-link" href="https://www.gims.net.in/pgdm.php#programhighlight">About PGDM@GIMS</a></li>
							<li class="nav-item"><a class="nav-link" href="https://www.gims.net.in/pgdm.php#programhighlight" >Program Highlights</a></li>
							<li class="nav-item"><a class="nav-link" href="https://www.gims.net.in/pgdm.php#specialization" >PGDM Specializations</a></li>
							<li class="nav-item"><a class="nav-link" href="https://www.gims.net.in/self-directed-learning.php">Self Directed Learning</a></li>
							<li class="nav-item"><a class="nav-link" href="https://www.gims.net.in/pedagogy.php">Pedagogy</a></li>
							<li class="nav-item"><a class="nav-link" href="https://www.gims.net.in/electives.php">Electives</a></li>
							<li class="nav-item"><a class="nav-link" href="https://www.gims.net.in/pgdm.php#certification" >Certifications</a></li>
							<li class="nav-item"><a class="nav-link" href="https://www.gims.net.in/course-structure-2023-25.php" >Course structure and curriculum 23-25</a></li> -->
							<!-- <li class="nav-item"><a href="pedagogy.php">FAQs</a></li> -->
							<!-- <li class="nav-item"><a class="nav-link" href="https://www.gims.net.in/curriculum.php">Curriculum</a></li> -->
                        </ul>
                    </li>
                    <li class="nav-item dropdown submenu">
                        ...
                        <ul class="dropdown-menu">
							<li class="nav-item"><a href="../lecture-hall.php" class="nav-link"><i class="icon-microphone2"></i> Lecture Halls</a></li>
							<li class="nav-item"><a href="../library.php" class="nav-link"><i class="icon-book2"></i> Library</a></li>
							<li class="nav-item"><a href="../computer-centre.php" class="nav-link"><i class="icon-desktop"></i> Computer Lab</a></li>
							<li class="nav-item"><a href="../hostel-facility.php" class="nav-link"><i class="icon-building"></i> Hostel</a></li>
							<li class="nav-item"><a href="music-room.php" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-music"><path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/></svg> Music Room</a></li>
							<li class="nav-item"><a href="../sports.php" class="nav-link"><i class="icon-t-shirt"></i> Sports</a></li>
							...
							<li class="nav-item"><a href="../auditorium.php" class="nav-link"><i class="icon-building"></i> Auditorium</a></li>
							<li class="nav-item"><a href="../conference-hall.php" class="nav-link"><i class="icon-building"></i> Conference Hall</a></li>
							<li class="nav-item"><a href="../recreational-area.php" class="nav-link"><i class="icon-building"></i> Recreational Area</a></li>
                    ...
                    <li class="nav-item dropdown submenu">
                        ...
                        <ul class="dropdown-menu">
							<!-- <li class="nav-item"><a href="../academics.php" class="nav-link"><i class="icon-building"></i> Academics</a></li>
							<li class="nav-item"><a href="../mentorship.php" class="nav-link"><i class="icon-building"></i> Mentorship</a></li>
							<li class="nav-item"><a href="../clubs-at-gims.php" class="nav-link"><i class="icon-building"></i> Clubs @ GIMS</a></li>
							<li class="nav-item"><a href="../anti-ragging.php" class="nav-link"><i class="icon-building"></i> Anti Ragging</a></li>
							<li class="nav-item"><a href="../hostel-life.php" class="nav-link"><i class="icon-building"></i> Hostel Life</a></li>
							<li class="nav-item"><a href="../life-at-gims.php" class="nav-link"><i class="icon-building"></i> Life at GIMS</a></li>
							<li class="nav-item"><a href="../gallery.php" class="nav-link">Gallery</a></li>
                            <li class="nav-item"><a href="" class="nav-link">Campus Hostel</a></li> -->

							<li class="nav-item"><a href="../gallery.php"><i class="icon-line2-graduation"></i> Gallery</a></li>
							<li class="nav-item"><a href="../campus.php"><i class="icon-line2-feed"></i> Campus</a></li>
							<li class="nav-item"><a href="../academics.php"><i class="icon-building"></i> Academics</a></li>
							<li class="nav-item"><a href="../mentorship.php"><i class="icon-building"></i> Mentorship</a></li>
							<li class="nav-item"><a href="../sports.php"><i class="icon-building"></i> Sports</a></li>
							<li class="nav-item"><a href="../it-infrastructure.php"><i class="icon-building"></i> IT Infrastructure</a></li>
							<li class="nav-item"><a href="../clubs-at-gims.php"><i class="icon-building"></i> Clubs @ GIMS</a></li>
							<li class="nav-item"><a href="../anti-ragging.php"><i class="icon-building"></i> Anti Ragging</a></li>
							<li class="nav-item"><a href="../hostel-life.php"><i class="icon-building"></i> Hostel Life</a></li>
							<li class="nav-item"><a href="../life-at-gims.php"><i class="icon-building"></i> Life at GIMS</a></li>
                    ...
                    <li class="nav-item dropdown submenu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <!-- <li class="nav-item"><a href="../eligibility-criteria.php" class="nav-link">Admission Process</a></li>
                            <li class="nav-item"><a href="https://www.gims.net.in/admissions-at-gims.php" class="nav-link">Eligibility Criteria</a></li>
                            <li class="nav-item"><a href="https://www.gims.net.in/admissions-at-gims.php#scholarship" class="nav-link">Scholarship</a></li>
                            <li class="nav-item"><a href="https://www.gims.net.in/fee-structure.php" class="nav-link">Fee Structure</a></li>
							<li class="nav-item"><a href="https://www.gims.net.in/pdf/gims-Eform.pdf" target="_blank"><i class="icon-download-alt"></i> GIMS Admission Form</a></li>
							<li class="nav-item"><a href="https://www.gims.net.in/intellectual-capital-at-gims.php" class="nav-link">Intellectual Capital @ GIMS</a></li>
							<li class="nav-item"><a href="https://www.gims.net.in/pgdm-in-delhi-ncr.php" class="nav-link">Education Loan Help</a></li>
							<li><a href="#" data-toggle="modal" data-target="#myModal3"><i class="icon-line2-graduation"></i> Outreach</a></li>
				...
				<li class="nav-item"><a href="../area-academic-board.php" class="nav-link">AAB</a></li>
                    ...
                    <li class="nav-item dropdown submenu">
						...
						<ul class="dropdown-menu">
							...
							<li class="nav-item"><a class="nav-link" href="../our-recruiters.php">Our Recruiters</a></li>
							<li class="nav-item"><a class="nav-link" href="https://www.gims.net.in/placement-record-2023-25.php?v=1"> Placement 2023-2025</a></li>
							<li class="nav-item"><a class="nav-link" href="https://www.gims.net.in/placement-record-2022-24.php?v=1"> Placement 2022-2024</a></li>
							<li class="nav-item"><a class="nav-link" href="https://www.gims.net.in/placement-2021-23.php"> Placement 2021-2023</a></li>
							<li class="nav-item"><a class="nav-link" href="#"> Placement 2020-2022</a></li>
							...
							<li class="nav-item"><a class="nav-link" href="../sip.php">SIP</a></li>
					...
					<li class="nav-item dropdown submenu">
                        <a class="nav-link dropdown-toggle" href="../life-at-gims.php" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Other
                        </a>
                        <ul class="dropdown-menu">
					...
					<li class="nav-item"><a target="_blank" class="nav-link" href="https://www.gims.net.in/pdf/gims-pgdm-brochure-batch-2025-2027-computer.pdf">Prospectus</a></li>
					...
					<!-- <li class="nav-item"><a target="_blank" class="nav-link" href="https://www.gims.net.in/pdf/national-conference-brochure.pdf">Research</a></li> -->
					
					<li class="nav-item"><a href="../committee.php" target="_blank">Committee</a></li>
					<li class="nav-item"><a href="https://gims.net.in/blog/" target="_blank">Blogs</a></li>
					...
					<li><a href="https://www.gims.net.in/gims-international-immersion-programmes.php" class="nav-link"  target="_blank">IIP Batch (2022-2024)</a></li>
					...
					<li class="nav-item"><a href="https://www.gims.net.in/apply-now/" target="_blank" >Register Here</a></li>
				...
				<li class="nav-item dropdown submenu">
					...
					<a class="nav-link dropdown-toggle" href="pdf/gims-mandatory-di.pdf" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Mandatory Disclosure</a>
